...
A component that dynamically renders JSX strings with streaming support for
AI-generated UI.
...
The JSXPreview component integrates with the AI SDK to render generated UI in
real-time:
