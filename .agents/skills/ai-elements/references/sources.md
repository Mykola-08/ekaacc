...
A component that allows a user to view the sources or citations used to generate
a response.

The `Sources` component allows a user to view the sources or citations used to
generate a response.
...
- Collapsible component that allows a user to view the sources or citations used
