...
name: eka-design
description:
  Design system, animation, and UX conventions for the EKA platform. Applies
  when building UI components, layouts, animations, forms, or marketing pages.
...
- Every Dialog/Sheet/Drawer must have a Title (use `sr-only` if visually
  hidden).
