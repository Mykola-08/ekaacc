 ...
 return (
  <div className="space-y-6">
   ...
   <div className="flex justify-center gap-2">
     {page > 1 && (
       <a href={`?page=${page - 1}`} className="px-4 py-2 bg-secondary/50 rounded-xl text-sm hover:bg-secondary/70 transition-colors">Previous</a>
     )}
     {((count || 0) > page * 20) && (
        <a href={`?page=${page + 1}`} className="px-4 py-2 bg-secondary/50 rounded-xl text-sm hover:bg-secondary/70 transition-colors">Next</a>
     )}
   </div>
  </div>
 )
