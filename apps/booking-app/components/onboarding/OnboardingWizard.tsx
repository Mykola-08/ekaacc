     ...
     return (
         <div className="min-h-screen bg-background flex items-center justify-center p-4">
             <div className="text-center animate-in zoom-in duration-500">
                 ...
                 <h1 className="text-3xl font-serif text-foreground mb-2">You're All Set</h1>
        ...
        <div className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full px-6 pb-20 pt-10">
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className="w-full"
                >
                    <div className="mb-2 text-sm font-bold text-muted-foreground uppercase tracking-widest">
                             ...
                             <div className="grid gap-3">
                                {normalizedOptions.map((option: any) => (
                                    <div
                                        ...
                                        className={cn(
                                            "w-full cursor-pointer p-6 text-left rounded-xl border transition-all flex items-center justify-between group hover:shadow-md",
