  ...
  return (
    <DashboardLayout profile={{ first_name: 'Client', role: 'client' }}>
      <div className="space-y-10 animate-in fade-in duration-500 pb-20 max-w-[1600px] mx-auto">
        ...
        {/* Search & Filter Bar */}
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between sticky top-4 bg-card z-20 py-2">
                ...
                {categories.map(cat => (
                   <button
                      ...
                      className={`
                         ...
                         ${filter === cat.id 
                            ? 'bg-foreground text-background shadow-lg hover:scale-105' 
