    ...
    <div className="flex flex-col gap-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-border">
          <div className="space-y-2 text-center md:text-left">
              <h1 className="font-serif text-3xl md:text-4xl text-foreground">Community Forum</h1>
      ...
      <div className="space-y-4">
        {posts.length === 0 ? (
            <Card className="flex flex-col items-center justify-center py-20 bg-muted/50 border-dashed">
                <MessageSquare className="w-12 h-12 text-muted-foreground/50 mb-4" />
                <h3 className="font-serif text-xl text-foreground mb-2">No posts yet</h3>
            ...
            posts.map((post, idx) => (
                ...
                >
                    <Card className="p-6 md:p-8 hover:shadow-md transition-all duration-300 hover:scale-[1.01] hover:bg-accent/5 overflow-hidden">
                        <div className="flex flex-col md:flex-row gap-6">
                            {/* Avatar Placeholder */}
                            <div className="shrink-0">
                                <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center font-serif text-lg font-bold">
                            ...
                            <div className="flex-1 space-y-3">
                                ...
                                <h3 className="font-serif text-2xl text-foreground group-hover:text-primary transition-colors leading-tight">
                                    {post.title}
                                </h3>
