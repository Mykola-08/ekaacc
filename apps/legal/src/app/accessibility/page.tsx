...
const content = {
  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "La accesibilidad de EKA Balance se basa en las siguientes tecnologías para funcionar con la combinación particular de navegador web y cualquier tecnología de asistencia o complementos instalados en su computadora:\n\n• HTML\n• WAI-ARIA\n• CSS\n• JavaScript\n\nSe confía en estas tecnologías para la conformidad con los estándares de accesibilidad utilizados."
      },
      {
  ...
  ca: {
    ...
    sections: [
      ...
      {
        title: "8. Aprovació Formal d'aquesta Declaració d'Accessibilitat",
