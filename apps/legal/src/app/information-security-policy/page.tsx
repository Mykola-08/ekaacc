      ...
      sections: [
        {
          ...
          icon: <Key className="w-6 h-6 text-blue-600" />,
          text: "El acceso a la información y los sistemas se otorga según el principio de privilegio mínimo. A los usuarios solo se les otorga acceso a los datos y recursos necesarios para su función. Se aplican medidas de autenticación sólidas, incluida la autenticación multifactor."
        },
        {
