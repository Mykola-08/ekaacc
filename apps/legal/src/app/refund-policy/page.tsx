...
const content = {
  ...
  es: {
    ...
    intro: "En EKA Balance, nos esforzamos por brindar servicios de terapia y bienestar de alta calidad. Entendemos que las circunstancias pueden cambiar y es posible que deba cancelar o reprogramar sus citas. Esta política describe los términos para reembolsos y cancelaciones.",
    sections: [
      {
  ...
  ca: {
    ...
    intro: "A EKA Balance, ens esforcem per oferir serveis de teràpia i benestar d'alta qualitat. Entenem que les circumstàncies poden canviar i és possible que hagi de cancel·lar o reprogramar les seves cites. Aquesta política descriu els termes per a reemborsaments i cancel·lacions.",
    sections: [
      {
  ...
  ru: {
    ...
    intro: "В EKA Balance мы стремимся предоставлять высококачественные услуги терапии и оздоровления. Мы понимаем, что обстоятельства могут измениться, и вам может потребоваться отменить или перенести ваши встречи. Эта политика описывает условия возврата и отмены.",
    sections: [
      {
