...
import { Sparkles, Heart, Shield, Brain, Users, BookOpen, TrendingUp, Calendar, MessageSquare, Target, Award } from 'lucide-react'
        ...
        <div className="text-center space-y-8">
          ...
          >
            <Button asChild size="lg">
              <Link href="https://app.ekabalance.com/api/auth/login">
                Sign In
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg">
              <Link href="https://app.ekabalance.com/api/auth/login?screen_hint=signup">
                Create Account
              </Link>
            </Button>
          </motion.div>
