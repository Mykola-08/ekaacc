...
const content = {
  ...
  es: {
    ...
    intro: "Esta Política de Uso Aceptable (\"PUA\") describe los ejemplos de conducta prohibida en relación con nuestros servicios. Esta política es una parte integral de nuestros Términos de Servicio y se aplica a todos los usuarios, visitantes y clientes de EKA Balance. Nuestro objetivo es mantener un entorno seguro y respetuoso para todos los usuarios a nivel mundial.",
    sections: [
      {
  ...
  ca: {
    ...
    intro: "Aquesta Política d'Ús Acceptable (\"PUA\") descriu els exemples de conducta prohibida en relació amb els nostres serveis. Aquesta política és una part integral dels nostres Termes de Servei i s'aplica a tots els usuaris, visitants i clients d'EKA Balance. El nostre objectiu és mantenir un entorn segur i respectuós per a tots els usuaris a nivell mundial.",
    sections: [
      {
