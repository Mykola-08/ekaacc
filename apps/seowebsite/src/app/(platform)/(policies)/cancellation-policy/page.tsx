...
export default function CancellationPolicy() {
 ...
 const content = {
  en: {
   ...
   intro: "We understand that life happens and you may need to cancel or reschedule your appointment. This policy outlines the procedures and fees associated with cancellations to ensure fair treatment for both clients and providers.",
   sections: [
    {
  ...
  es: {
   ...
   intro: "Entendemos que la vida sucede y es posible que deba cancelar o reprogramar su cita. Esta política describe los procedimientos y tarifas asociados con las cancelaciones para garantizar un trato justo tanto para los clientes como para los proveedores.",
   sections: [
    {
  ...
  ca: {
   ...
   intro: "Entenem que la vida passa i és possible que hàgiu de cancel·lar o reprogramar la vostra cita. Aquesta política descriu els procediments i tarifes associats amb les cancel·lacions per garantir un tracte just tant per als clients com per als proveïdors.",
   sections: [
    {
  ...
  ru: {
   ...
   intro: "Мы понимаем, что обстоятельства могут измениться, и вам может потребоваться отменить или перенести встречу. Эта политика описывает процедуры и сборы, связанные с отменой, чтобы обеспечить справедливое отношение как к клиентам, так и к специалистам.",
   sections: [
    {
     title: "1. Срок отмены",
     icon: <Clock className="w-6 h-6 text-blue-600" />,
