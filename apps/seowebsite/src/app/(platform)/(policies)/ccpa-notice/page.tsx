 ...
 return (
  <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
   ...
   <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
    <div className="bg-gradient-to-r from-yellow-600 to-orange-600 px-8 py-12 text-white">
    ...
    <div className="p-8 space-y-8">
     {t.sections.map((section, index) => (
      <div key={index} id={(section as any).id} className="flex gap-4 p-6 rounded-[32px] bg-gray-50 hover:bg-gray-100 transition-colors scroll-mt-24">
