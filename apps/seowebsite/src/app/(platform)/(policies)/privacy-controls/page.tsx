...
const PageContainer = ({ children, className }: any) => <div className={`container mx-auto p-6 ${className || ''}`}>{children}</div>;
const SurfacePanel = ({ children, className }: any) => <div className={`bg-card rounded-xl border p-6 ${className || ''}`}>{children}</div>;
const PageHeader = ({ title, description }: any) => <div className="mb-8"><h1 className="text-3xl font-bold">{title}</h1><p className="text-muted-foreground">{description}</p></div>;
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => 
                          setPrivacySettings({
                            ...privacySettings,
                            dataSharing: { ...privacySettings.dataSharing, thirdPartyServices: checked }
                          })
                        }
                      />
                    </div>
            ...
            >
              <Card className="border-slate-200 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Manage who can see your information and activity</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'public' | 'private' | 'connections') => 
                          setPrivacySettings({
                            ...privacySettings,
                            visibility: { ...privacySettings.visibility, profileVisibility: value }
                          })
                        }
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => 
                          setPrivacySettings({
                            ...privacySettings,
                            visibility: { ...privacySettings.visibility, showOnlineStatus: checked }
                          })
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => 
                          setPrivacySettings({
                            ...privacySettings,
                            security: { ...privacySettings.security, sessionTimeout: parseInt(value) }
                          })
                        }
                      >
                        <SelectTrigger className="mt-1">
                  ...
                  <div className="space-y-3 max-h-64 overflow-y-auto">
                    {privacyAudit.length === 0 ? (
                      ...
                      privacyAudit.map((audit) => (
                        <div key={audit.id} className="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg">
