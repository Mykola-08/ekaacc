...
export default function ServiceLevelAgreement() {
 ...
 const content = {
  en: {
   ...
   intro: "This Service Level Agreement (SLA) outlines the performance commitments and guarantees provided by EKA Balance to our enterprise customers.",
   sections: [
    {
  ...
  es: {
   ...
   intro: "Este Acuerdo de Nivel de Servicio (SLA) describe los compromisos de rendimiento y las garantías proporcionadas por EKA Balance a nuestros clientes empresariales.",
   sections: [
    {
  ...
  ca: {
   ...
   intro: "Aquest Acord de Nivell de Servei (SLA) descriu els compromisos de rendiment i les garanties proporcionades per EKA Balance als nostres clients empresarials.",
   sections: [
    {
  ...
  ru: {
   ...
   intro: "В этом Соглашении об уровне обслуживания (SLA) изложены обязательства по производительности и гарантии, предоставляемые EKA Balance нашим корпоративным клиентам.",
   sections: [
    {
