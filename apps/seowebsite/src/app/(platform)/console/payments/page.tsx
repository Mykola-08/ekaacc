    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2 text-lg">View and manage payment transactions.</p>
        </div>
        
        <div className="flex gap-2">
            <button className="inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 shadow-sm transition-colors">
      ...
      <div className="bg-white rounded-[32px] p-8 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 relative overflow-hidden min-h-[400px] flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-md mx-auto">
           <div className="relative mb-6">
                ...
                <div className="h-24 w-24 bg-white rounded-full flex items-center justify-center relative shadow-sm ring-1 ring-slate-100">
                    <Receipt className="w-10 h-10 text-blue-600" />
                </div>
           </div>
           
           <h2 className="text-2xl font-bold text-gray-900 mb-3">Transaction History</h2>
