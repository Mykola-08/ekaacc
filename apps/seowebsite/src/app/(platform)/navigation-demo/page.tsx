...
import { Table, TableHeader, TableRow, TableHead, TableBody, TableCell } from '@/components/platform/ui/table';
...
import { getSecurityMetrics, getSecurityAlerts } from '@/lib/platform/security-monitoring';
import { invalidateUserPermissionCache } from '@/lib/platform/permission-service';
