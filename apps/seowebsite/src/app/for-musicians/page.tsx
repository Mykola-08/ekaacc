...
import { Music, Clock, CheckCircle, ArrowRight } from 'lucide-react';
import { useBooking } from '@/react-app/hooks/useBooking';
import { useLanguage } from '@/react-app/contexts/LanguageContext';

export default function MusiciansPersonalized() {
 const { navigateToBooking } = useBooking();
 const { t } = useLanguage();

 const recommendedServices = [
  {
   id: 'feldenkrais-expression',
   ...
   />
     ...
     <div className="max-w-6xl mx-auto px-4 sm:px-8">
      <div className="text-center mb-12">
       ...
       <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link
         href="/contact"
         className="bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-4 rounded-full border-2 border-gray-200 transition-colors duration-200 flex items-center justify-center"
        >
    ...
    <section className="py-16 bg-white">
     <div className="max-w-4xl mx-auto px-4 sm:px-8">
      <div className="bg-purple-50 rounded-[32px] p-8 sm:p-12">
     ...
     <div className="max-w-6xl mx-auto px-4 sm:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
       {recommendedServices.map((service, index) => (
        <div key={service.id} className="bg-white rounded-[32px] p-8 border-none ">
    ...
    <section className="py-16 bg-white">
     <div className="max-w-4xl mx-auto px-4 sm:px-8">
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-[32px] p-8 sm:p-12">
