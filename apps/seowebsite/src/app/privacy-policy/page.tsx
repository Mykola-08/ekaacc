              ...
              <div className="px-0 py-0 text-black">
                ...
                <div className="mb-12">
                  ...
                  <div className="grid gap-6">
                    <div className="bg-green-50 rounded-lg p-6 border border-green-100">
                      ...
                      <p className="text-gray-700 mb-4">We rely on your explicit consent for:</p>
                      ...
                      <p className="text-gray-600 mt-4 text-sm">You may withdraw your consent at any time without affecting the lawfulness of processing based on consent before its withdrawal.</p>
                    </div>

                    <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">2.2 Contractual Necessity (Article 6(1)(b))</h3>
                      <p className="text-gray-700 mb-4">Processing is necessary for:</p>
                      <ul className="space-y-2 text-gray-700">
                    ...
                    <div className="bg-purple-50 rounded-lg p-6 border border-purple-100">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">2.3 Legal Obligations (Article 6(1)(c))</h3>
                      <p className="text-gray-700 mb-4">Processing is necessary to comply with:</p>
                      <ul className="space-y-2 text-gray-700">
                    ...
                    <div className="bg-orange-50 rounded-lg p-6 border border-orange-100">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">2.4 Legitimate Interests (Article 6(1)(f))</h3>
                      <p className="text-gray-700 mb-4">We process data based on our legitimate interests, which include:</p>
                      <ul className="space-y-2 text-gray-700">
                      ...
                      <p className="text-gray-600 mt-4 text-sm">We conduct balancing tests to ensure our legitimate interests do not override your fundamental rights and freedoms.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">3.2 Right to Erasure ('Right to be Forgotten') (Article 17)</h3>
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-700 mb-4">You have the right to receive your personal data in a structured, commonly used, and machine-readable format and have the right to transmit that data to another controller where:</p>
                      <ul className="space-y-2 text-gray-700">
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 mt-8 border border-blue-100">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex">
                        <span className="font-medium text-gray-900 w-24">Mail:</span>
                        <span className="text-gray-700">Data Protection Officer, Calle Plata 1, 08191 Rubí, Barcelona, Spain</span>
                      </div>
                      <div className="flex">
                        <span className="font-medium text-gray-900 w-24">Phone:</span>
                        <span className="text-gray-700">+34 658 867 133</span>
                      </div>
                    </div>
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="bg-red-50 rounded-lg p-6 border border-red-100">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-gray-700">Phone: +34 901 100 099 / +34 91 266 35 17</div>
                      </div>
                      <p className="text-gray-600 mt-4 text-sm">
