   ...
   <div className="relative bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-32 pb-20 px-6 overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
     ...
     <div className="relative">
      <div className="relative rounded-[32px] overflow-hidden shadow-2xl border-none border-white">
        <img
    ...
    <div className="max-w-7xl mx-auto px-6">
     ...
     <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      {sessionTypes.map((session, index) => (
       <div key={index} className="bg-white rounded-[32px] p-8 shadow-sm hover:shadow-xl transition-all duration-300 border-none relative overflow-hidden group">
