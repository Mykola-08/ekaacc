    ...
    <div className="w-full max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2 text-lg">System administration and performance monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-[32px] p-6 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 relative overflow-hidden group">
          ...
          <div className="bg-white rounded-[32px] p-6 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 relative overflow-hidden group">
             ...
             <div className="relative z-10">
                ...
                <div className="text-3xl font-bold text-gray-900">€{stats.revenueMtd.toLocaleString()}</div>
          ...
          <div className="bg-white rounded-[32px] p-6 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 relative overflow-hidden group">
             ...
             <div className="relative z-10">
                ...
                <div className="text-3xl font-bold text-gray-900">{stats.revenueGrowth}%</div>
                <div className="mt-2 text-xs text-gray-400">
                     Revenue Growth MoM
                </div>
             </div>
          ...
          <div className="bg-white rounded-[32px] p-6 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 relative overflow-hidden group">
             ...
             <div className="relative z-10">
                ...
                <div className="text-3xl font-bold text-gray-900 capitalize">{stats.systemHealth}</div>
                <div className="mt-2 text-xs text-gray-400">
      ...
      <TabGroup>
        <TabList className="flex space-x-2 bg-white/50 p-1 rounded-2xl backdrop-blur-sm border border-gray-100 w-fit">
