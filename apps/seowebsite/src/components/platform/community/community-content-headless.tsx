                 ...
                 <div className="bg-white rounded-4xl border border-gray-100 shadow-sm overflow-hidden">
                     <div className="p-8 border-b border-gray-100 bg-gray-50/50">
                         ...
                         <div className="grid sm:grid-cols-2 gap-4">
                             {/* Event Card 1 */}
                             <div className="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all cursor-pointer">
                                 ...
                                 <h3 className="font-bold text-gray-900 group-hover:text-rose-600 transition-colors">Group Meditation</h3>
                                 <p className="text-sm text-gray-500 mt-1">10:00 AM • with Sarah</p>
                             ...
                             <div className="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all cursor-pointer">
                                 <div className="flex justify-between items-start mb-3">
                                      <span className="text-xs font-bold text-gray-500 uppercase">Nov 12</span>
                                 </div>
                                 <h3 className="font-bold text-gray-900 group-hover:text-rose-600 transition-colors">Wellness Workshop</h3>
                                  <p className="text-sm text-gray-500 mt-1">2:00 PM • with Dr. Smith</p>
                     ...
                     <div className="p-8">
                             ...
                             {[
                                 ...
                                 <div key={i} className="flex gap-4 group cursor-pointer">
                                     ...
                                     <div className="grow pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                                         <h3 className="font-bold text-gray-900 text-lg group-hover:text-blue-600 transition-colors">{topic.title}</h3>
                                         <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                                             <span>By {topic.author}</span>
                                             <span>•</span>
                                             <span>{topic.time}</span>
                                             <span className="ml-auto flex items-center gap-1 bg-gray-50 px-2 py-1 rounded-lg">
                         ...
                         <div className="mt-8 text-center bg-gray-50 p-6 rounded-2xl border border-gray-100 border-dashed">
                             <h4 className="font-bold text-gray-900 mb-2">Have something to share?</h4>
                             <p className="text-sm text-gray-500 mb-4">Start a new discussion topic or ask a question.</p>
            ...
            <div className="space-y-6">
                 ...
                 <div className="rounded-4xl bg-linear-to-br from-indigo-500 to-purple-600 p-8 text-white shadow-lg relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <span className="text-xs font-bold bg-white/20 px-2 py-1 rounded-lg border border-white/10 mb-4 inline-block">Featured Group</span>
                        ...
                        <div className="flex -space-x-3 mb-6">
                             ...
                             <div className="w-10 h-10 rounded-full bg-white text-indigo-600 flex items-center justify-center font-bold text-xs border-2 border-indigo-500">+150</div>
                        </div>
                        <button className="w-full py-3 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors shadow-lg">Join Group</button>
                    </div>
                 </div>
