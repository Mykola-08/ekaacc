...
import { StatsGrid } from '@/components/platform/eka/dashboard/stats-grid';
import { NextSession } from '@/components/platform/eka/dashboard/next-session';
import { GoalProgress } from '@/components/platform/eka/dashboard/goal-progress';
import { WelcomeHeader } from '@/components/platform/eka/dashboard/welcome-header';
import { AIHelpWidget } from '@/components/platform/ai-help-widget';
import BehavioralInsightsWidget from '@/components/platform/eka/behavioral-insights-widget';
import PersonalBlock from '@/components/platform/PersonalBlock';
