...
import { StatCard } from '@/components/platform/eka/dashboard/stat-card';
import { Smile, TrendingUp } from 'lucide-react';
import { useFeatureData } from '@/hooks/platform/use-feature-data';
import { useAuth } from '@/lib/platform/supabase-auth';
import { useAppStore } from '@/store/platform/app-store';
import { useEffect } from 'react';
import type { JournalEntry, StatCard as StatCardType } from '@/lib/platform/types';
