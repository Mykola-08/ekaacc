...
import { Slider } from '@/components/platform/ui/slider';
import { Badge } from '@/components/platform/ui/badge';
import { cn } from '@/lib/platform/utils';
import { useAuth } from '@/lib/platform/supabase-auth';
import { InView } from '@/components/platform/motion-primitives/in-view';
import { AnimatedGroup } from '@/components/platform/motion-primitives/animated-group';
import { TextLoop } from '@/components/platform/motion-primitives/text-loop';
