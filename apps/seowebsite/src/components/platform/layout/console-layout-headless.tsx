    ...
    <>
      <div>
                    ...
                    <div className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-gray-400">System Access</span>
                            </div>
                        </div>
                    </div>
                </li>
        ...
        <div className="lg:pl-72">
          {/* Top Header */}
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between gap-x-4 border-b border-gray-100 bg-white/80 backdrop-blur-md px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <div className="relative flex flex-1 items-center">
                 <div className="w-full max-w-md relative hidden md:block">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 border-none bg-gray-50 rounded-full text-sm text-gray-900 focus:ring-2 focus:ring-emerald-500/20 placeholder:text-gray-400" 
                    />
                 </div>
              </div>
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <HeadlessMenu as="div" className="relative">
                  ...
                  >
                    <MenuItems className="absolute right-0 z-10 mt-2.5 w-48 origin-top-right rounded-2xl bg-white. py-2 shadow-2xl shadow-slate-200 ring-1 ring-gray-900/5 focus:outline-none p-1">
                      ...
                      <MenuItem>
                        {({ active }) => (
                          <Link href="/console/settings" className={cn(active ? 'bg-gray-50' : '', 'flex items-center gap-2 px-3 py-2 text-sm leading-6 text-gray-900 rounded-xl')}>
                      ...
                      <MenuItem>
                        {({ active }) => (
                          <button onClick={() => signOut()} className={cn(active ? 'bg-red-50 text-red-700' : 'text-gray-900', 'flex w-full items-center gap-2 px-3 py-2 text-sm leading-6 rounded-xl')}>
                            <LogOut className={cn(active ? 'text-red-500' : 'text-gray-400', "w-4 h-4")} />
                            Sign out
                          </button>
                        )}
                      </MenuItem>
