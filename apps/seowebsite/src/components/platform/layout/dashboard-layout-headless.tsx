      ...
      <nav className="flex flex-1 flex-col">
        <ul role="list" className="flex flex-1 flex-col gap-y-7">
          ...
          <li className="mt-auto">
                <div className="rounded-3xl bg-gradient-to-br from-primary to-blue-600 p-5 relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300 cursor-pointer shadow-lg shadow-blue-900/10">
