...
import { SystemRole, hasPermission, PermissionGroup, PermissionAction } from '@/lib/platform/role-permissions';
import { canAccessRoute } from '@/lib/platform/permission-service';
import { logSecurityEvent, logUnauthorizedAccess } from '@/lib/platform/security-monitoring';
