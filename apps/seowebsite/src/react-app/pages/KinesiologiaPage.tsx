    ...
    <div className="min-h-screen bg-muted/30 font-sans text-foreground">
      ...
      <div className="relative bg-background pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 backdrop-blur-sm border border-border/30 text-sm text-primary mb-8 shadow-sm">
