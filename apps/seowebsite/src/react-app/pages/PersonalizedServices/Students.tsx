            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.challenge1.title')}</h3>
                    <p className="text-gray-600">{t('students.challenge1.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.challenge2.title')}</h3>
                    <p className="text-gray-600">{t('students.challenge2.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-red-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.challenge3.title')}</h3>
                    <p className="text-gray-600">{t('students.challenge3.desc')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.help1.title')}</h3>
                    <p className="text-gray-600">{t('students.help1.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.help2.title')}</h3>
                    <p className="text-gray-600">{t('students.help2.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('students.help3.title')}</h3>
                    <p className="text-gray-600">{t('students.help3.desc')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="squircle-card bg-white p-12 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <div className="text-gray-600">{t('students.stats.concentration')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-light text-yellow-600 mb-2">83%</div>
                <div className="text-gray-600">{t('students.stats.tension')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-light text-yellow-600 mb-2">79%</div>
                <div className="text-gray-600">{t('students.stats.stress')}</div>
              </div>
            </div>
          </div>
        </div>
