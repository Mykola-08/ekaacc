...
export default function LoyaltyElitePage() {
 return (
  <div className="min-h-screen bg-linear-to-br from-red-50 via-orange-50 to-pink-50">
   ...
   <section className="relative overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
     <div className="text-center">
      <BlurIn>
       <div className="inline-flex items-center px-6 py-3 bg-linear-to-r from-red-500 to-orange-500 rounded-full text-white text-lg font-semibold mb-6 shadow-lg">
      ...
      <BlurIn>
       <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
        Premium Rewards
        <span className="block text-transparent bg-clip-text bg-linear-to-r from-red-500 to-orange-600">
         & Exclusive Benefits
        </span>
       </h1>
      </BlurIn>
      ...
      <BlurIn>
       <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <ShimmerButton className="px-8 py-4 text-lg bg-linear-to-r from-red-500 to-orange-500">
     ...
     <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {benefits.map((benefit, index) => (
       <BlurIn key={index} delay={index * 0.1}>
        <div className="bg-linear-to-br from-white to-red-50 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-red-100 h-full">
   ...
   {/* Exclusive Features */}
   <section className="py-16 bg-linear-to-br from-red-100 to-orange-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="text-center mb-12">
      <AnimatedGradientText className="text-3xl font-bold mb-4">
   ...
   {/* Stats Section */}
   <section className="py-16 bg-linear-to-r from-red-600 via-orange-600 to-pink-600">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
