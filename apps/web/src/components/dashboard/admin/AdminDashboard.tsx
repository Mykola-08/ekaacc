                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <Card className="p-6 rounded-2xl bg-card border-border shadow-sm flex items-center gap-4 group hover:border-primary/20 hover:shadow-md transition-all">
                            ...
                            <Card className="p-6 rounded-2xl bg-card border-border shadow-sm flex items-center gap-4 group hover:border-amber-500/20 hover:shadow-md transition-all">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="p-8 bg-primary rounded-2xl shadow-lg shadow-primary/20 flex flex-col items-center justify-center text-center relative overflow-hidden group">
