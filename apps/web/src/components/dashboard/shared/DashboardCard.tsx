...
export function DashboardCard({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "bg-card p-8 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between h-full relative overflow-hidden group",
                className
            )}
        >
            <div className="space-y-6 relative z-10 w-full">
                <header className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        {Icon && (
                            <div className="h-12 w-12 rounded-lg bg-card flex items-center justify-center text-foreground">
