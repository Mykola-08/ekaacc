                           ...
                           {MOODS.map(m => (
                              <button
                                 ...
                                 className={cn(
                                    ...
                                    newEntry.mood === m.id ? `${m.bg} scale-110 shadow-inner ring-2 ring-black/5` : "hover:bg-card"
                                 )}
                              >
                     ...
                     >
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
                           <div className="flex items-center gap-5">
                              ...
                              <div>
                                 <h3 className="text-xl font-bold text-foreground tracking-tight mb-1">{entry.title}</h3>
                           ...
                           <Button variant="ghost" size="sm" className="hidden group-hover:flex text-primary bg-primary/5 hover:bg-primary/10 rounded-full h-9 px-4 text-xs font-bold transition-all">
                              <Sparkles className="w-3.5 h-3.5 mr-2" strokeWidth={2.5} />
                              AI Analyze
                           </Button>
                        </div>
                        <div className="pl-0 md:pl-[76px]">
                           <p className="text-muted-foreground leading-relaxed text-[16px] font-medium">
                              {entry.text}
                           </p>
                        </div>
                     </motion.div>
