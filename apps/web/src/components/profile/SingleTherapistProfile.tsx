...
export function SingleTherapistProfile({ therapist }: { therapist: any }) {
    ...
    return (
        <div className="rounded-2xl glass-card p-8 mb-8 flex flex-col md:flex-row gap-6 items-center md:items-start animate-in fade-in slide-in-from-top-5 duration-700">
