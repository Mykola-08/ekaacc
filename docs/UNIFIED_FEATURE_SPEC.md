...
### Main App Features (`marketing-area`)
...
### Booking App Features (`platform-area`)
...
### Main App Features (`marketing-area`) - Platform Area
...
### Main App Features (`marketing-area`) - `(platform)/therapist`
...
### Main App Features (`marketing-area`) - `(platform)/educator`
...
### Main App Features (`marketing-area`) - `(platform)/console`
...
### Booking App Features (`platform-area`) - `/admin`
