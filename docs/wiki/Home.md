...
Welcome to the EKA Account Wiki. Here you can find documentation on architecture, setup, database, and more.

## Architecture & Design
- [AI Services Architecture](AI_SERVICES_ARCHITECTURE.md)
- [App Flows Documentation](APP_FLOWS_DOCUMENTATION.md)
- [Broadcast System](BROADCAST_SYSTEM.md)
- [Design System](DESIGN_SYSTEM.md)
- [Flow Connections](FLOW_CONNECTIONS.md)

## Database
- [Database Configuration](DATABASE_CONFIGURATION.md)
- [Database Current State](DATABASE_CURRENT_STATE.md)
- [Database Requirements](DATABASE_REQUIREMENTS.md)
- [Database Setup Guide](DATABASE_SETUP_GUIDE.md)

## Guides & Setup
- [Full Implementation Guide](FULL_IMPLEMENTATION_GUIDE.md)
- [Production Deployment Guide](PRODUCTION_DEPLOYMENT_GUIDE.md)
- [Notifications Setup](NOTIFICATIONS_SETUP.md)
- [Supabase Email Setup](SUPABASE_EMAIL_SETUP.md)
- [Resend Integration](RESEND_INTEGRATION.md)
