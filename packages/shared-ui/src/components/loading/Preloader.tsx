    ...
    >
      <div className="fixed inset-0 z-[100] grid place-items-center bg-background/95 backdrop-blur-sm supports-[backdrop-filter]:bg-background/60">
        <div className="flex flex-col items-center justify-center p-6 text-center">
          ...
          >
            <h1 className="text-4xl font-serif font-black tracking-tighter sm:text-6xl text-foreground">
              EKA
            </h1>
          </Transition.Child>

          {/* Spacer to prevent layout shift when slow warning appears */}
          <div className="h-24 flex flex-col items-center justify-center gap-4 mt-8">
