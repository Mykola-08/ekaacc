              ...
              {emailSent ? (
                ...
                >
                  ...
                  >
                    <Button
                      type="submit"
                      className="h-12 w-full rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all hover:scale-105 hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl hover:shadow-indigo-500/30 active:scale-95"
                      disabled={isLoading}
                    >
                      {isLoading ? (
