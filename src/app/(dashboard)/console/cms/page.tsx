  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8 duration-500">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <button className="inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-white shadow-sm shadow-border transition-all hover:scale-105 hover:bg-foreground/90 active:scale-95">
          Create Entry
        </button>
      </div>

      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="bg-card hover:bg-muted/30/50 group flex cursor-pointer flex-col items-center justify-center rounded-lg p-8 py-12 text-center shadow-sm ring-1 shadow-slate-200/50 ring-slate-100 transition-colors">
