...
import { FavouriteIcon, InvoiceIcon, ArrowUpRight01Icon, ArrowTurnDownIcon } from '@hugeicons/core-free-icons';
...
export default function DonationReportsPage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Transaction List */}
      <Card className="mt-8 border-border rounded-[var(--radius)]">
        <CardHeader>
              ...
              {transactions.map((txn) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className={`text-sm font-semibold ${txn.amount >= 0 ? 'text-success' : 'text-destructive'}`}>
                      {txn.amount >= 0 ? '+' : ''}
                      {new Intl.NumberFormat('en-IE', { style: 'currency', currency: 'EUR' }).format(txn.amount)}
                    </p>
