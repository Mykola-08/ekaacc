...
export default function RootLayout({
  ...
  return (
    ...
    >
      <a
        href="#main-content"
        className="focus: sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-100 focus:rounded-[calc(var(--radius)*0.8)] focus:bg-white focus:px-4 focus:py-2 focus:font-medium focus:text-blue-600"
      >
