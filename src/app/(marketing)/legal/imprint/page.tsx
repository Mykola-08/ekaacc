...
const content = {
  ...
  es: {
    ...
    intro:
      'En cumplimiento del artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSI-CE), se exponen a continuación los datos identificativos del titular del sitio web.',
    sections: [
      {
  ...
  ca: {
    ...
    intro:
      "En compliment de l'article 10 de la Llei 34/2002, d'11 de juliol, de Serveis de la Societat de la Informació i del Comerç Electrònic (LSSI-CE), s'exposen a continuació les dades identificatives del titular del lloc web.",
    sections: [
      {
  ...
  ru: {
    ...
    intro:
      'В соответствии со статьей 10 Закона 34/2002 от 11 июля об услугах информационного общества и электронной коммерции (LSSI-CE), ниже приведены идентификационные данные владельца веб-сайта.',
    sections: [
      {
