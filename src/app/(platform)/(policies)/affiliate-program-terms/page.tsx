...
export default function AffiliateProgramTerms() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'Estos términos y condiciones rigen su participación en el Programa de Afiliados de EKA Balance. Al unirse a nuestro programa, acepta promocionar nuestros servicios de acuerdo con estos términos.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "Aquests termes i condicions regeixen la vostra participació en el Programa d'Afiliats d'EKA Balance. En unir-vos al nostre programa, accepteu promocionar els nostres serveis d'acord amb aquests termes.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'Эти условия регулируют ваше участие в партнерской программе EKA Balance. Присоединяясь к нашей программе, вы соглашаетесь продвигать наши услуги в соответствии с этими условиями.',
      sections: [
        {
