...
export default function AntiBriberyPolicy() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'EKA Balance tiene una política de tolerancia cero hacia el soborno y la corrupción. Nos comprometemos a actuar de manera profesional, justa e íntegra en todos nuestros tratos y relaciones comerciales dondequiera que operemos.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        'EKA Balance té una política de tolerància zero cap al suborn i la corrupció. Ens comprometem a actuar de manera professional, justa i íntegra en tots els nostres tractes i relacions comercials allà on operem.',
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'EKA Balance придерживается политики нулевой терпимости к взяточничеству и коррупции. Мы обязуемся действовать профессионально, справедливо и честно во всех наших деловых отношениях, где бы мы ни работали.',
      sections: [
        {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="bg-card overflow-hidden rounded-2xl shadow-xl">
        <div className="bg-linear-to-r from-red-700 to-pink-700 px-8 py-12 text-white">
