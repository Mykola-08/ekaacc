...
export default function CcpaNotice() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'Este Aviso de Privacidad para Residentes de California complementa la información contenida en la Política de Privacidad general de EKA Balance y se aplica únicamente a los visitantes, usuarios y otras personas que residen en el Estado de California.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "Aquest Avís de Privadesa per a Residents de Califòrnia complementa la informació continguda en la Política de Privadesa general d'EKA Balance i s'aplica únicament als visitants, usuaris i altres persones que resideixen a l'Estat de Califòrnia.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'Это Уведомление о конфиденциальности для жителей Калифорнии дополняет информацию, содержащуюся в общей Политике конфиденциальности EKA Balance, и применяется исключительно к посетителям, пользователям и другим лицам, проживающим в штате Калифорния.',
      sections: [
        {
