...
export default function CodeOfEthics() {
  ...
  const content = {
    en: {
      ...
      intro:
        'EKA Balance is dedicated to maintaining the highest standards of integrity and ethical conduct. This Code of Ethics guides our decisions and actions, ensuring we act responsibly towards our patients, colleagues, and the community.',
      sections: [
        {
    ...
    es: {
      ...
      intro:
        'EKA Balance se dedica a mantener los más altos estándares de integridad y conducta ética. Este Código de Ética guía nuestras decisiones y acciones, asegurando que actuemos de manera responsable hacia nuestros pacientes, colegas y la comunidad.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "EKA Balance es dedica a mantenir els estàndards més alts d'integritat i conducta ètica. Aquest Codi Ètic guia les nostres decisions i accions, assegurant que actuem de manera responsable envers els nostres pacients, col·legues i la comunitat.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'EKA Balance стремится поддерживать самые высокие стандарты честности и этического поведения. Этот Кодекс этики направляет наши решения и действия, гарантируя, что мы действуем ответственно по отношению к нашим пациентам, коллегам и обществу.',
      sections: [
        {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="bg-card overflow-hidden rounded-2xl shadow-xl">
        <div className="bg-linear-to-r from-amber-500 to-orange-500 px-8 py-12 text-white">
