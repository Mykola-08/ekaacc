...
const content = {
  ...
  es: {
    ...
    intro:
      'Esta Política de Cookies explica cómo EKA Balance utiliza cookies y tecnologías similares para reconocerlo cuando visita nuestro sitio web. Explica qué son estas tecnologías y por qué las usamos, así como sus derechos para controlar nuestro uso de ellas.',
    sections: [
      {
        id: 'what-are-cookies',
  ...
  ca: {
    ...
    intro:
      "Aquesta Política de Cookies explica com EKA Balance utilitza cookies i tecnologies similars per reconèixer-vos quan visiteu el nostre lloc web. Explica què són aquestes tecnologies i per què les utilitzem, així com els vostres drets per controlar el nostre ús d'elles.",
    sections: [
      {
        id: 'what-are-cookies',
  ...
  ru: {
    ...
    intro:
      'Эта Политика использования файлов cookie объясняет, как EKA Balance использует файлы cookie и аналогичные технологии, чтобы распознавать вас, когда вы посещаете наш веб-сайт. В ней объясняется, что это за технологии и почему мы их используем, а также ваши права контролировать их использование нами.',
    sections: [
      {
        id: 'what-are-cookies',
