 ...
 return (
  <div className="max-w-4xl mx-auto">
   ...
   <div className="prose max-w-none dark:prose-invert">
    ...
    <div className="mt-12 p-4 bg-muted/50 rounded-xl text-sm text-muted-foreground text-center">
     <p>
      {lang === 'en' && "By using this website, you accept this disclaimer in full."}
      {lang === 'es' && "Al utilizar este sitio web, usted acepta este descargo de responsabilidad en su totalidad."}
      {lang === 'ca' && "En utilitzar aquest lloc web, accepteu aquest descàrrec de responsabilitat en la seva totalitat."}
      {lang === 'ru' && "Используя этот веб-сайт, вы принимаете этот отказ от ответственности в полном объеме."}
     </p>
    </div>
   </div>
  </div>
