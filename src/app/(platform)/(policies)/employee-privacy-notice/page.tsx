...
export default function EmployeePrivacyNotice() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'Este aviso describe cómo EKA Balance recopila, utiliza y protege la información personal de sus empleados, contratistas y solicitantes de empleo. Nos comprometemos a respetar su privacidad y gestionar sus datos de manera responsable.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "Aquest avís descriu com EKA Balance recopila, utilitza i protegeix la informació personal dels seus empleats, contractistes i sol·licitants d'ocupació. Ens comprometem a respectar la vostra privacitat i gestionar les vostres dades de manera responsable.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'В этом уведомлении описывается, как EKA Balance собирает, использует и защищает личную информацию своих сотрудников, подрядчиков и соискателей. Мы обязуемся уважать вашу конфиденциальность и ответственно управлять вашими данными.',
      sections: [
        {
