...
export default function InformationSecurityPolicy() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'EKA Balance se compromete a proteger la confidencialidad, integridad y disponibilidad de nuestros activos de información. Esta política describe nuestro enfoque para la gestión de la seguridad de la información.',
      sections: [
        {
          id: 'access-control',
    ...
    ca: {
      ...
      intro:
        "EKA Balance es compromet a protegir la confidencialitat, integritat i disponibilitat dels nostres actius d'informació. Aquesta política descriu el nostre enfocament per a la gestió de la seguretat de la informació.",
      sections: [
        {
          id: 'access-control',
    ...
    ru: {
      ...
      intro:
        'EKA Balance стремится защищать конфиденциальность, целостность и доступность наших информационных активов. Эта политика определяет наш подход к управлению информационной безопасностью.',
      sections: [
        {
          id: 'access-control',
