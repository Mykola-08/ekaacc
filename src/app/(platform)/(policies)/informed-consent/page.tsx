...
export default function InformedConsent() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'Este documento sirve como un formulario de consentimiento informado general para el tratamiento en EKA Balance. Los procedimientos específicos pueden requerir formularios de consentimiento adicionales. Lea esto detenidamente y haga cualquier pregunta que pueda tener.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        'Aquest document serveix com a formulari de consentiment informat general per al tractament a EKA Balance. Els procediments específics poden requerir formularis de consentiment addicionals. Llegiu-ho detingudament i feu qualsevol pregunta que tingueu.',
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'Этот документ служит общей формой информированного согласия на лечение в EKA Balance. Конкретные процедуры могут потребовать дополнительных форм согласия. Пожалуйста, внимательно прочитайте это и задайте любые вопросы, которые могут у вас возникнуть.',
      sections: [
        {
