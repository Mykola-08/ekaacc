...
const content = {
  ...
  es: {
    ...
    intro:
      'EKA Balance respeta los derechos de propiedad intelectual de otros y espera que sus usuarios hagan lo mismo. Es nuestra política, en las circunstancias apropiadas y a nuestra discreción, deshabilitar y/o cancelar las cuentas de los usuarios que infrinjan repetidamente o sean acusados repetidamente de infringir los derechos de autor u otros derechos de propiedad intelectual de otros.',
    sections: [
      {
        id: 'eka-ip',
      ...
      },
      {
        id: 'dmca-notice',
        title:
          '4. Aviso y Procedimiento de la DMCA para Reclamaciones de Infracción de Derechos de Autor',
  ...
  ca: {
    ...
    intro:
      "EKA Balance respecta els drets de propietat intel·lectual d'altres i espera que els seus usuaris facin el mateix. És la nostra política, en les circumstàncies apropiades i a la nostra discreció, deshabilitar i/o cancel·lar els comptes dels usuaris que infringeixin repetidament o siguin acusats repetidament d'infringir els drets d'autor o altres drets de propietat intel·lectual d'altres.",
    sections: [
      {
        id: 'eka-ip',
