...
export default function KycAmlPolicy() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'EKA Balance se compromete a prevenir el blanqueo de capitales, la financiación del terrorismo y otros delitos financieros. Implementamos procedimientos sólidos de Conozca a su Cliente (KYC) y Anti-Blanqueo de Capitales (AML).',
      sections: [
        {
          id: 'cdd',
    ...
    ca: {
      ...
      intro:
        'EKA Balance es compromet a prevenir el blanqueig de capitals, el finançament del terrorisme i altres delictes financers. Implementem procediments sòlids de Conegui el seu Client (KYC) i Anti-Blanqueig de Capitals (AML).',
      sections: [
        {
          id: 'cdd',
    ...
    ru: {
      ...
      intro:
        'EKA Balance стремится предотвращать отмывание денег, финансирование терроризма и другие финансовые преступления. Мы внедряем надежные процедуры «Знай своего клиента» (KYC) и борьбы с отмыванием денег (AML).',
      sections: [
        {
          id: 'cdd',
