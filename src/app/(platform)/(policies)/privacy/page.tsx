...
const content = {
  en: {
    ...
    intro:
      'At EKA Balance, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.',
    sections: [
      {
        id: 'collection',
  ...
  ca: {
    ...
    intro:
      "A EKA Balance, ens prenem molt seriosament la vostra privacitat. Aquesta Política de Privacitat explica com recopilem, utilitzem, divulguem i protegim la vostra informació quan visiteu el nostre lloc web i utilitzeu els nostres serveis. Llegiu atentament aquesta política de privacitat. Si no esteu d'acord amb els termes d'aquesta política de privacitat, no accediu al lloc.",
    sections: [
      {
        id: 'collection',
            ...
            <section key={index} id={section.id} className="mb-8 scroll-mt-24">
              ...
              {section.id === 'ccpa' && (
                <button
                  ...
                  className="bg-secondary text-secondary-foreground hover:bg-secondary/90 mt-4 rounded-xl px-4 py-2 text-sm font-medium transition-colors"
                >
