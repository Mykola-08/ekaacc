...
export default function RemoteWorkPolicy() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'EKA Balance apoya el trabajo remoto para brindar flexibilidad y promover el equilibrio entre la vida laboral y personal. Esta política describe las pautas y expectativas para los empleados que trabajan de forma remota.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "EKA Balance dóna suport al treball remot per oferir flexibilitat i promoure l'equilibri entre la vida laboral i personal. Aquesta política descriu les directrius i expectatives per als empleats que treballen de forma remota.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'EKA Balance поддерживает удаленную работу, чтобы обеспечить гибкость и способствовать балансу между работой и личной жизнью. Эта политика определяет руководящие принципы и ожидания для сотрудников, работающих удаленно.',
      sections: [
        {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="bg-card overflow-hidden rounded-2xl shadow-xl">
        <div className="bg-linear-to-r from-blue-600 to-emerald-600 px-8 py-12 text-white">
