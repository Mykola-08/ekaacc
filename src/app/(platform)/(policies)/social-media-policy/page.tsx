...
export default function SocialMediaPolicy() {
  ...
  const content = {
    ...
    es: {
      ...
      intro:
        'Esta política describe las pautas para los empleados y asociados de EKA Balance al usar las redes sociales, tanto profesional como personalmente, para proteger nuestra marca y reputación.',
      sections: [
        {
    ...
    ca: {
      ...
      intro:
        "Aquesta política descriu les directrius per als empleats i associats d'EKA Balance en utilitzar les xarxes socials, tant professionalment com personalment, per protegir la nostra marca i reputació.",
      sections: [
        {
    ...
    ru: {
      ...
      intro:
        'Эта политика определяет руководящие принципы для сотрудников и партнеров EKA Balance при использовании социальных сетей, как в профессиональных, так и в личных целях, для защиты нашего бренда и репутации.',
      sections: [
        {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="bg-card overflow-hidden rounded-2xl shadow-xl">
        <div className="bg-linear-to-r from-cyan-600 to-blue-600 px-8 py-12 text-white">
