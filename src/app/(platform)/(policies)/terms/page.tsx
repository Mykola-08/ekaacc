...
const content = {
  ...
  es: {
    ...
    intro:
      'Lea estos Términos de Servicio ("Términos", "Términos de Servicio") detenidamente antes de utilizar el sitio web y los servicios de EKA Balance (el "Servicio") operados por EKA Balance ("nosotros", "nos" o "nuestro"). Su acceso y uso del Servicio está condicionado a su aceptación y cumplimiento de estos Términos. Estos Términos se aplican a todos los visitantes, usuarios y otras personas que acceden o utilizan el Servicio.',
    sections: [
      {
  ...
  ru: {
    ...
    intro:
      'Пожалуйста, внимательно прочитайте эти Условия обслуживания («Условия», «Условия обслуживания») перед использованием веб-сайта и услуг EKA Balance («Сервис»), управляемых EKA Balance («нас», «мы» или «наш»). Ваш доступ к Сервису и его использование зависят от вашего принятия и соблюдения этих Условий. Эти Условия распространяются на всех посетителей, пользователей и других лиц, которые получают доступ к Сервису или используют его.',
    sections: [
      {
