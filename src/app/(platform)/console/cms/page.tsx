  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-card rounded-4xl p-8 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 flex flex-col items-center justify-center text-center hover:bg-muted/30/50 transition-colors cursor-pointer group py-12">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Pages</h3>
        ...
        <div className="bg-card rounded-2xl p-8 shadow-xl shadow-slate-200/50 ring-1 ring-slate-100 flex flex-col items-center justify-center text-center hover:bg-muted/30/50 transition-colors cursor-pointer group py-12">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Media Library</h3>
            <p className="text-muted-foreground text-sm max-w-[200px]">
