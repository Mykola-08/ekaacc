    ...
    <div className="space-y-6">
      ...
      <div
        className={
          applicationStatus === 'approved'
            ? 'rounded-xl border border-green-500/50 bg-green-500/10 p-4'
            : applicationStatus === 'pending'
              ? 'rounded-xl border border-yellow-500/50 bg-yellow-500/10 p-4'
              : 'rounded-xl border border-red-500/50 bg-red-500/10 p-4'
        }
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-sm">{getStatusDescription()}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground text-xs">Supporting your journey</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground text-xs">2:00 PM</p>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Control what information donors can see about you</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex-1 space-y-0.5">
              <Label className="text-base">Share name with donors</Label>
              <p className="text-muted-foreground text-sm">Allow donors to see your full name</p>
            </div>
            <Switch
          ...
          <Alert>
            ...
            <AlertDescription>
              Your privacy is important. You can change these settings at any time. Financial
              information is never shared with donors.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      {applicationStatus === 'approved' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>This is what donors see when they view your profile</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Get help and learn more about the donation program</CardDescription>
        </CardHeader>
