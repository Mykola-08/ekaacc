        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              ...
              <Badge variant={mockDataEnabled ? 'default' : 'secondary'} className={mockDataEnabled ? 'text-success border-success/20 bg-success/5' : 'text-muted-foreground border-muted/30 bg-muted/10'}>{mockDataEnabled ? 'ENABLED' : 'DISABLED'}</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              ...
              <Badge variant="default" className="text-primary border-primary/20 bg-primary/5">CONNECTED</Badge>
            </div>
          </CardContent>
        </Card>
      </div>
