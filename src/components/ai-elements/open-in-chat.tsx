...
import { ChevronDownIconIcon, ExternalLinkIconIcon, MessageCircleIconIcon } from 'hugeicons-react';
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      ...
      >
        ...
        <ExternalLinkIconIcon className="size-4 shrink-0" />
      </a>
    </DropdownMenuItem>
  );
};
