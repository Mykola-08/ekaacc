...
export function StepAddons() {
  return (
    <div className="grid gap-4">
      {/* Placeholder usage */}
      <div className="group bg-card hover:bg-secondary border-muted hover:border-foreground flex cursor-pointer items-center justify-between rounded-lg border-2 border-dashed p-6 transition-colors">
        <div>
      ...
      <div className="bg-primary/5 text-primary rounded-lg p-6 text-center text-sm font-medium">
