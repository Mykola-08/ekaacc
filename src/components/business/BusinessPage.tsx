  ...
  return (
    <div className="bg-background animate-fade-in min-h-screen">
      ...
      <section className="px-4 py-24 text-center">
        <Card className="border-border relative mx-auto max-w-4xl overflow-hidden p-12 shadow-2xl md:p-20">
          ...
          <Link href="/contact">
            <Button
              size="lg"
              className="relative z-10 h-14 rounded-full px-10 text-lg shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl"
            >
              Get Started
            </Button>
          </Link>
