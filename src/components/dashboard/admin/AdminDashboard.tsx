      ...
      <div className="animate-in fade-in space-y-8 font-sans duration-500">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#111827] p-8 text-white shadow-sm">
          ...
          <div className="relative z-10 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="group flex cursor-pointer items-center gap-4 rounded-xl border border-white/5 bg-[#1f2937] p-4 transition-colors hover:bg-[#253042]">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-100">User & Team</div>
                <div className="text-xs text-gray-500">Manage roles & access</div>
              </div>
            </div>
            ...
            <div className="group flex cursor-pointer items-center gap-4 rounded-xl border border-white/5 bg-[#1f2937] p-4 transition-colors hover:bg-[#253042]">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-100">Finance & Pricing</div>
                <div className="text-xs text-gray-500">Track revenue & invoices</div>
              </div>
            </div>
            ...
            <div className="group flex cursor-pointer items-center gap-4 rounded-xl border border-white/5 bg-[#1f2937] p-4 transition-colors hover:bg-[#253042]">
              ...
              <div>
                <div className="text-sm font-semibold text-gray-100">System Health</div>
                <div className="text-xs text-gray-500">Logs, errors & flags</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex gap-4">
              <div className="min-w-[160px] rounded-2xl border border-gray-100 bg-gray-50/50 p-5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-gray-700">Healthy</span>
                </div>
              </div>
              ...
              <div className="min-w-[160px] rounded-2xl border border-gray-100 bg-gray-50/50 p-5">
                ...
                <div className="text-2xl font-bold text-gray-900">{stats?.users_total || 2}</div>
              </div>
            </div>
          </div>
        </div>
