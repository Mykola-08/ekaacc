...
const Element = ({ attributes, children, element }: RenderElementProps) => {
  ...
  switch ((element as any).type) {
    case 'block-quote':
      return (
        <blockquote style={style} {...attributes} className="border-l-4 border-muted-foreground pl-4 italic">
          {children}
        </blockquote>
      )
    case 'bulleted-list':
    ...
    case 'heading-one':
      return (
        <h1 style={style} {...attributes} className="text-3xl font-bold mt-6 mb-4">
          {children}
        </h1>
      )
    case 'heading-two':
      return (
        <h2 style={style} {...attributes} className="text-2xl font-bold mt-5 mb-3">
          {children}
        </h2>
      )
    case 'heading-three':
      return (
        <h3 style={style} {...attributes} className="text-xl font-bold mt-4 mb-2">
          {children}
        </h3>
      )
    case 'list-item':
