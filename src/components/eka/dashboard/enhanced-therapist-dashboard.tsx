...
const BookingCalendar = dynamic(() => import('@/components/eka/booking-calendar'));
const SessionAssessmentForm = dynamic(() => import('@/components/eka/forms/session-assessment-form').then(m => m.SessionAssessmentForm));
