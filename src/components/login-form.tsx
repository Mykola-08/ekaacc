...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="eka-card-elevated overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              {error && (
                <Alert variant="destructive" className="eka-alert-destructive">
                  <AlertDescription>{error}</AlertDescription>
                </Alert>
              )}

              <div className="eka-form-group">
                <Label htmlFor="email" className="eka-form-label">Email</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="eka-form-group">
                <div className="flex items-center">
                  <Label htmlFor="password" className="eka-form-label">Password</Label>
                  <a
                    href="/forgot-password"
                    className="ml-auto text-sm underline-offset-2 hover:underline eka-transition"
                  >
              ...
              <Button type="submit" className="w-full eka-transition" disabled={isLoading}>
                {isLoading ? (
                  <>
              ...
              <div className={cn(
                ...
                <Button variant="outline" className="w-full eka-transition" type="button" disabled={isLoading} onClick={() => signInWithOAuth('google')}>
                ...
                {enabledProviders.x && (
                <Button variant="outline" className="w-full eka-transition" type="button" disabled={isLoading} onClick={() => signInWithOAuth('twitter')}>
                ...
                <Button variant="outline" className="w-full eka-transition" type="button" disabled={isLoading} onClick={() => signInWithOAuth('linkedin')}>
              ...
              <div className="text-center text-sm">
                ...
                <a href="/signup" className="underline underline-offset-4 eka-transition hover:text-primary">
                  Sign up
                </a>
              </div>
            </div>
