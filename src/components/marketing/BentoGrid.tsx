  ...
  return (
    ...
    >
      ...
      <motion.div variants={item} className="row-span-2 md:col-span-2 lg:col-span-2">
        <Card className="group relative h-full min-h-[400px] overflow-hidden rounded-2xl border-none shadow-sm">
      ...
      <motion.div variants={item}>
        <Card className="bg-primary/5 flex h-full flex-col items-center justify-center rounded-2xl border-none p-8 text-center shadow-none">
          <div className="text-primary mb-4 flex size-12 items-center justify-center rounded-2xl bg-white shadow-sm">
      ...
      <motion.div variants={item} className="md:col-span-2 lg:col-span-1">
        <Card className="flex h-full flex-col rounded-2xl bg-black p-8 text-white">
      ...
      <motion.div variants={item} className="md:col-span-1 lg:col-span-1">
        <Card className="group relative h-full overflow-hidden rounded-2xl border-none bg-gradient-to-br from-blue-500 to-indigo-600 p-8 text-white transition-transform hover:scale-105">
          ...
          <div className="absolute top-0 right-0 -mt-16 -mr-16 size-32 rounded-full bg-white/10 blur-3xl" />
        </Card>
      </motion.div>
