...
export default function ChildrenContent() {
  ...
  const Hero = (
    <section className="relative overflow-hidden bg-linear-to-br from-white via-blue-50/30 to-indigo-50/50 py-12 sm:py-20">
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-8">
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="group relative overflow-hidden rounded-[20px] border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:border-blue-200 hover:shadow-xl">
