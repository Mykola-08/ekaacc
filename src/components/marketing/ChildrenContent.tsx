...
export default function ChildrenContent() {
  ...
  const Hero = (
    <section className="relative overflow-hidden bg-linear-to-br from-background via-info/10 to-accent/10 py-12 sm:py-20">
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-all duration-300 hover:border-info hover:shadow-xl">
              ...
              <div className="p-8">
                ...
                <h3 className="mb-3 text-2xl font-light text-foreground transition-colors group-hover:text-info-foreground">
                ...
                <Link
                  ...
                  className="inline-flex items-center font-medium text-primary transition-colors hover:text-info-foreground"
                >
