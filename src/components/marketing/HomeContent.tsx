...
import { BentoCard } from '@/components/marketing/ui/bento-card';
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[320px] md:auto-rows-[280px]">
            ...
            <BentoCard href="/services/kinesiology" delay={0.1} className="md:col-span-2 md:row-span-1">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-[60%] md:w-1/2 z-0 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-r from-[#f5f5f7] via-[#f5f5f7]/80 to-transparent pointer-events-none" />
              </div>
            ...
            <BentoCard href="/cases" delay={0.3} className="md:col-span-1 md:row-span-1">
              <div className="absolute inset-0 z-0 bg-[#fff5f5]" />
      ...
      <section className="py-24 relative overflow-hidden bg-[#f5f5f7]">
        <div className="section-container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            ...
            >
              <div className="relative w-full max-w-md aspect-4/5 rounded-3xl overflow-hidden bg-white">
                <Image
            ...
            >
              ...
              <Link href="/about" className="inline-block pt-4">
                <Button variant="default" size="lg" className="px-10 py-6 text-lg h-auto shadow-sm">
                  {t('common.readMore')}
                </Button>
              </Link>
            </motion.div>
      ...
      <section className="py-32 bg-white">
        <div className="section-container">
          ...
          <div className="mt-16 text-center">
            <Link href="/services">
              <Button variant="default" size="lg" className="px-10 py-6 text-lg h-auto">
                {t('services.viewAll')}
              </Button>
            </Link>
          </div>
