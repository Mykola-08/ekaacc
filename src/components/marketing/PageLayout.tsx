    ...
    <div className={`min-h-screen bg-white ${className || ''}`}>
      {hero && (
        <div className="relative">
          <div className="pointer-events-none absolute inset-0 -z-10 bg-[url('/grid.svg')] bg-center opacity-50 [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" />
          {renderHero()}
        </div>
      )}
      <main>{children}</main>
