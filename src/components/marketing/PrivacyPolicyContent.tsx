      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-8">
        <div className="rounded-apple-xl overflow-hidden border border-border bg-card p-8 shadow-xl shadow-primary/5 md:p-12">
          ...
          <div className="mb-12">
            ...
            <div className="rounded-[20px] border border-warning/30 bg-warning p-6">
              ...
              <ul className="ml-5 list-disc space-y-2 text-foreground">
                <li>
                  Do not stop prescribed medication or clinical care based on website content.
                </li>
                <li>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4 rounded-[20px] bg-muted p-6">
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="w-32 shrink-0 font-medium text-foreground">Name:</span>
                <span className="text-foreground">Olena Kucherova Dryzhak (EKA Balance)</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="w-32 shrink-0 font-medium text-foreground">Address:</span>
                <span className="text-foreground">Calle Plata 1, 08191 Rubí, Barcelona, Spain</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="w-32 shrink-0 font-medium text-foreground">Phone:</span>
                <span className="text-foreground">+34 658 867 133</span>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="w-32 shrink-0 font-medium text-foreground">Email:</span>
                <a
                  href="mailto:legal@ekabalance.com"
                  className="text-primary transition-colors hover:text-info-foreground"
                >
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4 rounded-[20px] border border-info bg-info/50 p-6">
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="w-32 shrink-0 font-medium text-foreground">Name:</span>
            ...
            <p className="mt-4 text-sm leading-relaxed font-light text-muted-foreground">
              You may contact our DPO directly for any privacy-related inquiries, complaints, or to
          ...
          <div className="mb-12">
            ...
            <p className="mb-8 leading-relaxed text-foreground">
              We collect all types of personal, technical, behavioral, and sensitive data, including
            ...
            <div className="space-y-8">
              <div className="border-l-4 border-info pl-6">
                ...
                <ul className="space-y-3 text-foreground">
                  <li className="flex items-start">
                    <span className="mt-2 mr-3 h-2 w-2 shrink-0 rounded-full bg-info"></span>
                    Full name
                  </li>
                  <li className="flex items-start">
                    <span className="mt-2 mr-3 h-2 w-2 shrink-0 rounded-full bg-info"></span>
              ...
              <div className="border-l-4 border-destructive/30 pl-6">
                ...
                <ul className="space-y-3 text-foreground">
                  <li className="flex items-start">
                    <span className="mt-2 mr-3 h-2 w-2 shrink-0 rounded-full bg-destructive/60"></span>
                    Health information
                  </li>
                  <li className="flex items-start">
                    <span className="mt-2 mr-3 h-2 w-2 shrink-0 rounded-full bg-destructive/60"></span>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-[20px] border border-success bg-success/50 p-6">
                <h3 className="mb-3 text-lg font-medium text-foreground">
                  2.1 Consent (Article 6(1)(a))
                </h3>
                <p className="mb-4 text-sm text-foreground">We rely on your explicit consent for:</p>
              ...
              <div className="rounded-[20px] border border-info bg-info/50 p-6">
                ...
                <p className="mb-4 text-sm text-foreground">Processing is necessary for:</p>
                <ul className="space-y-2 text-sm text-foreground">
              ...
              <div className="rounded-[20px] border border-accent bg-accent/50 p-6">
                <h3 className="mb-3 text-lg font-medium text-foreground">2.3 Legal Obligations</h3>
              ...
              <div className="rounded-[20px] border border-warning/20 bg-warning/50 p-6">
                <h3 className="mb-3 text-lg font-medium text-foreground">2.4 Legitimate Interests</h3>
                <p className="mb-4 text-sm text-foreground">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              <div className="rounded-[20px] border border-border bg-muted/50 p-6">
                <h3 className="mb-3 text-lg font-medium text-foreground">
                  3.1 Right of Access (Article 15)
                </h3>
                <p className="mb-4 text-foreground">You have the right to obtain:</p>
                ...
                <div className="mt-4 rounded-xl border border-border bg-card p-4">
                  <p className="text-sm text-muted-foreground">
                    <strong>Response Time:</strong> We will respond within 30 days of receiving your
                    request.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-[20px] border border-border bg-muted/50 p-6">
                ...
                <p className="mb-4 text-foreground">
                  You have the right to obtain the erasure of personal data concerning you where one
            ...
            <div className="mt-8 rounded-[20px] border border-info bg-info/50 p-6">
              <h4 className="mb-3 font-medium text-foreground">Exercising Your Rights</h4>
              <p className="mb-4 text-foreground">
                To exercise any of your rights, please contact us:
              </p>
              <div className="space-y-2">
                <div className="flex flex-col sm:flex-row">
                  <span className="w-24 font-medium text-foreground">Email:</span>
                  <a href="mailto:dpo@ekabalance.com" className="text-primary hover:text-info-foreground">
                    dpo@ekabalance.com
                  </a>
                </div>
              </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-6">
              <div className="rounded-[20px] border border-border bg-muted p-6">
                <h3 className="mb-4 text-lg font-medium text-foreground">
                  Data Protection Officer (DPO)
                </h3>
              ...
              <div className="rounded-[20px] border border-destructive/20 bg-destructive/5 p-6">
                <h3 className="mb-4 text-lg font-medium text-foreground">Supervisory Authority</h3>
                <p className="mb-4 text-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-foreground">C/ Jorge Juan, 6, 28001 Madrid, Spain</div>
