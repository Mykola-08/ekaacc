...
import { useScrollLock } from '@/hooks/marketing/useScrollLock';
    ...
    <>
      ...
      >
        <button
          ...
          className="relative text-left flex flex-col justify-end w-full h-full min-h-105 rounded-3xl overflow-hidden group outline-none isolate border border-secondary/50 bg-[#fbfbfd] transition-all duration-500 will-change-transform active:scale-[0.98]"
        >
          <motion.div
        ...
        {isOpen && (
          <div className="fixed inset-0 z-100 flex items-end sm:items-center justify-center sm:p-6" onClick={() => setIsOpen(false)}>
            ...
            <motion.div
               ...
               className="relative w-full max-w-5xl bg-white rounded-t-[2rem] sm:rounded-3xl overflow-hidden z-10 h-[90vh] sm:h-[80vh] flex flex-col"
               ...
               <div className="flex flex-col md:flex-row w-full h-full">
                 {image ? (
                    <>
                      ...
                      <div className="flex-1 p-6 sm:p-8 md:p-10 flex flex-col overflow-y-auto overscroll-contain">
                    ...
                    <div className="flex-1 p-6 sm:p-8 flex flex-col overflow-y-auto overscroll-contain pt-12 sm:pt-8">
