      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 animate-fade-in">
       ...
       <div className="grid gap-8 lg:grid-cols-3 animate-slide-up">
            ...
            <div className="lg:col-span-2 space-y-8">
                 ...
                 <div className="space-y-4">
                     {courses.map((course, i) => (
                         <div key={i} className="group bg-card rounded-3xl p-4 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col sm:flex-row items-center gap-6 cursor-pointer">
                             ...
                             <div className="grow w-full text-center sm:text-left">
                                 <h3 className="text-xl font-bold text-foreground mb-2 group-hover:text-indigo-600 transition-colors">{course.title}</h3>
            ...
            <div className="space-y-6">
                {/* Certificates */}
                <div className="bg-card rounded-4xl border border-gray-100 shadow-sm p-8">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                         ...
                         <div className="aspect-square rounded-2xl bg-muted/30 border border-gray-100 flex flex-col items-center justify-center text-center p-3 opacity-50">
                ...
                <div className="bg-linear-to-br from-green-500 to-emerald-600 rounded-4xl p-8 text-white shadow-lg relative overflow-hidden">
                    ...
                    <div className="bg-card/20 backdrop-blur-sm rounded-xl p-3 text-xs font-medium text-white relative z-10 inline-block">
                        Read more &rarr;
                    </div>
                </div>
            </div>
