...
export function AuthGuard({
  ...
  if (isLoading) {
    return <>{loadingComponent || <div className="flex justify-center p-4">Loading...</div>}</>;
  }
  ...
  if (!isAuthenticated) {
    ...
    return (
      <>
        {fallback || <div className="p-4 text-center">Please sign in to access this content.</div>}
      </>
    );
  }
