          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="p-4 border rounded-lg bg-muted/30">
                ...
                <p className="text-xs text-muted-foreground">Required for basic site functionality like security, network management, and accessibility.</p>
              </div>
              ...
              <div className="p-4 border rounded-lg hover:border-primary/50 transition-colors">
                ...
                <p className="text-xs text-muted-foreground">Help us understand how visitors interact with the website by collecting and reporting information anonymously.</p>
              </div>
              ...
              <div className="p-4 border rounded-lg hover:border-primary/50 transition-colors">
                ...
                <p className="text-xs text-muted-foreground">Used to track visitors across websites to display ads that are relevant and engaging for the individual user.</p>
              </div>
              ...
              <div className="p-4 border rounded-lg hover:border-primary/50 transition-colors">
                ...
                <p className="text-xs text-muted-foreground">Enable the website to provide enhanced functionality and personalization, such as live chats and videos.</p>
              </div>
            </div>
