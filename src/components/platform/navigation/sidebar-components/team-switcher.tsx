      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            ...
            sideOffset={12}
          >
            <DropdownMenuLabel className="text-muted-foreground px-2 py-1.5 text-[10px] font-semibold tracking-widest uppercase opacity-50">
              Accounts
            </DropdownMenuLabel>
            <DropdownMenuItem className="cursor-pointer gap-3 rounded-xl p-2">
              ...
              <DropdownMenuShortcut className="ml-auto text-[10px] font-semibold opacity-50">
                âŒ˜1
              </DropdownMenuShortcut>
            </DropdownMenuItem>
