...
import { TierBadge, TierBadgeGradient } from '@/components/platform/tiers/tier-badge';
import {
...
export function UserTierDashboard({ userId, className }: UserTierDashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'benefits' | 'progress' | 'history'>(
    'overview'
  );
  ...
  const getVipBenefits = (data: typeof tierData) =>
    data
      ? [
          {
  ...
  const getLoyaltyBenefits = (data: typeof tierData) =>
    data
      ? [
          {
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent className="space-y-4">
            {tierData?.currentTiers?.vip && (tierData?.usage as any)?.vip ? (
              <>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground text-sm">Sessions Used</span>
          ...
          <CardContent className="space-y-4">
            {tierData?.currentTiers?.loyalty && (tierData?.usage as any)?.loyalty ? (
              <>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground text-sm">Points Multiplier</span>
                  <Badge variant="secondary">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground text-sm">Discount Available</span>
                  <Badge variant="secondary">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Based on your current {tierData.currentTiers.vip?.tier} VIP and{' '}
                  {tierData.currentTiers.loyalty?.tier} Loyalty tiers
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <TierBenefitsList
                      benefits={getLoyaltyBenefits(tierData)}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-muted/30 flex items-center gap-4 rounded-lg p-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground text-sm">January 10, 2024</p>
                  </div>
                  <Badge variant="outline">Active</Badge>
                </div>
              </div>
