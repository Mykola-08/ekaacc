...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "bg-secondary/50 shadow-none flex items-center gap-2 rounded-xl border-none px-4 text-sm font-medium [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none",
        className
      )}
      {...props}
    />
