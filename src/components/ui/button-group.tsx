...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "bg-secondary/50 flex items-center gap-2 rounded-xl border-none px-4 text-sm font-medium shadow-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
