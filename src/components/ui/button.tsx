...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 apple-button touch-friendly focus-visible-mobile",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-transparent hover:bg-muted/50 hover:border-primary/50 hover:shadow-sm",
        secondary:
