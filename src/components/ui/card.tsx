...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card bg-card text-card-foreground border-border flex flex-col gap-6 overflow-hidden rounded-2xl border py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-[24px] *:[img:last-child]:rounded-b-[24px]',
        className
      )}
      {...props}
    />
