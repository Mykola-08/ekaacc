  ...
  return (
    <SlateElement className="my-4 flex w-full items-stretch" {...props}>
      <div className="flex w-full flex-col md:flex-row">
        <div className="bg-muted/50 relative h-full min-w-0 flex-1 rounded-[calc(var(--radius)*0.6)] p-8 pr-4">
        ...
        <div className="bg-muted/30 relative flex min-w-0 flex-1 items-center justify-center rounded-[calc(var(--radius)*0.6)] border p-4">
