  ...
  return (
    <SlateElement className="my-4 flex w-full items-stretch" {...props}>
      <div className="flex w-full flex-col md:flex-row">
        <div className="relative h-full min-w-0 flex-1 rounded-[calc(var(--radius)*0.6)] bg-muted/50 p-8 pr-4">
        ...
        <div className="relative flex min-w-0 flex-1 items-center justify-center rounded-[calc(var(--radius)*0.6)] border bg-muted/30 p-4">
