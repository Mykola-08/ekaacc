...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-foreground/10 fixed inset-0 z-50 supports-backdrop-filter:backdrop-blur-xs',
        className
      )}
      {...props}
    />
