    ...
    variants: {
      variant: {
        comment: cn(
          ...
          'rounded-[calc(var(--radius)*0.6)] border-[1.5px] border-transparent bg-transparent',
        ...
        demo: 'h-[650px]',
        select: cn(
          'group rounded-[calc(var(--radius)*0.6)] border border-input ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
...
const editorVariants = cva(
  cn(
    ...
    'rounded-[calc(var(--radius)*0.6)] ring-offset-background focus-visible:outline-none',
