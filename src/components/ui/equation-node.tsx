...
import { ArrowDown01Icon, SquareIcon } from 'hugeicons-react';
import {
          ...
          >
            {props.element.texExpression.length > 0 ? (
              ...
              <div className="text-muted-foreground flex h-7 w-full items-center gap-2 text-sm whitespace-nowrap">
                <SquareIcon className="text-muted-foreground/80 size-6" />
        ...
        <PopoverTrigger asChild>
          ...
          >
            ...
            {element.texExpression.length === 0 && (
              <span>
                <SquareIcon className="mr-1 inline-block h-[19px] w-4 py-[1.5px] align-text-bottom" />
                New equation
              </span>
            )}
          </div>
  ...
  return (
    ...
    >
      ...
      <Button variant="secondary" className="px-3" onClick={onClose}>
        Done <ArrowDown01Icon className="size-3.5" />
      </Button>
    </PopoverContent>
  );
};
