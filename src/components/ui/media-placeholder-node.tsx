...
import { AiAudioIcon, FileUploadIcon, Film01Icon, Image01Icon, Loading03Icon } from 'hugeicons-react';
              ...
              {loading && !isImage && (
                <div className="mt-1 flex items-center gap-1.5">
                  ...
                  <div className="flex items-center">
                    <Loading03Icon className="text-muted-foreground mr-1 size-3.5 animate-spin" />
                    {progress ?? 0}%
                  </div>
                </div>
              )}
    ...
    <div className={cn('relative', className)} contentEditable={false}>
      ...
      {progress < 100 && (
        <div className="absolute right-1 bottom-1 flex items-center space-x-2 rounded-full bg-black/50 px-1 py-0.5">
          <Loading03Icon className="text-muted-foreground size-3.5 animate-spin" />
