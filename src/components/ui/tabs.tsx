  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        '=line]/tabs-list:data-active:border-transparent =line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent',
        'data-active:bg-background :text-foreground :border-input :bg-input/30 data-active:text-foreground',
