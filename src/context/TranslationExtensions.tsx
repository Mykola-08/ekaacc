...
export const servicesTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'casos.section.subtitle': 'Anàlisi precisa i tractament sistèmic per a la recuperació integral de la salut.',
    ...
    'casos.problems.backPain.description': 'Tractament de la compressió discal, rectificació cervical i desequilibris posturals crònics mitjançant descompressió axial i reeducació neuromuscular.',
    'casos.problems.stress.title': 'Desregulació del Sistema Nerviós',
    'casos.problems.stress.description': 'Intervenció en estats d\'hiperactivació simpàtica, ansietat somatitzada i bloquejos diafragmàtics per restablir l\'homeòstasi vagal.',
    'casos.problems.digestive.title': 'Disfunció Visceral i Digestiva',
    'casos.problems.digestive.description': 'Abordatge de la motilitat visceral i l\'eix intestí-cervell per resoldre inflamacions, dispèpsies i bloquejos emocionals somatitzats.',
    'casos.problems.migraines.title': 'Cefalees i Tensió Cranial',
    'casos.problems.migraines.description': 'Descompressió de la base del crani i sutures cranials per alleujar migranyes tensionals, bruxisme i fatiga neurosensorial.',
    'casos.problems.lowEnergy.title': 'Síndrome de Fatiga Crònica',
    'casos.problems.lowEnergy.description': 'Reactivació metabòlica i desbloqueig de l\'estancament limfàtic per combatre l\'esgotament sistèmic i la letargia.',
    'casos.problems.sleep.title': 'Trastorns del Son i del Descans',
    'casos.problems.sleep.description': 'Regulació dels cicles circadians i del sistema parasimpàtic per induir un son profund, reparador i lliure d\'interrupcions.',
    // Massatge Page
    ...
    'agenyz.page.description': 'Biohacking i nutrició que treballen a nivell cel·lular. Restaura l\'energia, la immunitat i la joventut des de dins.',
    ...
    'agenyz.benefits.antiaging.desc': 'Combat l\'estrès oxidatiu i alenteix els processos d\'envelliment.',
    ...
    'hero.description': 'Un viatge de 90 minuts per mapar el teu paisatge físic, emocional i energètic. No és només un diagnòstic — és el primer pas per tornar a casa, al teu cos.',
    ...
    'why.physical.desc': 'On viu la tensió. Llegim l\'estructura, la fàscia i la postura per trobar on estàs aguantant.',
    'why.emotional.title': 'El Cos Emocional',
    'why.emotional.desc': 'On s\'emmagatzema la història. Les emocions no processades es converteixen en bloquejos físics.',
    'why.energetic.title': 'El Cos Energètic',
    'why.energetic.desc': 'On flueix la vitalitat. Restaurem el flux perquè la sanació pugui ocórrer naturalment.',
    'service.title': 'L\'Experiència',
    'service.step1.title': '1. L\'Entrevista Profunda',
    'service.step1.desc': 'Més enllà de l\'historial mèdic. Parlem de la teva vida, el teu estrès, els teus somnis i el que el teu cos ha estat intentant dir-te.',
    'service.step2.title': '2. El Mapeig Corporal',
    'service.step2.desc': 'Una lectura pràctica de la teva estructura. Identifiquem desequilibris, restriccions fascials i àrees d\'energia estancada.',
    'service.step3.title': '3. La Sessió d\'Integració',
    'service.step3.desc': 'Utilitzant una barreja de modalitats (massatge, kinesiologia, treball energètic) per començar el procés de desbloqueig i realineament.',
    'service.step4.title': '4. El Pla de Ruta',
    'service.step4.desc': 'No marxes amb les mans buides. Rebràs un pla personalitzat amb exercicis, consells d\'estil de vida i recomanacions de tractament.',
    ...
    'variants.alignment.desc': 'Per a un treball més profund. Inclou Mapeig + 2 sessions de seguiment focalitzades.',
    ...
    'prompt.techniquesDesc': 'massatge terapèutic, kinesiologia, osteobalance, moviment conscient (Feldenkrais), respiració i regulació del sistema nerviós',
    'prompt.layeredProcesses': 'Processos en capes',
    'prompt.layeredDesc': 'alliberar tensió, reordenar patrons i consolidar nous hàbits corporals i emocionals',
    ...
    'prompt.forWhoDesc': 'Per a persones que volen canvis reals i consistents, no solucions ràpides. Si estàs preparada per escoltar-te i comprometre\'t amb el teu benestar, aquest treball és per a tu.',
    ...
    'benefits.benefit1.science': 'El treball corporal integratiu estimula el nervi vag, millorant la comunicació cervell-cos i la funció executiva.',
    'benefits.benefit2.title': 'Equilibri Emocional',
    'benefits.benefit2.description': 'Major resistència emocional i regulació',
    'benefits.benefit2.science': 'Les tècniques somàtiques ajuden a processar el trauma emmagatzemat i regular els patrons de resposta a l\'estrès del sistema nerviós.',
    'benefits.benefit3.title': 'Energia Sostinguda',
    'benefits.benefit3.description': 'Vitalitat natural sense estimulació artificial',
    'benefits.benefit3.science': 'Abordar les restriccions fascials i els desequilibris posturals redueix el malbaratament d\'energia metabòlica, augmentant la vitalitat natural.',
    ...
    'benefits.benefit4.science': 'L\'enfocament 360° aborda les causes arrel en lloc dels símptomes, creant canvis neuroplàstics duradors en la percepció del dolor.',
    'benefits.benefit5.title': 'Millor Son',
    'benefits.benefit5.description': 'Cicles de son més profunds i reparadors',
    'benefits.benefit5.science': 'La regulació del sistema nerviós i l\'alliberament de tensions promouen ritmes circadians saludables i arquitectura del son.',
    ...
    'benefits.benefit6.science': 'Construir el to parasimpàtic a través del treball corporal augmenta la resistència a l\'estrès i la capacitat de recuperació.',
    'benefits.benefit7.title': 'Llibertat de Moviment',
    'benefits.benefit7.description': 'Millor mobilitat i consciència corporal',
    'benefits.benefit7.science': 'L\'alliberament fascial i la reeducació del moviment restauren els patrons naturals de moviment i la consciència propioceptiva.',
    ...
    'benefits.benefit8.science': 'La consciència interoceptiva desenvolupada a través del treball corporal millora les sensacions viscerals i la claredat en la presa de decisions.',
    'benefits.benefit9.title': 'Vitalitat',
    'benefits.benefit9.description': 'Renovat sentit de vida i presència',
    'benefits.benefit9.science': 'Eliminar bloquejos energètics i restaurar el flux crea millores mesurables en la força vital i presència.',
    'benefits.science': 'La Ciència',
    'benefits.philosophy': 'Mesurem l\'èxit no només en l\'absència de símptomes, sinó en la presència de vitalitat, goig, i el coneixement profund que el teu cos és el teu aliat en la vida.',
    ...
    'testimonials.maria.quote': 'Després de 15 anys de dolor, finalment em sento com jo mateixa un altre cop. L\'enfocament 360° no només va arreglar el meu coll — em va tornar la meva confiança.',
    'testimonials.maria.result': 'Dolor reduït de 8/10 a 1/10, nivells d\'estrès dramàticament millorats',
    ...
    'testimonials.david.quote': 'Pensava que coneixia el meu cos com a atleta. El mapeig 360° va revelar patrons que mai vaig saber que existien. El meu rendiment i recuperació han assolit nous nivells.',
    'testimonials.david.result': '25% de millora en temps de recuperació, va eliminar lesions recurrents',
    ...
    'testimonials.david.after': 'Entrenament lliure de lesions, recuperació més ràpida, nous rècords personals',
    'testimonials.jennifer.name': 'Jennifer',
    'testimonials.jennifer.issue': 'Recuperació post-quirúrgica i mobilitat',
    'testimonials.jennifer.quote': 'Després de la meva cirurgia, em sentia desconnectada del meu cos. La sanació aquí va ser més enllà del físic — vaig aprendre a confiar en el meu cos un altre cop.',
    'testimonials.jennifer.result': 'Mobilitat completa restaurada, confiança en el moviment retornada',
    'testimonials.jennifer.timeframe': '4 mesos',
    'testimonials.jennifer.before': 'Mobilitat limitada, por al moviment, depressió',
    'testimonials.jennifer.after': 'Rang complet de moviment, goig en el moviment, sanació emocional',
    'testimonials.alex.name': 'Alex',
    'testimonials.alex.issue': 'Ansietat i desregulació del sistema nerviós',
    'testimonials.alex.quote': 'Vaig venir per ansietat, sense esperar que el treball corporal ajudés. Però quan van explicar com el meu sistema nerviós estava encallat, tot va tenir sentit. Em sento calm al meu cos per primera vegada en anys.',
    ...
    'testimonials.keyInsight1': 'Com l\'enfocament 360° va abordar les causes arrel, no només els símptomes',
    ...
    'testimonials.videoImplementation': 'En una implementació real, això seria contingut de vídeo incorporat',
    'story.title': 'Un Viatge de Sanació',
    'story.intro': 'La Sarah va arribar a nosaltres carregant el pes de deu anys...',
    'story.paragraph1': 'Les espatlles de la Sarah van parlar abans que ella. Corbades cap endins com un closca protector, guardaven la història d\'innombrables nits sense dormir, de correus respostos a mitjanit, d\'una promoció que va venir amb un preu que el seu cos encara estava pagant.',
    'story.paragraph2': '"Només vull que el meu coll deixi de doler," va dir durant la nostra primera sessió. Però el seu cos murmurava veritats més profundes — sobre la por allotjada al seu pit, l\'ansietat que havia pres residència a la seva mandíbula, l\'esgotament que vivia als seus mateixos ossos.',
    'story.paragraph3': 'L\'enfocament 360° no només va abordar el seu coll. Vam treballar amb els patrons emocionals que van crear la tensió, els desequilibris estructurals que la mantenien, i els bloquejos energètics que impedien la sanació. Vam escoltar el que el seu cos necessitava per tornar a sentir-se segur.',
    'story.paragraph4': 'Tres mesos després, la Sarah es posava diferent. No només més dreta — es posava com algú que va recordar que tenia permís per ocupar espai. El seu dolor de coll s\'havia convertit en una porta per reclamar parts de si mateixa que havia oblidat que existien.',
    'story.paragraph5': '"No només vaig recuperar el meu cos," ens va dir. "Vaig recuperar la meva vida."',
    'story.philosophy': 'Cada cos té una història. Cada història mereix ser escoltada amb la plenitud que conté — no només els símptomes, sinó tota l\'experiència humana que hi ha sota d\'ells.',
    ...
    'footer.description': 'Transformant vides a través de la sanació integral del cos, ment i esperit. El teu viatge cap al benestar complet comença aquí.',
  ...
  en: {
    ...
    'elena.about.p1': 'Elena Kuchera is an integrative therapist with over 10 years dedicated to deep work with the body, mind and emotional state of people. She has studied in 9 different countries and resolved over 500 cases, transforming physical and emotional suffering into consciousness, freedom and vitality.',
    ...
    'agenyz.page.description': 'Biohacking and nutrition working at the cellular level. Restore energy, immunity, and youthfulness from the inside out.',
    ...
    'hero.description': 'A 90-minute journey to map your physical, emotional, and energetic landscape. It\'s not just a diagnosis — it\'s the first step to coming home to your body.',
    ...
    'why.physical.desc': 'Where tension lives. We read structure, fascia, and posture to find where you are holding on.',
    'why.emotional.title': 'The Emotional Body',
    'why.emotional.desc': 'Where history is stored. Unprocessed emotions become physical blockages.',
    ...
    'service.step1.desc': 'Beyond medical history. We talk about your life, your stress, your dreams, and what your body has been trying to tell you.',
    'service.step2.title': '2. The Body Mapping',
    'service.step2.desc': 'A hands-on reading of your structure. We identify imbalances, fascial restrictions, and areas of stagnant energy.',
    'service.step3.title': '3. The Integration Session',
    'service.step3.desc': 'Using a blend of modalities (massage, kinesiology, energy work) to begin the process of unlocking and realigning.',
    'service.step4.title': '4. The Roadmap',
    'service.step4.desc': 'You don\'t leave empty-handed. You receive a personalized plan with exercises, lifestyle tips, and treatment recommendations.',
    ...
    'prompt.techniquesDesc': 'therapeutic massage, kinesiology, osteobalance, conscious movement (Feldenkrais), breathing and nervous system regulation',
    ...
    'prompt.forWhoDesc': 'For people who want real and consistent changes, not quick solutions. If you are ready to listen to yourself and commit to your well-being, this work is for you.',
    'prompt.booking': 'Book',
    ...
    'benefits.benefit1.science': 'Integrative bodywork stimulates the vagus nerve, improving brain-body communication and executive function.',
    'benefits.benefit2.title': 'Emotional Balance',
    'benefits.benefit2.description': 'Greater emotional resilience and regulation',
    'benefits.benefit2.science': 'Somatic techniques help process stored trauma and regulate nervous system stress response patterns.',
    'benefits.benefit3.title': 'Sustained Energy',
    'benefits.benefit3.description': 'Natural vitality without artificial stimulation',
    'benefits.benefit3.science': 'Addressing fascial restrictions and postural imbalances reduces metabolic energy waste, increasing natural vitality.',
    'benefits.benefit4.title': 'Pain Relief',
    'benefits.benefit4.description': 'Lasting relief from chronic pain patterns',
    'benefits.benefit4.science': 'The 360° approach addresses root causes rather than symptoms, creating lasting neuroplastic changes in pain perception.',
    'benefits.benefit5.title': 'Better Sleep',
    'benefits.benefit5.description': 'Deeper, more restorative sleep cycles',
    'benefits.benefit5.science': 'Nervous system regulation and tension release promote healthy circadian rhythms and sleep architecture.',
    'benefits.benefit6.title': 'Stress Resilience',
    'benefits.benefit6.description': 'Greater capacity to handle life\'s challenges',
    'benefits.benefit6.science': 'Building parasympathetic tone through bodywork increases stress resilience and recovery capacity.',
    'benefits.benefit7.title': 'Movement Freedom',
    'benefits.benefit7.description': 'Improved mobility and body awareness',
    'benefits.benefit7.science': 'Fascial release and movement re-education restore natural movement patterns and proprioceptive awareness.',
    'benefits.benefit8.title': 'Inner Compass',
    'benefits.benefit8.description': 'Stronger connection to intuition and inner wisdom',
    'benefits.benefit8.science': 'Interoceptive awareness developed through bodywork enhances gut feelings and decision-making clarity.',
    'benefits.benefit9.title': 'Vitality',
    'benefits.benefit9.description': 'Renewed sense of aliveness and presence',
    'benefits.benefit9.science': 'Clearing energetic blockages and restoring flow creates measurable improvements in life force and presence.',
    'benefits.science': 'The Science',
    'benefits.philosophy': 'We measure success not just in the absence of symptoms, but in the presence of vitality, joy, and the deep knowing that your body is your ally in life.',
    ...
    'testimonials.maria.quote': 'After 15 years of pain, I finally feel like myself again. The 360° approach didn\'t just fix my neck — it gave me back my confidence.',
    'testimonials.maria.result': 'Pain reduced from 8/10 to 1/10, stress levels dramatically improved',
    ...
    'testimonials.david.quote': 'I thought I knew my body as an athlete. The 360° mapping revealed patterns I never knew existed. My performance and recovery have reached new levels.',
    ...
    'testimonials.jennifer.quote': 'After my surgery, I felt disconnected from my body. The healing here went beyond physical — I learned to trust my body again.',
    ...
    'testimonials.alex.quote': 'I came for anxiety, not expecting bodywork to help. But when they explained how my nervous system was stuck, it all made sense. I feel calm in my body for the first time in years.',
    ...
    'testimonials.videoImplementation': 'In a real implementation, this would be embedded video content',
    'story.title': 'A Healing Journey',
    'story.intro': 'Sarah came to us carrying the weight of ten years...',
    'story.paragraph1': 'Sarah\'s shoulders spoke before she did. Curved inward like a protective shell, they held the story of countless sleepless nights, of emails answered at midnight, of a promotion that came with a price her body was still paying.',
    'story.paragraph2': '"I just want my neck to stop hurting," she said during our first session. But her body whispered deeper truths — about the fear lodged in her chest, the anxiety that had taken residence in her jaw, the exhaustion that lived in her very bones.',
    'story.paragraph3': 'The 360° approach didn\'t just address her neck. We worked with the emotional patterns that created the tension, the structural imbalances that maintained it, and the energetic blockages that prevented healing. We listened to what her body needed to feel safe again.',
    'story.paragraph4': 'Three months later, Sarah carried herself differently. Not just straighter — she carried herself like someone who remembered she had permission to take up space. Her neck pain had become a doorway to reclaiming parts of herself she had forgotten existed.',
    'story.paragraph5': '"I didn\'t just get my body back," she told us. "I got my life back."',
    'story.philosophy': 'Every body has a story. Every story deserves to be heard in its fullness — not just the symptoms, but the whole human experience beneath them.',
    ...
    'footer.description': 'Transforming lives through integral healing of body, mind and spirit. Your journey to complete wellness begins here.',
  ...
  es: {
    ...
    'agenyz.page.description': 'Biohacking y nutrición que trabajan a nivel celular. Restaura la energía, la inmunidad y la juventud desde adentro.',
    ...
    'agenyz.benefits.antiaging.desc': 'Combate el estrés oxidativo y ralentiza los procesos de envejecimiento.',
    ...
    'hero.description': 'Un viaje de 90 minutos para mapear tu paisaje físico, emocional y energético. No es solo un diagnóstico — es el primer paso para volver a casa, a tu cuerpo.',
    ...
    'why.physical.desc': 'Donde vive la tensión. Leemos la estructura, la fascia y la postura para encontrar dónde estás aguantando.',
    'why.emotional.title': 'El Cuerpo Emocional',
    'why.emotional.desc': 'Donde se almacena la historia. Las emociones no procesadas se convierten en bloqueos físicos.',
    'why.energetic.title': 'El Cuerpo Energético',
    'why.energetic.desc': 'Donde fluye la vitalidad. Restauramos el flujo para que la sanación pueda ocurrir naturalmente.',
    'service.title': 'La Experiencia',
    'service.step1.title': '1. La Entrevista Profunda',
    'service.step1.desc': 'Más allá del historial médico. Hablamos de tu vida, tu estrés, tus sueños y lo que tu cuerpo ha estado tratando de decirte.',
    'service.step2.title': '2. El Mapeo Corporal',
    'service.step2.desc': 'Una lectura práctica de tu estructura. Identificamos desequilibrios, restricciones fasciales y áreas de energía estancada.',
    'service.step3.title': '3. La Sesión de Integración',
    'service.step3.desc': 'Utilizando una mezcla de modalidades (masaje, kinesiología, trabajo energético) para comenzar el proceso de desbloqueo y realineación.',
    'service.step4.title': '4. El Mapa de Ruta',
    'service.step4.desc': 'No te vas con las manos vacías. Recibes un plan personalizado con ejercicios, consejos de estilo de vida y recomendaciones de tratamiento.',
    ...
    'variants.alignment.desc': 'Para un trabajo más profundo. Incluye Mapeo + 2 sesiones de seguimiento focalizadas.',
    ...
    'prompt.techniquesDesc': 'masaje terapéutico, kinesiología, osteobalance, movimiento consciente (Feldenkrais), respiración y regulación del sistema nervioso',
    'prompt.layeredProcesses': 'Procesos en capas',
    'prompt.layeredDesc': 'liberar tensión, reordenar patrones y consolidar nuevos hábitos corporales y emocionales',
    'prompt.session': 'Sesión',
    'prompt.firstVisit': 'Primera visita con diagnóstico y trabajo suave. A partir de aquí, trazo el',
    ...
    'prompt.forWhoDesc': 'Para personas que quieren cambios reales y consistentes, no soluciones rápidas. Si estás preparada para escucharte y comprometerte con tu bienestar, este trabajo es para ti.',
    'prompt.booking': 'Reserva',
    'prompt.consultation': 'Consulta',
    'prompt.promptLabel': 'Prompt',
    'prompt.signature': '— Elena Kuchera',
    ...
    'benefits.benefit1.science': 'El trabajo corporal integrativo estimula el nervio vago, mejorando la comunicación cerebro-cuerpo y la función ejecutiva.',
    'benefits.benefit2.title': 'Equilibrio Emocional',
    'benefits.benefit2.description': 'Mayor resistencia emocional y regulación',
    'benefits.benefit2.science': 'Las técnicas somáticas ayudan a procesar el trauma almacenado y regular los patrones de respuesta al estrés del sistema nervioso.',
    'benefits.benefit3.title': 'Energía Sostenida',
    'benefits.benefit3.description': 'Vitalidad natural sin estimulación artificial',
    'benefits.benefit3.science': 'Abordar las restricciones fasciales y los desequilibrios posturales reduce el desperdicio de energía metabólica, aumentando la vitalidad natural.',
    'benefits.benefit4.title': 'Alivio del Dolor',
    'benefits.benefit4.description': 'Alivio duradero de patrones de dolor crónico',
    'benefits.benefit4.science': 'El enfoque 360° aborda las causas raíz en lugar de los síntomas, creando cambios neuroplásticos duraderos en la percepción del dolor.',
    'benefits.benefit5.title': 'Mejor Sueño',
    'benefits.benefit5.description': 'Ciclos de sueño más profundos y reparadores',
    'benefits.benefit5.science': 'La regulación del sistema nervioso y la liberación de tensiones promueven ritmos circadianos saludables y arquitectura del sueño.',
    ...
    'benefits.benefit6.science': 'Construir el tono parasimpático a través del trabajo corporal aumenta la resistencia al estrés y la capacidad de recuperación.',
    'benefits.benefit7.title': 'Libertad de Movimiento',
    'benefits.benefit7.description': 'Movilidad mejorada y conciencia corporal',
    'benefits.benefit7.science': 'La liberación fascial y la reeducación del movimiento restauran los patrones naturales de movimiento y la conciencia propioceptiva.',
    ...
    'benefits.benefit8.science': 'La conciencia interoceptiva desarrollada a través del trabajo corporal mejora las sensaciones viscerales y la claridad en la toma de decisiones.',
    'benefits.benefit9.title': 'Vitalidad',
    'benefits.benefit9.description': 'Renovado sentido de vida y presencia',
    'benefits.benefit9.science': 'Eliminar bloqueos energéticos y restaurar el flujo crea mejoras medibles en la fuerza vital y presencia.',
    'benefits.science': 'La Ciencia',
    'benefits.philosophy': 'Medimos el éxito no solo en la ausencia de síntomas, sino en la presencia de vitalidad, alegría, y el conocimiento profundo de que tu cuerpo es tu aliado en la vida.',
    ...
    'testimonials.maria.quote': 'Después de 15 años de dolor, finalmente me siento como yo misma otra vez. El enfoque 360° no solo arregló mi cuello — me devolvió mi confianza.',
    'testimonials.maria.result': 'Dolor reducido de 8/10 a 1/10, niveles de estrés dramáticamente mejorados',
    'testimonials.maria.timeframe': '3 meses',
    'testimonials.maria.before': 'Tensión constante, mala postura, ansiedad afectando la vida diaria',
    ...
    'testimonials.david.quote': 'Pensaba que conocía mi cuerpo como atleta. El mapeo 360° reveló patrones que nunca supe que existían. Mi rendimiento y recuperación han alcanzado nuevos niveles.',
    'testimonials.david.result': '25% de mejora en tiempo de recuperación, eliminó lesiones recurrentes',
    'testimonials.david.timeframe': '6 semanas',
    'testimonials.david.before': 'Lesiones frecuentes, recuperación lenta, estancamientos en rendimiento',
    'testimonials.david.after': 'Entrenamiento libre de lesiones, recuperación más rápida, nuevos récords personales',
    'testimonials.jennifer.name': 'Jennifer',
    'testimonials.jennifer.issue': 'Recuperación post-quirúrgica y movilidad',
    'testimonials.jennifer.quote': 'Después de mi cirugía, me sentía desconectada de mi cuerpo. La sanación aquí fue más allá de lo físico — aprendí a confiar en mi cuerpo otra vez.',
    'testimonials.jennifer.result': 'Movilidad completa restaurada, confianza en el movimiento retornada',
    'testimonials.jennifer.timeframe': '4 meses',
    'testimonials.jennifer.before': 'Movilidad limitada, miedo al movimiento, depresión',
    'testimonials.jennifer.after': 'Rango completo de movimiento, alegría en el movimiento, sanación emocional',
    'testimonials.alex.name': 'Alex',
    'testimonials.alex.issue': 'Ansiedad y desregulación del sistema nervioso',
    'testimonials.alex.quote': 'Vine por ansiedad, sin esperar que el trabajo corporal ayudara. Pero cuando explicaron cómo mi sistema nervioso estaba atascado, todo tuvo sentido. Me siento calmado en mi cuerpo por primera vez en años.',
    'testimonials.alex.result': 'Ansiedad reducida en 80%, calidad del sueño dramáticamente mejorada',
    ...
    'testimonials.keyInsight3': 'Herramientas prácticas que continúan apoyando el bienestar continuo',
    ...
    'testimonials.videoImplementation': 'En una implementación real, esto sería contenido de video incorporado',
    'story.title': 'Un Viaje de Sanación',
    'story.intro': 'Sarah llegó a nosotros cargando el peso de diez años...',
    'story.paragraph1': 'Los hombros de Sarah hablaron antes que ella. Curvados hacia adentro como un caparazón protector, guardaban la historia de incontables noches sin dormir, de correos respondidos a medianoche, de una promoción que vino con un precio que su cuerpo aún estaba pagando.',
    'story.paragraph2': '"Solo quiero que mi cuello deje de doler," dijo durante nuestra primera sesión. Pero su cuerpo susurraba verdades más profundas — sobre el miedo alojado en su pecho, la ansiedad que había tomado residencia en su mandíbula, el agotamiento que vivía en sus propios huesos.',
    'story.paragraph3': 'El enfoque 360° no solo abordó su cuello. Trabajamos con los patrones emocionales que crearon la tensión, los desequilibrios estructurales que la mantenían, y los bloqueos energéticos que impedían la sanación. Escuchamos lo que su cuerpo necesitaba para sentirse seguro otra vez.',
    'story.paragraph4': 'Tres meses después, Sarah se llevaba a sí misma de manera diferente. No solo más derecha — se llevaba como alguien que recordó que tenía permiso para ocupar espacio. Su dolor de cuello se había convertido en una puerta para reclamar partes de sí misma que había olvidado que existían.',
    'story.paragraph5': '"No solo recuperé mi cuerpo," nos dijo. "Recuperé mi vida."',
    'story.philosophy': 'Cada cuerpo tiene una historia. Cada historia merece ser escuchada en su plenitud — no solo los síntomas, sino toda la experiencia humana que hay debajo de ellos.',
    ...
    'footer.description': 'Transformando vidas a través de la sanación integral del cuerpo, mente y espíritu. Tu viaje hacia el bienestar completo comienza aquí.',
  ...
  ru: {
    ...
    'elena.about.p1': 'Елена Кучера - интегративный терапевт с более чем 10-летним опытом глубокой работы с телом, разумом и эмоциональным состоянием людей. Она училась в 9 разных странах и решила более 500 случаев, трансформируя физические и эмоциональные страдания в сознание, свободу и жизненную силу.',
    ...
    'casos.section.subtitle': 'Точный анализ и системное лечение для полного восстановления здоровья.',
    ...
    'casos.problems.backPain.description': 'Лечение дисковой компрессии, шейного выпрямления и хронических постуральных дисбалансов с помощью осевой декомпрессии и нейромышечного переобучения.',
    ...
    'casos.problems.stress.description': 'Вмешательство при состояниях симпатической гиперактивации, соматизированной тревожности и диафрагмальных блоках для восстановления вагального гомеостаза.',
    ...
    'casos.problems.digestive.description': 'Работа с висцеральной моторикой и осью кишечник-мозг для устранения воспалений, диспепсии и соматизированных эмоциональных блоков.',
    ...
    'casos.problems.migraines.description': 'Декомпрессия основания черепа и черепных швов для облегчения тензионных мигреней, бруксизма и нейросенсорной усталости.',
    ...
    'agenyz.benefits.antiaging.desc': 'Борется с окислительным стрессом и замедляет процессы старения.',
    ...
    'hero.description': '90-минутное путешествие для картирования вашего физического, эмоционального и энергетического ландшафта. Это не просто диагностика — это первый шаг к возвращению домой, в свое тело.',
    ...
    'why.physical.desc': 'Где живет напряжение. Мы читаем структуру, фасцию и осанку, чтобы найти, где вы держитесь.',
    'why.emotional.title': 'Эмоциональное Тело',
    'why.emotional.desc': 'Где хранится история. Необработанные эмоции становятся физическими блоками.',
    'why.energetic.title': 'Энергетическое Тело',
    'why.energetic.desc': 'Где течет жизненная сила. Мы восстанавливаем поток, чтобы исцеление могло происходить естественно.',
    'service.title': 'Опыт',
    'service.step1.title': '1. Глубокое Интервью',
    'service.step1.desc': 'За пределами медицинской истории. Мы говорим о вашей жизни, вашем стрессе, ваших мечтах и о том, что ваше тело пыталось вам сказать.',
    'service.step2.title': '2. Телесное Картирование',
    'service.step2.desc': 'Практическое чтение вашей структуры. Мы выявляем дисбалансы, фасциальные ограничения и области застойной энергии.',
    'service.step3.title': '3. Сессия Интеграции',
    'service.step3.desc': 'Использование смеси модальностей (массаж, кинезиология, энергетическая работа) для начала процесса разблокировки и выравнивания.',
    'service.step4.title': '4. Дорожная Карта',
    'service.step4.desc': 'Вы не уходите с пустыми руками. Вы получаете персонализированный план с упражнениями, советами по образу жизни и рекомендациями по восстановлению.',
    ...
    'variants.alignment.desc': 'Для более глубокой работы. Включает Картирование + 2 сфокусированные последующие сессии.',
    'variants.integral.title': 'Интегральная Трансформация',
    'variants.integral.price': '450€',
    'variants.integral.duration': '6-недельная программа',
    'variants.integral.desc': 'Полное изменение жизни. Картирование + 5 сессий + постоянная поддержка.',
    ...
    'prompt.techniquesDesc': 'терапевтический массаж, кинезиология, остеобаланс, осознанное движение (Фельденкрайз), дыхание и регуляция нервной системы',
    'prompt.layeredProcesses': 'Многослойные процессы',
    'prompt.layeredDesc': 'освобождение напряжения, переупорядочивание паттернов и укрепление новых телесных и эмоциональных привычек',
    ...
    'prompt.forWhoDesc': 'Для людей, которые хотят настоящих и последовательных изменений, а не быстрых решений. Если вы готовы слушать себя и посвятить себя своему благополучию, эта работа для вас.',
    ...
    'benefits.benefit1.science': 'Интегративная работа с телом стимулирует блуждающий нерв, улучшая связь мозг-тело и исполнительную функцию.',
    'benefits.benefit2.title': 'Эмоциональный Баланс',
    'benefits.benefit2.description': 'Большая эмоциональная устойчивость и регуляция',
    'benefits.benefit2.science': 'Соматические техники помогают обработать накопленную травму и регулировать паттерны стрессовой реакции нервной системы.',
    ...
    'benefits.benefit3.science': 'Устранение фасциальных ограничений и постуральных дисбалансов снижает метаболическое расточительство энергии, увеличивая естественную жизненность.',
    'benefits.benefit4.title': 'Облегчение Боли',
    'benefits.benefit4.description': 'Длительное облегчение хронических болевых паттернов',
    'benefits.benefit4.science': '360° подход обращается к корневым причинам, а не к симптомам, создавая длительные нейропластические изменения в восприятии боли.',
    'benefits.benefit5.title': 'Лучший Сон',
    'benefits.benefit5.description': 'Более глубокие, восстановительные циклы сна',
    'benefits.benefit5.science': 'Регуляция нервной системы и освобождение от напряжения способствуют здоровым циркадным ритмам и архитектуре сна.',
    ...
    'benefits.benefit6.science': 'Построение парасимпатического тонуса через работу с телом увеличивает стрессоустойчивость и способность к восстановлению.',
    'benefits.benefit7.title': 'Свобода Движения',
    'benefits.benefit7.description': 'Улучшенная мобильность и осознание тела',
    'benefits.benefit7.science': 'Фасциальное освобождение и переобучение движению восстанавливают естественные двигательные паттерны и проприоцептивное осознание.',
    ...
    'benefits.benefit8.science': 'Интероцептивное осознание, развитое через работу с телом, улучшает интуитивные ощущения и ясность принятия решений.',
    'benefits.benefit9.title': 'Жизненность',
    'benefits.benefit9.description': 'Обновленное чувство живости и присутствия',
    'benefits.benefit9.science': 'Устранение энергетических блоков и восстановление потока создает измеримые улучшения в жизненной силе и присутствии.',
    'benefits.science': 'Наука',
    'benefits.philosophy': 'Мы измеряем успех не только отсутствием симптомов, но и присутствием жизненности, радости и глубокого понимания того, что ваше тело — ваш союзник в жизни.',
    ...
    'testimonials.maria.quote': 'После 15 лет боли я наконец снова чувствую себя собой. Подход 360° не только исправил мою шею — он вернул мне уверенность.',
    'testimonials.maria.result': 'Боль уменьшилась с 8/10 до 1/10, уровень стресса значительно улучшился',
    ...
    'testimonials.david.after': 'Тренировки без травм, более быстрое восстановление, новые личные рекорды',
    'testimonials.jennifer.name': 'Дженнифер',
    'testimonials.jennifer.issue': 'Послеоперационное восстановление и подвижность',
    'testimonials.jennifer.quote': 'После операции я чувствовала себя отключенной от своего тела. Исцеление здесь вышло за рамки физического — я научилась снова доверять своему телу.',
    'testimonials.jennifer.result': 'Полная подвижность восстановлена, уверенность в движении вернулась',
    'testimonials.jennifer.timeframe': '4 месяца',
    'testimonials.jennifer.before': 'Ограниченная подвижность, страх движения, депрессия',
    'testimonials.jennifer.after': 'Полная амплитуда движений, радость в движении, эмоциональное исцеление',
    'testimonials.alex.name': 'Алекс',
    'testimonials.alex.issue': 'Тревога и дисрегуляция нервной системы',
    'testimonials.alex.quote': 'Я пришел с тревогой, не ожидая, что работа с телом поможет. Но когда они объяснили, как моя нервная система застряла, все обрело смысл. Я чувствую спокойствие в своем теле впервые за годы.',
    ...
    'testimonials.alex.after': 'Спокойная нервная система, восстановительный сон, воплощенная уверенность',
    ...
    'testimonials.keyInsight1': 'Как подход 360° обращался к корневым причинам, а не только к симптомам',
    'testimonials.keyInsight2': 'Эмоциональный прорыв, который ускорил физическое исцеление',
    'testimonials.keyInsight3': 'Практические инструменты, которые продолжают поддерживать постоянное благополучие',
    ...
    'testimonials.videoImplementation': 'В реальной реализации это было бы встроенное видео-содержание',
    'story.title': 'Путешествие Исцеления',
    'story.intro': 'Сара пришла к нам, неся груз десяти лет...',
    'story.paragraph1': 'Плечи Сары заговорили раньше неё. Согнутые внутрь, как защитная оболочка, они хранили историю бесчисленных бессонных ночей, писем, отвеченных в полночь, повышения, которое пришло с ценой, которую её тело всё ещё платило.',
    'story.paragraph2': '"Я просто хочу, чтобы моя шея перестала болеть," — сказала она во время нашей первой сессии. Но её тело шептало более глубокие истины — о страхе, поселившемся в её груди, о тревоге, которая обосновалась в её челюсти, об истощении, которое жило в её костях.',
    'story.paragraph3': 'Подход 360° затронул не только её шею. Мы работали с эмоциональными паттернами, которые создавали напряжение, структурными дисбалансами, которые его поддерживали, и энергетическими блоками, которые препятствовали исцелению. Мы слушали, что нужно её телу, чтобы снова чувствовать себя в безопасности.',
    'story.paragraph4': 'Три месяца спустя Сара держалась по-другому. Не просто прямее — она держалась как кто-то, кто вспомнил, что имеет право занимать пространство. Её боль в шее стала дверью к возвращению частей себя, о существовании которых она забыла.',
    'story.paragraph5': '"Я не просто вернула своё тело," — сказала она нам. "Я вернула свою жизнь."',
    'story.philosophy': 'У каждого тела есть история. Каждая история заслуживает того, чтобы быть услышанной в полноте — не только симптомы, но и весь человеческий опыт под ними.',
    ...
    'footer.description': 'Трансформируем жизни через интегральное исцеление тела, разума и духа. Ваше путешествие к полному благополучию начинается здесь.',
    ...
    'vip.testimonials.comment1': 'Сервис Gold VIP полностью изменил качество моей жизни. Персональное внимание и доступность 24/7 не имеют аналогов.',
    'vip.testimonials.comment2': 'Как врач, я могу подтвердить, что EKA Balance предлагает стандарт качества, превосходящий ожидания.',
    'vip.testimonials.comment3': 'План Silver VIP позволил мне заботиться о семье и сохранять баланс. Инвестиция, которая того стоит.',
    ...
    'vip.experienceDescription': 'Эксклюзивный опыт здоровья и благополучия для требовательных профессионалов',
