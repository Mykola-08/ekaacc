...
export const servicesTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // About Elena page
    'elena.title': 'Elena Kuchera - Terapeuta Integradora | EKA Balance',
    ...
    'prompt.signature': '— Elena Kuchera',
  ...
  en: {
    ...
    // About Elena page
    'elena.title': 'Elena Kuchera - Integrative Therapist | EKA Balance',
    ...
    'elena.about.p1':
      'Elena Kuchera is an integrative therapist with over 10 years dedicated to deep work with the body, mind and emotional state of people. She has studied in 9 different countries and resolved over 500 cases, transforming physical and emotional suffering into consciousness, freedom and vitality.',
    'elena.about.p2':
  ...
  ru: {
    ...
    // About Elena page
    'elena.title': 'Елена Кучера - Интегративный терапевт | EKA Balance',
    ...
    'elena.about.p1':
      'Елена Кучера - интегративный терапевт с более чем 10-летним опытом глубокой работы с телом, разумом и эмоциональным состоянием людей. Она училась в 9 разных странах и решила более 500 случаев, трансформируя физические и эмоциональные страдания в сознание, свободу и жизненную силу.',
    'elena.about.p2':
