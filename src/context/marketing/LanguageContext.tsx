...
const guaranteedTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // Home Bento Grid
    'home.bento.badge': 'El Mètode EKA',
    'home.bento.title': 'Benestar integratiu, resultats reals',
    'home.bento.featured': 'Destacat',
    'home.bento.equilibri.title': 'Equilibri corporal',
    'home.bento.equilibri.desc': 'Descobreix com restaurar l\'harmonia natural del teu cos amb un enfocament somàtic personalitzat.',
    'home.bento.kinesiology.title': 'Kinesiologia',
    'home.bento.kinesiology.desc': 'Test muscular precís per detectar desequilibris i activar la capacitat de curació del cos.',
    'home.bento.explore': 'Explorar →',
    'home.bento.nutrition.title': 'Nutrició funcional',
    'home.bento.nutrition.desc': 'Plans nutricionals adaptats al teu metabolisme i objectius.',
    'home.bento.testimonial.quote': '"Després de 3 sessions, el meu dolor crònic d\'esquena va desaparèixer completament."',
    'home.bento.testimonial.author': 'Maria L.',
    'home.bento.testimonial.role': 'Clienta des de 2023',
    // For Business
    'personalizedServices.business': 'Per a empreses',
    'common.enquireNow': 'Sol·licitar informació',
    'personalized.business.hero.title': 'Benestar corporatiu a mida',
    'personalized.business.hero.description': 'Programes de benestar personalitzats per a equips i empreses que volen invertir en la salut dels seus treballadors.',
    'personalized.business.bento.title': 'Les nostres solucions',
    'personalized.business.bento.subtitle': 'Programes adaptats a cada tipus d\'empresa i necessitat.',
    'personalized.business.bento.box1.title': 'Sessions presencials a l\'oficina',
    'personalized.business.bento.box1.desc': 'Portem el benestar directament al vostre lloc de treball.',
    'personalized.business.bento.box1.details.title': 'Sessions a l\'oficina',
    'personalized.business.bento.box1.details.desc': 'Massatge de cadira, estiraments guiats i tècniques de relaxació adaptades a l\'entorn laboral.',
    'personalized.business.bento.box2.title': 'Tallers de benestar',
    'personalized.business.bento.box2.desc': 'Formació pràctica per millorar la salut del vostre equip.',
    'personalized.business.bento.box2.details.title': 'Tallers formatius',
    'personalized.business.bento.box2.details.desc': 'Tallers sobre postura, gestió de l\'estrès, nutrició funcional i moviment conscient.',
    'personalized.business.bento.box3.title': 'Programes de prevenció',
    'personalized.business.bento.box3.desc': 'Estratègies preventives per reduir l\'absentisme.',
    'personalized.business.bento.box3.details.title': 'Prevenció activa',
    'personalized.business.bento.box3.details.desc': 'Avaluació ergonòmica, plans de moviment i seguiment individualitzat per a cada treballador.',
    'personalized.business.bento.box4.title': 'Retirs corporatius',
    'personalized.business.bento.box4.desc': 'Experiències de benestar immersives per al vostre equip.',
    'personalized.business.bento.box4.details.title': 'Retirs d\'equip',
    'personalized.business.bento.box4.details.desc': 'Jornades de benestar fora de l\'oficina amb activitats de cohesió, moviment i relaxació.',
    'personalized.business.plans.title': 'Plans i preus',
    'personalized.business.plans.subtitle': 'Seleccioneu el pla que millor s\'adapti a la vostra empresa.',
    'personalized.business.plans.teams.title': 'Equips',
    'personalized.business.plans.teams.desc': 'Ideal per a equips petits i mitjans que volen millorar el benestar laboral.',
    'personalized.business.plans.teams.price': 'Per mes, fins a 10 persones',
    'personalized.business.plans.teams.feature1': 'Sessions setmanals presencials',
    'personalized.business.plans.teams.feature2': 'Avaluació ergonòmica inicial',
    'personalized.business.plans.teams.feature3': 'Informe mensual de benestar',
    'personalized.business.plans.teams.feature4': 'Suport per correu electrònic',
    'personalized.business.plans.enterprise.title': 'Empresa',
    'personalized.business.plans.enterprise.desc': 'Per a empreses grans que busquen un programa complet.',
    'personalized.business.plans.enterprise.price': 'Per mes, equip il·limitat',
    'personalized.business.plans.enterprise.feature1': 'Sessions il·limitades presencials',
    'personalized.business.plans.enterprise.feature2': 'Programa de prevenció complert',
    'personalized.business.plans.enterprise.feature3': 'Tallers mensuals exclusius',
    'personalized.business.plans.enterprise.feature4': 'Gestor de compte dedicat',
    'personalized.business.faq.q1': 'Com funcionen les sessions a l\'oficina?',
    'personalized.business.faq.a1': 'Portem tot l\'equipament necessari. Només necessiteu un espai tranquil de mínim 3x3m. Les sessions duren entre 15 i 30 minuts per persona.',
    'personalized.business.faq.q2': 'Quants treballadors poden participar?',
    'personalized.business.faq.a2': 'No hi ha límit mínim. Adaptem el programa al nombre de participants i a la freqüència desitjada.',
    'personalized.business.faq.q3': 'Es pot personalitzar el programa?',
    'personalized.business.faq.a3': 'Absolutament. Cada programa es dissenya a mida segons les necessitats i objectius de la vostra empresa.',
  },
  en: {
    ...
    // Home Bento Grid
    'home.bento.badge': 'The EKA Method',
    'home.bento.title': 'Integrative wellness, real results',
    'home.bento.featured': 'Featured',
    'home.bento.equilibri.title': 'Body balance',
    'home.bento.equilibri.desc': 'Discover how to restore your body\'s natural harmony through a personalized somatic approach.',
    'home.bento.kinesiology.title': 'Kinesiology',
    'home.bento.kinesiology.desc': 'Precise muscle testing to detect imbalances and activate the body\'s healing ability.',
    'home.bento.explore': 'Explore →',
    'home.bento.nutrition.title': 'Functional nutrition',
    'home.bento.nutrition.desc': 'Nutrition plans tailored to your metabolism and goals.',
    'home.bento.testimonial.quote': '"After 3 sessions, my chronic back pain disappeared completely."',
    'home.bento.testimonial.author': 'Maria L.',
    'home.bento.testimonial.role': 'Client since 2023',
    // For Business
    'personalizedServices.business': 'For Business',
    'common.enquireNow': 'Enquire now',
    'personalized.business.hero.title': 'Corporate wellness, tailored to you',
    'personalized.business.hero.description': 'Custom wellness programs for teams and companies that want to invest in their employees\' health.',
    'personalized.business.bento.title': 'Our solutions',
    'personalized.business.bento.subtitle': 'Programs adapted to every company type and need.',
    'personalized.business.bento.box1.title': 'On-site office sessions',
    'personalized.business.bento.box1.desc': 'We bring wellness directly to your workplace.',
    'personalized.business.bento.box1.details.title': 'Office sessions',
    'personalized.business.bento.box1.details.desc': 'Chair massage, guided stretching, and relaxation techniques adapted to the work environment.',
    'personalized.business.bento.box2.title': 'Wellness workshops',
    'personalized.business.bento.box2.desc': 'Hands-on training to improve your team\'s health.',
    'personalized.business.bento.box2.details.title': 'Training workshops',
    'personalized.business.bento.box2.details.desc': 'Workshops on posture, stress management, functional nutrition, and mindful movement.',
    'personalized.business.bento.box3.title': 'Prevention programs',
    'personalized.business.bento.box3.desc': 'Preventive strategies to reduce absenteeism.',
    'personalized.business.bento.box3.details.title': 'Active prevention',
    'personalized.business.bento.box3.details.desc': 'Ergonomic assessment, movement plans, and individualized follow-up for each employee.',
    'personalized.business.bento.box4.title': 'Corporate retreats',
    'personalized.business.bento.box4.desc': 'Immersive wellness experiences for your team.',
    'personalized.business.bento.box4.details.title': 'Team retreats',
    'personalized.business.bento.box4.details.desc': 'Off-site wellness days with team-building activities, movement, and relaxation.',
    'personalized.business.plans.title': 'Plans & pricing',
    'personalized.business.plans.subtitle': 'Choose the plan that best fits your company.',
    'personalized.business.plans.teams.title': 'Teams',
    'personalized.business.plans.teams.desc': 'Ideal for small and medium teams wanting to improve workplace wellness.',
    'personalized.business.plans.teams.price': 'Per month, up to 10 people',
    'personalized.business.plans.teams.feature1': 'Weekly on-site sessions',
    'personalized.business.plans.teams.feature2': 'Initial ergonomic assessment',
    'personalized.business.plans.teams.feature3': 'Monthly wellness report',
    'personalized.business.plans.teams.feature4': 'Email support',
    'personalized.business.plans.enterprise.title': 'Enterprise',
    'personalized.business.plans.enterprise.desc': 'For large companies seeking a comprehensive program.',
    'personalized.business.plans.enterprise.price': 'Per month, unlimited team',
    'personalized.business.plans.enterprise.feature1': 'Unlimited on-site sessions',
    'personalized.business.plans.enterprise.feature2': 'Full prevention program',
    'personalized.business.plans.enterprise.feature3': 'Exclusive monthly workshops',
    'personalized.business.plans.enterprise.feature4': 'Dedicated account manager',
    'personalized.business.faq.q1': 'How do on-site sessions work?',
    'personalized.business.faq.a1': 'We bring all necessary equipment. You only need a quiet space of at least 3x3m. Sessions last between 15 and 30 minutes per person.',
    'personalized.business.faq.q2': 'How many employees can participate?',
    'personalized.business.faq.a2': 'There is no minimum. We adapt the program to the number of participants and desired frequency.',
    'personalized.business.faq.q3': 'Can the program be customized?',
    'personalized.business.faq.a3': 'Absolutely. Every program is custom-designed based on your company\'s needs and goals.',
  },
  es: {
    ...
    // Home Bento Grid
    'home.bento.badge': 'El Método EKA',
    'home.bento.title': 'Bienestar integrativo, resultados reales',
    'home.bento.featured': 'Destacado',
    'home.bento.equilibri.title': 'Equilibrio corporal',
    'home.bento.equilibri.desc': 'Descubre cómo restaurar la armonía natural de tu cuerpo con un enfoque somático personalizado.',
    'home.bento.kinesiology.title': 'Kinesiología',
    'home.bento.kinesiology.desc': 'Test muscular preciso para detectar desequilibrios y activar la capacidad de curación del cuerpo.',
    'home.bento.explore': 'Explorar →',
    'home.bento.nutrition.title': 'Nutrición funcional',
    'home.bento.nutrition.desc': 'Planes nutricionales adaptados a tu metabolismo y objetivos.',
    'home.bento.testimonial.quote': '"Después de 3 sesiones, mi dolor crónico de espalda desapareció por completo."',
    'home.bento.testimonial.author': 'Maria L.',
    'home.bento.testimonial.role': 'Clienta desde 2023',
    // For Business
    'personalizedServices.business': 'Para empresas',
    'common.enquireNow': 'Solicitar información',
    'personalized.business.hero.title': 'Bienestar corporativo a medida',
    'personalized.business.hero.description': 'Programas de bienestar personalizados para equipos y empresas que quieren invertir en la salud de sus trabajadores.',
    'personalized.business.bento.title': 'Nuestras soluciones',
    'personalized.business.bento.subtitle': 'Programas adaptados a cada tipo de empresa y necesidad.',
    'personalized.business.bento.box1.title': 'Sesiones presenciales en la oficina',
    'personalized.business.bento.box1.desc': 'Llevamos el bienestar directamente a tu lugar de trabajo.',
    'personalized.business.bento.box1.details.title': 'Sesiones en la oficina',
    'personalized.business.bento.box1.details.desc': 'Masaje de silla, estiramientos guiados y técnicas de relajación adaptadas al entorno laboral.',
    'personalized.business.bento.box2.title': 'Talleres de bienestar',
    'personalized.business.bento.box2.desc': 'Formación práctica para mejorar la salud de tu equipo.',
    'personalized.business.bento.box2.details.title': 'Talleres formativos',
    'personalized.business.bento.box2.details.desc': 'Talleres sobre postura, gestión del estrés, nutrición funcional y movimiento consciente.',
    'personalized.business.bento.box3.title': 'Programas de prevención',
    'personalized.business.bento.box3.desc': 'Estrategias preventivas para reducir el absentismo.',
    'personalized.business.bento.box3.details.title': 'Prevención activa',
    'personalized.business.bento.box3.details.desc': 'Evaluación ergonómica, planes de movimiento y seguimiento individualizado para cada trabajador.',
    'personalized.business.bento.box4.title': 'Retiros corporativos',
    'personalized.business.bento.box4.desc': 'Experiencias inmersivas de bienestar para tu equipo.',
    'personalized.business.bento.box4.details.title': 'Retiros de equipo',
    'personalized.business.bento.box4.details.desc': 'Jornadas de bienestar fuera de la oficina con actividades de cohesión, movimiento y relajación.',
    'personalized.business.plans.title': 'Planes y precios',
    'personalized.business.plans.subtitle': 'Selecciona el plan que mejor se adapte a tu empresa.',
    'personalized.business.plans.teams.title': 'Equipos',
    'personalized.business.plans.teams.desc': 'Ideal para equipos pequeños y medianos que quieren mejorar el bienestar laboral.',
    'personalized.business.plans.teams.price': 'Por mes, hasta 10 personas',
    'personalized.business.plans.teams.feature1': 'Sesiones semanales presenciales',
    'personalized.business.plans.teams.feature2': 'Evaluación ergonómica inicial',
    'personalized.business.plans.teams.feature3': 'Informe mensual de bienestar',
    'personalized.business.plans.teams.feature4': 'Soporte por correo electrónico',
    'personalized.business.plans.enterprise.title': 'Empresa',
    'personalized.business.plans.enterprise.desc': 'Para empresas grandes que buscan un programa completo.',
    'personalized.business.plans.enterprise.price': 'Por mes, equipo ilimitado',
    'personalized.business.plans.enterprise.feature1': 'Sesiones presenciales ilimitadas',
    'personalized.business.plans.enterprise.feature2': 'Programa de prevención completo',
    'personalized.business.plans.enterprise.feature3': 'Talleres mensuales exclusivos',
    'personalized.business.plans.enterprise.feature4': 'Gestor de cuenta dedicado',
    'personalized.business.faq.q1': '¿Cómo funcionan las sesiones en la oficina?',
    'personalized.business.faq.a1': 'Llevamos todo el equipo necesario. Solo necesitáis un espacio tranquilo de mínimo 3x3m. Las sesiones duran entre 15 y 30 minutos por persona.',
    'personalized.business.faq.q2': '¿Cuántos trabajadores pueden participar?',
    'personalized.business.faq.a2': 'No hay límite mínimo. Adaptamos el programa al número de participantes y a la frecuencia deseada.',
    'personalized.business.faq.q3': '¿Se puede personalizar el programa?',
    'personalized.business.faq.a3': 'Absolutamente. Cada programa se diseña a medida según las necesidades y objetivos de vuestra empresa.',
  },
  ru: {
    'adult.cta.desc':
      'Начните путь к благополучию с персональной сессии.',
    'adult.cta.title': 'Готовы начать?',
    'adult.recommended': 'Рекомендуемые услуги',
    'adult.recommended.desc':
      'Подобранные терапии для взрослых и комплексного благополучия.',
    ...
    'elena.approach':
      'Я помогаю вам слышать тело и восстанавливать естественный баланс.',
    ...
    'nutrition.page.durationsSubtitle':
      'Выберите длительность, которая подходит вам лучше всего.',
    ...
    'recommendations.systemic.description':
      'Системная работа для снятия глубоких блоков.',
    'services.disclaimerBody':
      'This content is informational. Our methods are complementary and do not replace medical or mental health care.',
    ...
    'services.nutrition.shortDesc':
      'Функциональное питание под ваш запрос.',
    'services.title': 'Personalized wellness sessions',
    'services.subtitle':
    ...
    // Home Bento Grid
    'home.bento.badge': 'Метод EKA',
    'home.bento.title': 'Интегративное оздоровление, реальные результаты',
    'home.bento.featured': 'Рекомендуем',
    'home.bento.equilibri.title': 'Баланс тела',
    'home.bento.equilibri.desc': 'Откройте для себя восстановление естественной гармонии тела с помощью индивидуального соматического подхода.',
    'home.bento.kinesiology.title': 'Кинезиология',
    'home.bento.kinesiology.desc': 'Точное мышечное тестирование для выявления дисбалансов и активации способности тела к исцелению.',
    'home.bento.explore': 'Подробнее →',
    'home.bento.nutrition.title': 'Функциональное питание',
    'home.bento.nutrition.desc': 'Планы питания, адаптированные к вашему метаболизму и целям.',
    'home.bento.testimonial.quote': '"После 3 сеансов моя хроническая боль в спине полностью исчезла."',
    'home.bento.testimonial.author': 'Мария Л.',
    'home.bento.testimonial.role': 'Клиент с 2023 года',
    // For Business
    'personalizedServices.business': 'Для бизнеса',
    'common.enquireNow': 'Запросить информацию',
    'personalized.business.hero.title': 'Корпоративное оздоровление на заказ',
    'personalized.business.hero.description': 'Индивидуальные программы оздоровления для команд и компаний, инвестирующих в здоровье сотрудников.',
    'personalized.business.bento.title': 'Наши решения',
    'personalized.business.bento.subtitle': 'Программы, адаптированные под каждый тип компании и потребности.',
    'personalized.business.bento.box1.title': 'Сессии в офисе',
    'personalized.business.bento.box1.desc': 'Мы приносим оздоровление прямо на ваше рабочее место.',
    'personalized.business.bento.box1.details.title': 'Офисные сессии',
    'personalized.business.bento.box1.details.desc': 'Массаж на кресле, управляемая растяжка и техники релаксации для офисной среды.',
    'personalized.business.bento.box2.title': 'Оздоровительные мастер-классы',
    'personalized.business.bento.box2.desc': 'Практическое обучение для улучшения здоровья команды.',
    'personalized.business.bento.box2.details.title': 'Обучающие мастер-классы',
    'personalized.business.bento.box2.details.desc': 'Мастер-классы по осанке, управлению стрессом, функциональному питанию и осознанному движению.',
    'personalized.business.bento.box3.title': 'Программы профилактики',
    'personalized.business.bento.box3.desc': 'Превентивные стратегии для снижения абсентеизма.',
    'personalized.business.bento.box3.details.title': 'Активная профилактика',
    'personalized.business.bento.box3.details.desc': 'Эргономическая оценка, планы движения и индивидуальное сопровождение каждого сотрудника.',
    'personalized.business.bento.box4.title': 'Корпоративные ретриты',
    'personalized.business.bento.box4.desc': 'Иммерсивные оздоровительные мероприятия для вашей команды.',
    'personalized.business.bento.box4.details.title': 'Командные ретриты',
    'personalized.business.bento.box4.details.desc': 'Дни оздоровления за пределами офиса с тимбилдингом, движением и релаксацией.',
    'personalized.business.plans.title': 'Планы и цены',
    'personalized.business.plans.subtitle': 'Выберите план, который лучше всего подходит вашей компании.',
    'personalized.business.plans.teams.title': 'Команды',
    'personalized.business.plans.teams.desc': 'Идеально для небольших и средних команд, желающих улучшить рабочее самочувствие.',
    'personalized.business.plans.teams.price': 'В месяц, до 10 человек',
    'personalized.business.plans.teams.feature1': 'Еженедельные очные сессии',
    'personalized.business.plans.teams.feature2': 'Первичная эргономическая оценка',
    'personalized.business.plans.teams.feature3': 'Ежемесячный отчёт о здоровье',
    'personalized.business.plans.teams.feature4': 'Поддержка по электронной почте',
    'personalized.business.plans.enterprise.title': 'Предприятие',
    'personalized.business.plans.enterprise.desc': 'Для крупных компаний, ищущих комплексную программу.',
    'personalized.business.plans.enterprise.price': 'В месяц, без ограничений по числу участников',
    'personalized.business.plans.enterprise.feature1': 'Безлимитные очные сессии',
    'personalized.business.plans.enterprise.feature2': 'Полная программа профилактики',
    'personalized.business.plans.enterprise.feature3': 'Эксклюзивные ежемесячные мастер-классы',
    'personalized.business.plans.enterprise.feature4': 'Персональный менеджер',
    'personalized.business.faq.q1': 'Как проходят сессии в офисе?',
    'personalized.business.faq.a1': 'Мы привозим всё необходимое оборудование. Вам нужно только тихое помещение минимум 3x3 м. Сессии длятся от 15 до 30 минут на человека.',
    'personalized.business.faq.q2': 'Сколько сотрудников могут участвовать?',
    'personalized.business.faq.a2': 'Минимума нет. Мы адаптируем программу под количество участников и желаемую частоту.',
    'personalized.business.faq.q3': 'Можно ли адаптировать программу?',
    'personalized.business.faq.a3': 'Безусловно. Каждая программа разрабатывается индивидуально под потребности и цели вашей компании.',
  },
};
...
const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'services.massage.subtitle':
      'Больше, чем расслабление: глубокое восстановление',
    'services.massage.description':
    ...
    'services.nutrition.subtitle':
      'Питайте свою жизненную силу, исцеляйтесь изнутри',
    'services.nutrition.description':
    ...
    'problems.injuries.title':
      'Продвинутая функциональная реабилитация',
    'problems.injuries.desc':
    ...
    'finalCta.subtitle':
      'Свяжитесь с нами, чтобы забронировать сессию или решить любые вопросы',

    // Casos page
    'casos.hero.badge': 'Реальные истории',
    'casos.title': 'Пути к исцелению',
    'casos.subtitle':
      'Ваше тело рассказывает историю. Мы помогаем переписать её.',
    'casos.description':
    ...
    'casos.frequentCasesSubtitle':
      'Обычные проблемы, которые мы успешно лечим каждый день',
    'casos.otherCases': 'Другие случаи, которые мы также лечим',
    'casos.otherCasesSubtitle':
      'Полный список проблем, которые мы можем помочь вам решить',
    ...
    'casos.problems.lowEnergy.title':
      'Недостаток энергии или низкая производительность',
    'casos.problems.lowEnergy.description':
    ...
    'casos.problems.hormonal.title':
      'Гормональные проблемы или нерегулярные циклы',
    'casos.problems.hormonal.description':
    ...
    'casos.problems.digestive.symptom3':
      'Нерегулярный стул (запоры или диарея) и боли в животе.',
    'casos.problems.digestive.symptom4':
    ...
    'casos.problems.migraines.cause2':
      'Дисфункция внчс (бруксизм), иррадиирующая боль в голову.',
    'casos.problems.migraines.cause3':
    ...
    'casos.problems.sleep.symptom2':
      'Частые ночные пробуждения или слишком ранний подъем.',
    'casos.problems.sleep.symptom3':
    ...
    'casos.problems.sleep.cause2':
      'Дисрегуляция циркадных ритмов (режим, синий свет).',
    'casos.problems.sleep.cause3':
      'Неподходящие привычки сна или неблагоприятная обстановка.',
    'casos.problems.sleep.cause4':
    ...
    // Recovery
    'casos.problems.recovery.symptom1':
      'Постоянная боль или дискомфорт в зоне старой травмы.',
    'casos.problems.recovery.symptom2':
    ...
    'casos.problems.recovery.symptom4':
      'Постуральные компенсации, вызывающие боль в других зонах.',
    'casos.problems.recovery.cause1':
    ...
    'casos.problems.recovery.cause4':
      'Незавершенная или поспешная реабилитация.',
    'casos.problems.recovery.treatment':
    ...
    'contact.success.message':
      'Спасибо, что связались с нами. Мы ответим вам очень скоро.',
    ...
    'contact.form.message.placeholder':
      'Кратко объясните, что вам нужно...',
    ...
    'casos.additionalProblems.tmj':
      'Боль внчс (височно-нижнечелюстной сустав)',
    ...
    'testimonials.subtitle':
      'Откройте реальный опыт людей, которые изменили свою жизнь',
    ...
    'testimonials.externalReviews':
      'Вы можете прочитать больше отзывов на наших внешних страницах',
    ...
    'testimonials.sliderSubtitle':
      'Узнайте, как мы помогли нашим клиентам достичь благополучия',
    ...
    'discounts.howToUse.subtitle':
      'Следуйте этим простым шагам, чтобы применить вашу скидку',
    'discounts.step1.title': 'Свяжитесь с нами',
    'discounts.step1.description':
      'Свяжитесь с нами через WhatsApp или телефон для бронирования',
    'discounts.step2.title': 'Упомяните код',
    'discounts.step2.description':
      'Укажите код скидки при оформлении брони',
    'discounts.step3.title': 'Наслаждайтесь скидкой',
    'discounts.step3.description':
      'Скидка будет автоматически применена к итоговой цене',
    'discounts.cta.title': 'Готовы использовать вашу скидку?',
    'discounts.cta.subtitle':
      'Забронируйте сессию сейчас и наслаждайтесь специальной ценой',
    ...
    'personalizedServices.difference.title':
      'Почему стоит выбрать специализированную программу?',
    ...
    'personalizedServices.special.list2':
      'Протоколы, специфичные для деятельности',
    ...
    'personalizedServices.officeWorkers.benefit2':
      'Эргономическая и дыхательная коррекция осанки.',
    ...
    'personalizedServices.athletes.benefit1':
      'Глубокая мышечная разгрузка и подвижность суставов.',
    'personalizedServices.athletes.benefit2':
      'Активное предотвращение травм и компенсаций.',
    'personalizedServices.athletes.benefit3':
      'Нейромышечная активация до/после соревнований.',
    ...
    'personalizedServices.artists.benefit1':
      'Специфическое лечение рук, запястий и предплечий.',
    'personalizedServices.artists.benefit2':
      'Освобождение плечевого пояса и шеи.',
    'personalizedServices.artists.benefit3':
      'Связь тела и разума для разблокировки творчества.',
    'personalizedServices.artists.result':
      'Творите без боли и с полной свободой движений.',
    ...
    'personalizedServices.musicians.benefit1':
      'Предотвращение тендинитов и фокальных дистоний.',
    'personalizedServices.musicians.benefit2':
      'Оптимизация осанки с инструментом.',
    'personalizedServices.musicians.benefit3':
      'Управление сценическим волнением через тело.',
    'personalizedServices.musicians.result':
      'Играйте с легкостью, точностью и без напряжения.',
    ...
    'personalizedServices.students.benefit1':
      'Снятие напряжения от часов учебы.',
    'personalizedServices.students.benefit2':
      'Улучшение оксигенации мозга и памяти.',
    'personalizedServices.students.benefit3':
      'Регуляция сна и тревожности перед экзаменами.',
    ...
    'booking.contact.subtitle':
      'Выберите предпочтительный способ для координации вашего визита.',
    'booking.direct.title': 'Прямой чат',
    'booking.direct.description':
      'Начните диалог немедленно, чтобы ускорить ваше бронирование.',
    'booking.direct.button': 'Открыть WhatsApp',
    'booking.form.title': 'Ассистент бронирования',
    'booking.form.description':
      'Подготовьте ваш запрос с ключевыми деталями для точного ответа.',
    ...
    'booking.form.objectivePlaceholder':
      'Кратко опишите вашу цель или симптом...',
    ...
    'booking.form.validationError':
      'Пожалуйста, заполните хотя бы имя и интересующую услугу.',
    'booking.popup.title': 'Забронируйте сеанс',
    'booking.popup.subtitle':
      'Выберите услугу и дату, которые вам подходят',
    'booking.whatsapp.greeting': 'Здравствуйте, я {name}',
    'booking.whatsapp.greetingGeneric':
      'Здравствуйте, Елена, я хотел бы записаться на прием.',
    ...
    'athletes.challenge3.desc':
      'Тревога и напряжение перед важными соревнованиями',
    'athletes.help.title': 'Как мы помогаем',
    'athletes.help1.title': 'Ускоряет восстановление мышц',
    'athletes.help1.desc':
      'Специальные техники для уменьшения воспаления и ускорения заживления',
    'athletes.help2.title': 'Улучшает гибкость и подвижность',
    'athletes.help2.desc':
      'Целенаправленные упражнения для увеличения диапазона движений',
    'athletes.help3.title': 'Управляет соревновательным стрессом',
    'athletes.help3.desc':
      'Техники релаксации для сохранения спокойствия под давлением',
    ...
    'artists.help1.title':
      'Специфический уход за руками и запястьями',
    'artists.help1.desc':
      'Целенаправленные процедуры для облегчения боли и предотвращения травм',
    ...
    'artists.help3.desc':
      'Устраняет физические напряжения, блокирующие творческий процесс',
    ...
    'musicians.problem1.desc':
      'Боль в руках, запястьях и предплечьях от интенсивной практики',
    'musicians.problem2.title': 'Постуральные напряжения',
    'musicians.problem2.desc':
      'Боль в шее и спине от поддержания специфических поз',
    'musicians.problem3.title': 'Сценическая тревога',
    'musicians.problem3.desc':
      'Стресс и напряжение перед важными выступлениями',
    'musicians.problem4.title': 'Потеря технической точности',
    'musicians.problem4.desc':
      'Напряжение влияет на координацию и музыкальное качество',
    'musicians.help.title': 'Как мы помогаем',
    'musicians.help1.title': 'Предотвращение травм',
    'musicians.help1.desc':
      'Техники для предотвращения и терапии травм от повторяющихся нагрузок',
    'musicians.help2.title': 'Постуральное улучшение',
    'musicians.help2.desc':
      'Специфические коррекции для вашей инструментальной осанки',
    'musicians.help3.title': 'Целенаправленная релаксация',
    'musicians.help3.desc':
      'Техники для поддержания спокойствия и точности',
    'musicians.results.title': 'Результаты, которых вы достигнете',
    'musicians.results.point1':
      'Значительное уменьшение боли и напряжения',
    'musicians.results.point2':
      'Улучшение технической точности и выразительности',
    'musicians.results.point3':
      'Большая уверенность и сценическое присутствие',
    'musicians.plans.title':
      'Специализированные планы для музыкантов',
    'musicians.plans.subtitle':
    ...
    'musicians.plan2.result':
      'Значительные улучшения в технике и комфорте',
    ...
    'musicians.plan3.desc':
      'Полное решение для профессиональных музыкантов',
    ...
    'musicians.plan3.result':
      'Полная трансформация вашего музыкального благополучия',
    ...
    'students.hero.subtitle':
      'Управление стрессом учебы, улучшение концентрации и уход за осанкой',
    ...
    'students.challenge2.desc':
      'Трудность поддержания внимания во время долгих учебных сессий',
    'students.challenge3.title': 'Постуральные напряжения',
    'students.challenge3.desc':
      'Боль в спине и шее от сидения многие часы за учебой',
    'students.help.title': 'Как мы помогаем',
    'students.help1.title': 'Управляет академическим стрессом',
    'students.help1.desc':
      'Техники релаксации для уменьшения тревоги от экзаменов',
    'students.help2.title': 'Улучшает концентрацию',
    'students.help2.desc':
      'Упражнения для увеличения продолжительности внимания и памяти',
    'students.help3.title': 'Корректирует учебную осанку',
    'students.help3.desc':
      'Постуральные корректировки для предотвращения боли во время учебы',
    ...
    'faq.subtitle':
      'Найдите ответы на самые распространенные вопросы о наших услугах',
    ...
    'faq.q5.answer':
      'Да, вы можете отменить или перенести за 24 часа без дополнительной платы.',
    ...
    'form.userType.officeWorkerDesc':
      'Я провожу много часов сидя перед компьютером',
    ...
    'form.userType.artistDesc':
      'Я работаю руками (живопись, скульптура, ремесла)',
    'form.userType.musician': 'Музыкант',
    'form.userType.musicianDesc':
      'Я регулярно играю на музыкальных инструментах',
    ...
    'form.userType.generalDesc':
      'Ни один из вышеперечисленных или комбинация нескольких',

    'form.step2.question':
      'Каковы ваши цели? (Выберите все подходящие)',
    ...
    'form.step4.question':
      'Какой у вас опыт работы с телесными терапиями?',
    'form.experience.none': 'Это мой первый раз',
    'form.experience.noneDesc':
      'Я никогда не получал телесных терапий',
    ...
    'form.step5.question':
      'Какой тип интенсивности вы предпочитаете?',
    'form.intensity.gentle': 'Мягкий и расслабляющий',
    'form.intensity.gentleDesc':
      'Я предпочитаю мягкое и спокойное методы работы',
    ...
    'form.intensity.deepDesc':
      'Я хочу глубокую работу для конкретных напряжений',

    'form.recommendation.badge': 'Персонализированная рекомендация',
    'form.recommendation.title': 'Ваша идеальная услуга',
    'form.recommendation.subtitle':
      'На основе вашего профиля мы нашли идеальную услугу для вас',
    ...
    'form.recommendation.officeWorker.benefit2':
      'Улучшает осанку за компьютером',
    ...
    'form.recommendation.artist.benefit4':
      'Предотвращает травмы от повторяющегося использования',
    ...
    'form.recommendation.musician.benefit3':
      'Управляет сценической тревогой',
    ...
    'form.recommendation.holistic.benefit3':
      'Облегчает физические напряжения',
    ...
    'seo.officeWorkers.title':
      'Благополучие для офисных работников | EKA Balance',
    'seo.officeWorkers.description':
    ...
    'seo.musicians.title':
      'Физиотерапия и благополучие для музыкантов | EKA Balance',
    'seo.musicians.description':
    ...
    'seo.athletes.title':
      'Спортивное восстановление и производительность | EKA Balance',
    'seo.athletes.description':
    ...
    'seo.parents.title':
      'Благополучие и энергия для родителей | EKA Balance',
    'seo.parents.description':
    ...
    // SEO
    'seo.home.title':
      'EKA Balance | терапевтический массаж и кинезиология в барселоне',
    'seo.home.description':
    ...
    'onboarding.welcome.title':
      'Добро пожаловать в ваш персонализированный опыт',
    'onboarding.welcome.description':
    ...
    'onboarding.results.title':
      'Ваша персонализированная рекомендация',
    ...
    'personalized.office.title':
      'Терапия для офисных работников | EKA Balance',
    'personalized.office.description':
    ...
    'personalized.athletes.title':
      'Спортивный массаж и восстановление | EKA Balance',
    'personalized.athletes.description':
    ...
    'personalized.artists.title':
      'Благополучие для художников и творцов | EKA Balance',
    'personalized.artists.description':
    ...
    'personalized.musicians.title':
      'Физиотерапия и массаж для музыкантов | EKA Balance',
    'personalized.musicians.description':
    ...
    'personalized.students.title':
      'Релаксация и концентрация для студентов | EKA Balance',
    'personalized.students.description':
    ...
    // Elena SEO
    'elena.seo.title':
      'О елене | холистический терапевт в барселоне',
    'elena.seo.desc':
    ...
    // Contact SEO
    'seo.contact.title':
      'Контакты и бронирование | EKA Balance барселона',
    'seo.contact.description':
    ...
    'seo.personalized.title':
      'Персонализированные терапии по профессии | EKA Balance',
    'seo.personalized.description':
    ...
    // Massage SEO
    'seo.massage.title':
      'Терапевтический и расслабляющий массаж | EKA Balance',
    'seo.massage.description':
    ...
    'seo.kinesiology.title':
      'Холистическая и эмоциональная кинезиология | EKA Balance',
    'seo.kinesiology.description':
    ...
    'massage.benefits.wellbeing':
      'Немедленное благополучие и настоящий отдых',
    ...
    'discovery.time.long.desc':
      'Комплексная и детальная трансформация.',
    ...
    'discovery.recommendation.emotional.service':
      'Эмоциональное восстановление баланса',
    'discovery.recommendation.emotional.desc':
    ...
    'discovery.recommendation.manual.service':
      'Мануальная терапевтическая сессия',
    'discovery.recommendation.manual.desc':
    ...
    'discovery.recommendation.integrative.service':
      'Интегративное снятие напряжения (4 в 1)',
    'discovery.recommendation.integrative.desc':
    ...
    'discovery.recommendation.title':
      'Персонализированная рекомендация - EKA Balance',
    ...
    'discovery.diagnosis.cause.posture':
      'Постуральная усталость (сидячий образ жизни)',
    ...
    'discovery.diagnosis.cause.metabolic':
      'Метаболический/пищеварительный дисбаланс',
    'discovery.diagnosis.cause.structural':
      'Структурный/механический дисбаланс',
    'discovery.diagnosis.cause.general':
      'Потребность в обслуживании/профилактике',
    'discovery.diagnosis.strategy.structural':
      'Структурное освобождение и мобильность',
    ...
    'discovery.diagnosis.freq.high':
      'Интенсивный (1 сеанс/неделю в течение 3 недель)',
    'discovery.diagnosis.freq.medium':
      'Поддерживающий (1 сеанс каждые 2-3 недели)',
    ...
    'discovery.step2.title':
      'Где вы чувствуете наибольшее напряжение?',
    ...
    'discovery.step4.subtitle':
      'Эмоциональное благополучие является ключом к физическому здоровью',
    'discovery.step5.title': 'Сколько времени у вас есть?',
    'discovery.step5.subtitle':
      'Мы адаптируем сессию к вашему расписанию',
    ...
    'onboarding.goals.stress':
      'Регуляция нервной системы и снижение тревожности',
    'onboarding.goals.pain': 'Лечение физической и структурной боли',
    'onboarding.goals.posture':
      'Коррекция осанки и оптимизация подвижности',
    'onboarding.goals.sleep': 'Восстановление качества глубокого сна',
    'onboarding.goals.energy':
      'Метаболическая реактивация и ясность ума',
    'onboarding.goals.focus':
      'Повышение когнитивной производительности и концентрации',
    'onboarding.goals.bodyAwareness':
      'Соматическая интеграция и осознание тела',
    'onboarding.goals.feelGood':
      'Целостное благополучие и системный баланс',

    'onboarding.questions.preferredFeeling.title':
      'Как вы хотите чувствовать себя после сеанса?',
    'onboarding.feelings.calm':
      'Глубокое спокойствие и нервная регуляция',
    'onboarding.feelings.light':
      'Физическая декомпрессия и свобода движения',
    'onboarding.feelings.energized':
      'Обновленная жизненная сила и оптимальный мышечный тонус',
    'onboarding.feelings.focused':
      'Ментальная острота и устойчивый фокус',
    'onboarding.feelings.confident':
      'Соматическая уверенность и полное присутствие',
    ...
    'onboarding.approaches.open':
      'Открыт для клинических рекомендаций',
    ...
    'office.seo.keywords':
      'Офисный массаж, боль в спине, эргономика, рабочий стресс, барселона',
    ...
    'office.problems.sedentary.desc':
      'Потеря подвижности и гибкости из-за слишком долгого сидения',
    ...
    'artists.seo.title':
      'Благополучие для художников в барселоне | EKA Balance',
    'artists.seo.desc':
    ...
    'musicians.seo.title':
      'Физиотерапия для музыкантов в барселоне | EKA Balance',
    'musicians.seo.desc':
    ...
    'students.seo.title':
      'Релаксация для студентов в барселоне | EKA Balance',
    'students.seo.desc':
    ...
    'students.seo.keywords':
      'Стресс студентов, концентрация, экзамены, учебная осанка, барселона',
    ...
    'personalized.students.services.subtitle':
      'Терапии, разработанные для студентов',
    'personalized.students.services.kinesiologyStress.title':
      'Кинезиология от стресса',
    'personalized.students.services.kinesiologyStress.description':
    ...
    'personalized.officeWorkers.hero.description':
      'Облегчение боли и коррекция осанки.',
    ...
    'personalized.musicians.hero.description':
      'Уход за телом для лучшего исполнения.',
    ...
    'personalized.musicians.understanding.callToAction':
      'Позаботьтесь о своем инструменте',
    ...
    'personalized.athletes.hero.description':
      'Оптимизация производительности и восстановление.',
    'personalized.athletes.understanding.title':
      'Поднимите свое тело на новый уровень',
    'personalized.athletes.understanding.description1':
    ...
    'vip.plan.bronze.description':
      'Необходимый уход для поддержания здоровья',
    'vip.plan.bronze.price': '150€',
    ...
    'vip.plan.gold.description':
      'Полная трансформация и эксклюзивность',
    'vip.plan.gold.price': '500€',
    ...
    'vip.testimonialsSubtitle':
      'Что говорят наши элитные члены о своем опыте.',
    ...
    'vip.testimonials.subtitle':
      'Услышьте тех, кто выбрал путь совершенства.',
    ...
    'whyChoose.personalized.title':
      'Истинно персонализированные планы',
    'whyChoose.personalized.description':
    ...
    'pricing.plan.pack3.desc':
      'Пакет из 3 сессий для непрерывного отслеживания',
    'pricing.plan.pack5.name': 'Пакет трансформация (5)',
    'pricing.plan.pack5.desc':
      'Комплексное лечение для глубоких изменений',
    ...
    'pricing.guarantee.nocommitment.desc':
      'Отмена или перенос записи за 24 часа без оплаты',
    ...
    'pricing.guarantee.certified.desc':
      'Все наши терапевты имеют официальные сертификаты',
    ...
    'booking.smart.time.placeholder':
      'Например: утром, на следующей неделе...',
