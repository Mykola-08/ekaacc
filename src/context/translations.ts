...
export const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'nav.profile': 'Perfil',
    'nav.adminDashboard': "Tauler d'Administració",
    'nav.userManagement': "Gestió d'Usuaris",
    'nav.subscriptions': 'Subscripcions',
    'nav.analytics': 'Analítiques',
    'nav.systemSettings': 'Configuració del Sistema',
    'nav.therapistDashboard': 'Tauler de Terapeuta',
    'nav.clientManagement': 'Gestió de Clients',
    'nav.educatorDashboard': "Tauler d'Educador",
    'nav.myCourses': 'Els Meus Cursos',
    'nav.createCourse': 'Crear Curs',
    'nav.bookings': 'Reserves',
    'nav.wallet': 'Moneder',
    'nav.account': 'El Meu Perfil',
    'nav.settings': 'Preferències',
    'nav.availability': 'Disponibilitat',
    'nav.resources': 'Materials',
    'nav.journal': 'Diari de Benestar',
    'nav.crisis': 'Suport en Crisi',
    'nav.notifications': 'Notificacions',
    'nav.features': 'Totes les Funcions',
    'nav.bookNowDash': 'Reservar Ara',
    'nav.clinicalNotes': 'Notes Clíniques',
    'nav.myClients': 'Els Meus Clients',
    'nav.templates': 'Plantilles',
    'nav.billing': 'Facturació',
    'nav.progressReports': 'Informes de Progrés',
    'nav.signOut': 'Tancar Sessió',
    // Dashboard sidebar — items not yet translated
    'nav.chat': 'Missatges',
    'nav.wellness': 'Benestar',
    'nav.goals': 'Objectius',
    'nav.assignments': 'Tasques',
    'nav.homework': 'Deures',
    'nav.aiInsights': 'Insights IA',
    'nav.community': 'Comunitat',
    'nav.patients': 'Pacients',
    'nav.sessionNotes': 'Notes de Sessió',
    ...
    'nav.database': 'Base de Dades',
    // Sidebar sections
    'nav.section.overview': 'Visió General',
    'nav.section.care': 'La Meva Cura',
    'nav.section.therapist': 'Terapeuta',
    'nav.section.manage': 'Gestió',
    'nav.section.platform': 'Plataforma',
    'nav.section.account': 'Compte',
    // Sidebar user dropdown
    'nav.user.account': 'Compte',
    'nav.user.billing': 'Facturació',
    'nav.user.logOut': 'Tancar Sessió',
    'nav.platformSubtitle': 'Plataforma de Benestar',
    ...
    'dashboard.welcome': 'Benvingut al teu Tauler',
    'dashboard.role': 'Rol',
    'dashboard.logout': 'Tancar sessió',

    // Dashboard Pages
    'page.bookings.title': 'Les Teves Reserves',
    ...
    'page.crisis.openMaterials': 'Obrir Materials',
    'page.resources.title': 'Materials i Recursos',
    'page.resources.subtitle': 'Accedeix a contingut educatiu, exercicis i guies de benestar.',
    'page.features.title': 'Totes les Funcions',
    'page.features.subtitle': 'Explora totes les eines i pàgines disponibles en un sol lloc.',
    'page.dashboard.dailyUpdate': 'Actualització Diària',
    'page.dashboard.goodMorning': 'Bon dia',
    'page.dashboard.goodAfternoon': 'Bona tarda',
    'page.dashboard.goodEvening': 'Bona nit',
    'page.dashboard.bookSession': 'Reservar Sessió',
    'page.dashboard.manageWallet': 'Gestionar Moneder',
    'page.dashboard.nextUp': 'PRÒXIM',
    'page.dashboard.balance': 'SALDO',
    'page.dashboard.viewDetails': 'Veure Detalls',
    'page.dashboard.noSessions': 'No hi ha sessions confirmades.',
    'page.dashboard.checkAvailability': 'Consultar disponibilitat',
    'page.dashboard.availableFunds': 'Fons disponibles',
    'page.dashboard.addFunds': 'Afegir fons',
    'page.dashboard.dailyCheckin': 'Control Diari',
    'page.dashboard.systemStatus': 'Estat del Sistema',
    'page.dashboard.normalOp': 'Funcionament Normal',
    'page.dashboard.membershipPlans': 'Plans de Subscripció',
    'page.dashboard.viewAll': 'Veure tot',
    'page.dashboard.recentActivity': 'Activitat Recent',

    'onboarding.welcome': 'Benvingut a EKA Balance',
    'onboarding.subtitle': 'Finalitzem el teu perfil per oferir-te la millor experiència.',
    'onboarding.role.label': 'Soc un/a...',
    'onboarding.role.patient': 'Client / Pacient',
    'onboarding.role.patient.desc': 'Vull millorar el meu benestar',
    'onboarding.role.therapist': 'Terapeuta',
    'onboarding.role.therapist.desc': 'Vull ajudar els altres',
    'onboarding.getStarted': 'Començar',
    'onboarding.complete': 'Completar Registre',
    'onboarding.loading': 'Configurant el teu perfil...',
    'common.price': 'Preu',
    ...
    'elena.bio':
      'He dedicat la meva vida a explorar les profunditats de les disciplines terapèutiques, creant un enfocament únic i integrador que honora la persona en la seva totalitat.',
    'elena.work.title': 'Treball',
    'elena.description1':
      "Sóc terapeuta corporal especialitzada en massatge terapèutic, kinesiologia i integració ment-cos. El meu treball es basa en la creença que la veritable curació prové d'escoltar el cos.",
    'elena.description2':
      "El meu objectiu és senzill: ajudar-te a alliberar el pes de la tensió i recuperar el teu benestar físic i emocional, perquè puguis moure't per la vida amb lleugeresa i energia renovada.",
    ...
    'donations.description':
      "Genera resums impulsats per IA de l'activitat de donacions o revisa el teu historial.",
    ...
    'donations.historyDescription':
      'Un registre complet de totes les donacions que has fet o rebut.',
    ...
    'donations.toast.failure.desc':
      'Hi ha hagut un error generant el teu resum. Si us plau, torna-ho a provar.',
    ...
    'donations.page.failedDesc':
      'Hi ha hagut un problema processant la teva donació. Si us plau, torna-ho a provar.',
    'donations.page.makeDonation': 'Fes una Donació',
    'donations.page.makeDonationDesc':
      "Dona suport al camí de benestar d'algú. La teva contribució marca una diferència real.",
    ...
    'donations.page.applicationSubmittedDesc':
      'La teva sol·licitud buscant donacions ha estat enviada per a revisió.',
    ...
    'dashboard.user.welcomeSub':
      'Fes un seguiment del teu camí de benestar i gestiona les teves sessions.',
    ...
    'dashboard.user.wellnessTipContent':
      '"La constància és la clau. Fins i tot un registre diari de 5 minuts pot millorar significativament el teu benestar mental amb el temps."',
    ...
    'myaccount.wallet.pendingPaymentsDesc':
      "Sol·licituds de recàrrega esperant aprovació de l'administrador.",
    ...
    'myaccount.wallet.requestTopUpDesc':
      "Envia una sol·licitud per a una recàrrega manual de saldo. Un administrador l'aprovarà en breu.",
    ...
    'myaccount.wallet.proofPlaceholder':
      "p.ex., ID de Transacció, o una nota per a l'administrador",
    ...
    'cookie.intro':
      'Utilitzem galetes per millorar la teva experiència de navegació, oferir anuncis o contingut personalitzat i analitzar el nostre trànsit. En fer clic a "Acceptar Tot", acceptes el nostre ús de galetes. Llegeix la nostra',
    ...
    'cookie.details.description':
      'Pots triar quines galetes vols acceptar. Les galetes essencials són necessàries perquè el lloc web funcioni correctament.',
  ...
  en: {
    ...
    'nav.therapistDashboard': 'Therapist Dashboard',
    'nav.clientManagement': 'Client Management',
    'nav.educatorDashboard': 'Educator Dashboard',
    ...
    'nav.sessionNotes': 'Session Notes',
    'nav.finances': 'Finances',
    ...
    'nav.section.care': 'My Care',
    'nav.section.therapist': 'Therapist',
    'nav.section.manage': 'Manage',
    'nav.section.platform': 'Platform',
    'nav.section.account': 'Account',
    // Sidebar user dropdown
    'nav.user.account': 'Account',
    'nav.user.billing': 'Billing',
    'nav.user.logOut': 'Log out',
    'nav.platformSubtitle': 'Wellness Platform',

    // Dashboard Pages
    'page.bookings.title': 'Your Bookings',
    'page.bookings.subtitle': 'View your session history and upcoming appointments.',
    ...
    'page.crisis.followUpDesc': 'Contact your therapist and review your safety plan.',
    'page.crisis.viewSessions': 'View Upcoming Sessions',
    'page.crisis.openMaterials': 'Open Materials',
    'page.resources.title': 'Materials & Resources',
    'page.resources.subtitle': 'Access educational content, exercises, and wellness guides.',
    'page.features.title': 'All Features',
    'page.features.subtitle': 'Explore every tool and page available to you in one place.',
    'page.dashboard.dailyUpdate': 'Daily Update',
    'page.dashboard.goodMorning': 'Good Morning',
    'page.dashboard.goodAfternoon': 'Good Afternoon',
    'page.dashboard.goodEvening': 'Good Evening',
    'page.dashboard.bookSession': 'Book a Session',
    'page.dashboard.manageWallet': 'Manage Wallet',
    'page.dashboard.nextUp': 'NEXT UP',
    'page.dashboard.balance': 'BALANCE',
    'page.dashboard.viewDetails': 'View Details',
    'page.dashboard.noSessions': 'No confirmed sessions.',
    'page.dashboard.checkAvailability': 'Check availability',
    'page.dashboard.availableFunds': 'Available funds',
    'page.dashboard.addFunds': 'Add funds',
    'page.dashboard.dailyCheckin': 'Daily Check-in',
    'page.dashboard.systemStatus': 'System Status',
    'page.dashboard.normalOp': 'Normal Operation',
    'page.dashboard.membershipPlans': 'Membership Plans',
    ...
    'onboarding.welcome': 'Welcome to EKA Balance',
    'onboarding.subtitle': "Let's finalize your profile to provide you the best experience.",
    'onboarding.role.label': 'I am a...',
    'onboarding.role.patient': 'Client / Patient',
    'onboarding.role.patient.desc': 'I want to improve my wellness',
    'onboarding.role.therapist': 'Therapist',
    'onboarding.role.therapist.desc': 'I want to help others',
    'onboarding.getStarted': 'Get Started',
    'onboarding.complete': 'Complete Onboarding',
    'onboarding.loading': 'Setting up your profile...',
    ...
    'donations.description':
      'Generate AI-powered summaries of donation activity or review your history.',
    ...
    'donations.page.makeDonationDesc':
      "Support someone's journey to wellness. Your contribution makes a real difference.",
    ...
    'donations.page.applicationSubmittedDesc':
      'Your donation seeker application has been submitted for review.',
    ...
    'cookie.details.description':
      'You can choose which cookies you want to accept. Essential cookies are necessary for the website to function properly.',
    ...
    'personalizedServices.subtitle':
      'Discover therapies specifically adapted to your profession and lifestyle',
    ...
    'personalizedServices.officeWorkers.desc':
      'Specific therapies to relieve sedentary work tensions and improve posture',
    ...
    'personalizedServices.officeWorkers.result':
      'More energy, less pain and better work performance',
    'personalizedServices.athletes': 'Athletes',
    'personalizedServices.athletes.desc':
      'Muscle recovery, injury prevention and sports performance optimization',
    ...
    'personalizedServices.musicians.desc':
      'Specialized therapies for musicians: hands, arms, posture and technique',
    ...
    'personalizedServices.musicians.result':
      'Improved technique and prevention of musical injuries',
    'personalizedServices.students': 'Students',
    'personalizedServices.students.desc':
      'Study stress management, concentration improvement and postural care',
  ...
  es: {
    ...
    'nav.resources': 'Materiales',
    'nav.journal': 'Diario de Bienestar',
    'nav.crisis': 'Soporte en Crisis',
    'nav.notifications': 'Notificaciones',
    'nav.features': 'Todas las Funciones',
    'nav.bookNowDash': 'Reservar Ahora',
    'nav.clinicalNotes': 'Notas Clínicas',
    'nav.myClients': 'Mis Clientes',
    'nav.templates': 'Plantillas',
    'nav.billing': 'Facturación',
    'nav.progressReports': 'Informes de Progreso',
    ...
    'nav.therapistDashboard': 'Panel del Terapeuta',
    'nav.clientManagement': 'Gestión de Clientes',
    // Dashboard sidebar — items not yet translated
    'nav.chat': 'Mensajes',
    'nav.wellness': 'Bienestar',
    'nav.goals': 'Objetivos',
    'nav.assignments': 'Tareas',
    'nav.homework': 'Deberes',
    'nav.aiInsights': 'Insights IA',
    'nav.community': 'Comunidad',
    'nav.patients': 'Pacientes',
    'nav.sessionNotes': 'Notas de Sesión',
    'nav.finances': 'Finanzas',
    'nav.business': 'Negocio',
    'nav.users': 'Usuarios',
    'nav.payments': 'Pagos',
    'nav.telegram': 'Telegram',
    'nav.featureFlags': 'Indicadores de Función',
    'nav.auditLog': 'Registro de Auditoría',
    'nav.platformSettings': 'Configuración de Plataforma',
    'nav.permissions': 'Permisos',
    'nav.content': 'Contenido',
    'nav.database': 'Base de Datos',
    // Sidebar sections
    'nav.section.overview': 'Resumen',
    'nav.section.care': 'Mi Cuidado',
    'nav.section.therapist': 'Terapeuta',
    'nav.section.manage': 'Gestión',
    'nav.section.platform': 'Plataforma',
    'nav.section.account': 'Cuenta',
    // Sidebar user dropdown
    'nav.user.account': 'Cuenta',
    'nav.user.billing': 'Facturación',
    'nav.user.logOut': 'Cerrar Sesión',
    'nav.platformSubtitle': 'Plataforma de Bienestar',

    // Dashboard Pages
    'page.bookings.title': 'Tus Reservas',
    ...
    'page.crisis.followUpDesc': 'Contacta con tu terapeuta y revisa tu plan de seguridad.',
    'page.crisis.viewSessions': 'Ver Próximas Sesiones',
    'page.crisis.openMaterials': 'Abrir Materiales',
    ...
    'page.dashboard.goodEvening': 'Buenas noches',
    'page.dashboard.bookSession': 'Reservar Sesión',
    'page.dashboard.manageWallet': 'Gestionar Monedero',
    'page.dashboard.nextUp': 'PRÓXIMO',
    'page.dashboard.balance': 'SALDO',
    'page.dashboard.viewDetails': 'Ver Detalles',
    'page.dashboard.noSessions': 'No hay sesiones confirmadas.',
    'page.dashboard.checkAvailability': 'Consultar disponibilidad',
    'page.dashboard.availableFunds': 'Fondos disponibles',
    'page.dashboard.addFunds': 'Añadir fondos',
    'page.dashboard.dailyCheckin': 'Control Diario',
    'page.dashboard.systemStatus': 'Estado del Sistema',
    'page.dashboard.normalOp': 'Funcionamiento Normal',
    'page.dashboard.membershipPlans': 'Planes de Suscripción',
    'page.dashboard.viewAll': 'Ver todo',
    ...
    'about.description1':
      'Con más de 15 años de práctica clínica, mi enfoque integra la biomecánica avanzada con la neurociencia aplicada. No tratamos síntomas aislados; restauramos la capacidad inherente del cuerpo para la autorregulación y la sanación.',
    'about.description2':
      'Cada sesión es una intervención precisa basada en el diagnóstico kinesiológico y la terapia manual avanzada, diseñada para desactivar patrones de dolor crónico y optimizar el rendimiento funcional.',
    ...
    'personalizedServices.officeWorkers.desc':
      'Terapias específicas para aliviar tensiones del trabajo sedentario y mejorar la postura',
    ...
    'personalizedServices.officeWorkers.result':
      'Más energía, menos dolor y mejor rendimiento laboral',
    'personalizedServices.athletes': 'Deportistas',
    'personalizedServices.athletes.desc':
      'Recuperación muscular, prevención de lesiones y optimización del rendimiento deportivo',
    ...
    'personalizedServices.musicians.desc':
      'Terapias especializadas para músicos: manos, brazos, postura y técnica',
    ...
    'onboarding.role.label': 'Soy un/a...',
    'onboarding.role.patient': 'Cliente / Paciente',
    'onboarding.role.patient.desc': 'Quiero mejorar mi bienestar',
    'onboarding.role.therapist': 'Terapeuta',
    'onboarding.role.therapist.desc': 'Quiero ayudar a otros',
    'onboarding.getStarted': 'Comenzar',
    'common.reserve': 'Reservar',
    'dashboard.welcome': 'Bienvenido a tu Panel',
    'dashboard.role': 'Rol',
    'dashboard.logout': 'Cerrar sesión',
    'onboarding.welcome': 'Bienvenido a EKA Balance',
    'onboarding.subtitle': 'Finalicemos tu perfil para ofrecerte la mejor experiencia.',
    'onboarding.complete': 'Completar Registro',
    'onboarding.loading': 'Configurando tu perfil...',
    ...
    'donations.description':
      'Genera resúmenes impulsados por IA de la actividad de donaciones o revisa tu historial.',
    ...
    'donations.historyDescription':
      'Un registro completo de todas las donaciones que has hecho o recibido.',
    ...
    'donations.toast.failure.desc':
      'Hubo un error generando tu resumen. Por favor, inténtalo de nuevo.',
    ...
    'donations.page.makeDonationDesc':
      'Apoya el camino de bienestar de alguien. Tu contribución marca una diferencia real.',
    ...
    'donations.page.applicationSubmittedDesc':
      'Tu solicitud buscando donaciones ha sido enviada para revisión.',
    ...
    'dashboard.user.wellnessTipContent':
      '"La constancia es la clave. Incluso un registro diario de 5 minutos puede mejorar significativamente tu bienestar mental con el tiempo."',
    ...
    'myaccount.wallet.pendingPaymentsDesc':
      'Solicitudes de recarga esperando aprobación del administrador.',
    ...
    'myaccount.wallet.requestTopUpDesc':
      'Envía una solicitud para una recarga manual de saldo. Un administrador la aprobará en breve.',
    ...
    'cookie.intro':
      'Utilizamos cookies para mejorar tu experiencia de navegación, ofrecer anuncios o contenido personalizado y analizar nuestro tráfico. Al hacer clic en "Aceptar Todo", aceptas nuestro uso de cookies. Lee nuestra',
    ...
    'cookie.details.description':
      'Puedes elegir qué cookies quieres aceptar. Las cookies esenciales son necesarias para que el sitio web fincione correctamente.',
    'cookie.type.essential': 'Esencial',
    'cookie.type.essentialDesc':
  ...
  ru: {
    ...
    'nav.therapistDashboard': 'Панель терапевта',
    'nav.clientManagement': 'Управление клиентами',
    'nav.educatorDashboard': 'Панель преподавателя',
    ...
    'nav.crisis': 'Экстренная Помощь',
    'nav.notifications': 'Уведомления',
    'nav.features': 'Все Функции',
    'nav.bookNowDash': 'Записаться',
    'nav.clinicalNotes': 'Клинические Заметки',
    'nav.myClients': 'Мои Клиенты',
    'nav.templates': 'Шаблоны',
    'nav.billing': 'Оплата',
    'nav.progressReports': 'Отчёты о Прогрессе',
    'nav.signOut': 'Выйти',
    // Dashboard sidebar — items not yet translated
    'nav.chat': 'Сообщения',
    ...
    'nav.sessionNotes': 'Заметки сессии',
    ...
    'nav.section.care': 'Моя Забота',
    'nav.section.therapist': 'Терапевт',
    'nav.section.manage': 'Управление',
    'nav.section.platform': 'Платформа',
    'nav.section.account': 'Аккаунт',
    // Sidebar user dropdown
    'nav.user.account': 'Аккаунт',
    'nav.user.billing': 'Оплата',
    'nav.user.logOut': 'Выйти',
    'nav.platformSubtitle': 'Платформа здоровья',

    // Dashboard Pages
    'page.bookings.title': 'Ваши Записи',
    ...
    'page.crisis.followUpDesc': 'Свяжитесь с терапевтом и просмотрите план безопасности.',
    'page.crisis.viewSessions': 'Посмотреть Предстоящие Сессии',
    'page.crisis.openMaterials': 'Открыть Материалы',
    'page.resources.title': 'Материалы и Ресурсы',
    'page.resources.subtitle': 'Доступ к образовательному контенту, упражнениям и гидам.',
    'page.features.title': 'Все Функции',
    'page.features.subtitle': 'Исследуйте все доступные инструменты и страницы в одном месте.',
    'page.dashboard.dailyUpdate': 'Ежедневное Обновление',
    'page.dashboard.goodMorning': 'Доброе утро',
    'page.dashboard.goodAfternoon': 'Добрый день',
    'page.dashboard.goodEvening': 'Добрый вечер',
    'page.dashboard.bookSession': 'Записаться на Сессию',
    'page.dashboard.manageWallet': 'Управлять Кошельком',
    'page.dashboard.nextUp': 'СЛЕДУЮЩЕЕ',
    'page.dashboard.balance': 'БАЛАНС',
    'page.dashboard.viewDetails': 'Подробнее',
    'page.dashboard.noSessions': 'Нет подтверждённых сессий.',
    'page.dashboard.checkAvailability': 'Проверить доступность',
    'page.dashboard.availableFunds': 'Доступные средства',
    'page.dashboard.addFunds': 'Пополнить',
    'page.dashboard.dailyCheckin': 'Ежедневный Отчёт',
    'page.dashboard.systemStatus': 'Статус Системы',
    'page.dashboard.normalOp': 'Нормальная Работа',
    ...
    'hero.title': 'EKA Balance',
    'hero.subtitle':
      'Оздоровительное пространство, специализирующееся на терапевтическом массаже, кинезиологии и персонализированных терапиях в сердце Барселоны',
    ...
    'onboarding.role.label': 'Я...',
    'onboarding.role.patient': 'Клиент / Пациент',
    'onboarding.role.patient.desc': 'Хочу улучшить самочувствие',
    'onboarding.role.therapist': 'Терапевт',
    'onboarding.role.therapist.desc': 'Хочу помогать другим',
    ...
    'dashboard.welcome': 'Добро пожаловать в личный кабинет',
    'dashboard.role': 'Роль',
    'dashboard.logout': 'Выйти',
    'onboarding.welcome': 'Добро пожаловать в EKA Balance',
    'onboarding.subtitle': 'Давайте завершим настройку профиля для лучшего опыта.',
    'onboarding.complete': 'Завершить настройку',
    'onboarding.loading': 'Настройка профиля...',
    ...
    'about.description1':
      'За более чем 15 лет клинической практики я усовершенствовала метод, выходящий за рамки традиционного лечения. Моя миссия — расшифровать язык вашего тела, чтобы разблокировать его врожденную способность к регенерации.',
    'about.description2':
      'Я объединяю точность прикладной нейробиологии с глубиной мануальных терапий. Каждая сессия — это стратегическое вмешательство в вашу нервную систему для деактивации болевых паттернов и восстановления жизненного баланса.',
    ...
    'casos.problems.lowEnergy.results':
      'Восстановление жизненной силы и энтузиазма. Ясный и бодрый ум. Способность встречать каждый день с энергией и радостью.',
    ...
    'contact.faq.q1.answer':
      'Вы можете забронировать встречу, написав в WhatsApp или Telegram по номеру 658 867 133, позвонив нам по тому же номеру или отправив нам электронное письмо.',
    ...
    'elena.role': 'Терапевт',
    'elena.bio':
      'Я посвятила свою жизнь изучению терапевтических дисциплин, создавая уникальный, интегративный подход, который уважает целостность человека.',
    'elena.work.title': 'Работа',
    'elena.description1':
      'Я телесный терапевт, специализирующийся на лечебном массаже, кинезиологии и интеграции ума и тела. Моя работа основана на убеждении, что истинное исцеление происходит от умения слушать свое тело.',
    'elena.description2':
      'Моя цель проста: помочь вам освободиться от тяжести напряжения и вернуть физическое и эмоциональное благополучие, чтобы вы могли двигаться по жизни с легкостью и обновленной энергией.',
    ...
    'donations.page.failedDesc':
      'Проблема при обработке пожертвования. Пожалуйста, попробуйте снова.',
    'donations.page.makeDonation': 'Сделать пожертвование',
    'donations.page.makeDonationDesc':
      'Поддержите чей-то путь к благополучию. Ваш вклад имеет реальное значение.',
    ...
    'donations.page.applicationSubmittedDesc':
      'Ваша заявка на получение пожертвований отправлена на рассмотрение.',
    ...
    'dashboard.user.wellnessTipContent':
      '"Постоянство — это ключ. Даже 5-минутная ежедневная проверка может со временем значительно улучшить ваше психическое благополучие."',
    ...
    'myaccount.wallet.pendingPaymentsDesc':
      'Запросы на пополнение, ожидающие одобрения администратора.',
    ...
    'myaccount.wallet.requestTopUpDesc':
      'Отправьте запрос на ручное пополнение баланса. Администратор одобрит его в ближайшее время.',
    ...
    'cookie.intro':
      'Мы используем файлы cookie для улучшения вашего удобства, показа персонализированной рекламы и анализа трафика. Нажимая "Принять все", вы соглашаетесь с использованием файлов cookie. Читайте нашу',
    ...
    'cookie.details.description':
      'Вы можете выбрать, какие cookie вы хотите принять. Обязательные cookie необходимы для правильной работы сайта.',
