...
export const mockJournalEntries: JournalEntry[] = [
  {
    ...
    painLevel: 3,
    energyLevel: 7,
    notes: 'Feeling much better today. Morning stretches helped a lot. Activities: Morning yoga, Walking 30min',
    tags: ['yoga', 'walking'],
    userId: 'user-1',
  },
  {
    ...
    painLevel: 4,
    energyLevel: 6,
    notes: 'Some stiffness in the morning, but improved after exercises. Activities: Exercises from therapy',
    tags: ['therapy', 'exercises'],
    userId: 'user-1',
  },
  {
    id: 'journal-3',
    ...
    painLevel: 2,
    energyLevel: 8,
    notes: 'Best day this week! Therapy session was very helpful. Activities: Physical therapy, Swimming',
    tags: ['therapy', 'swimming'],
    userId: 'user-1',
  },
];
