...
export const DEFAULT_SUBSCRIPTION_TIERS: Omit<
  SubscriptionTier,
...
>[] = [
  ...
  },
  {
    ...
    badge: {
      text: 'VIP',
      bgColor: 'bg-linear-to-r from-primary to-accent',
      textColor: 'text-primary-foreground',
      icon: 'crown',
      gradient: true,
      pulse: true,
...
export const EXTENDED_VIP_TIERS: Omit<VIPTierDetails, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    badge: {
      text: 'VIP GOLD',
      bgColor: 'bg-linear-to-r from-warning to-warning/80',
  ...
  [
    {
      ...
      color: 'var(--muted-foreground)', // zinc-500
      isActive: true,
      order: 1,
      popularBadge: false,
      loyaltyLevel: 'member',
    ...
    },
    {
      ...
      badge: {
        text: 'ELITE',
        bgColor: 'bg-linear-to-r from-destructive to-warning',
...
export const DEFAULT_THEMES: Omit<Theme, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    colors: {
      primary: 'oklch(0.62 0.17 220)',
      primaryForeground: 'oklch(0.985 0 0)',
      secondary: 'oklch(0.95 0.02 230)',
      secondaryForeground: 'oklch(0.30 0.06 230)',
      background: 'oklch(0.98 0.01 230)',
      foreground: 'oklch(0.22 0.05 230)',
      muted: 'oklch(0.95 0.02 230)',
      mutedForeground: 'oklch(0.48 0.08 230)',
      accent: 'oklch(0.83 0.07 220)',
      accentForeground: 'oklch(0.30 0.06 230)',
      destructive: 'oklch(0.58 0.22 27)',
      destructiveForeground: 'oklch(0.985 0 0)',
      ...
      card: 'oklch(1 0 0)',
      cardForeground: 'oklch(0.22 0.05 230)',
      popover: 'oklch(1 0 0)',
      popoverForeground: 'oklch(0.22 0.05 230)',
    },
    isActive: true,
    order: 2,
    featured: true,
  },
  {
    ...
    colors: {
      ...
      secondaryForeground: 'oklch(0.30 0.08 30)',
      background: 'oklch(0.99 0.01 55)',
      foreground: 'oklch(0.30 0.08 30)',
      muted: 'oklch(0.96 0.03 60)',
      mutedForeground: 'oklch(0.45 0.08 35)',
      accent: 'oklch(0.90 0.06 55)',
      accentForeground: 'oklch(0.30 0.08 30)',
      destructive: 'oklch(0.58 0.22 27)',
      destructiveForeground: 'oklch(0.985 0 0)',
      border: 'oklch(0.90 0.06 55)',
      input: 'oklch(0.90 0.06 55)',
      ring: 'oklch(0.70 0.16 45)',
      card: 'oklch(1 0 0)',
      cardForeground: 'oklch(0.30 0.08 30)',
      popover: 'oklch(1 0 0)',
      popoverForeground: 'oklch(0.30 0.08 30)',
    },
    isActive: true,
    order: 3,
    featured: true,
