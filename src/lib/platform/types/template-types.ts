...
Date: {{sessionDate}}`,
    fields: [
      { key: 'presentingConcerns', label: 'Presenting Concerns', type: 'textarea', required: true },
      {
        ...
        label: 'Appearance',
        type: 'text',
        placeholder: 'Well-groomed, appropriate dress',
      },
      {
        key: 'mood',
        label: 'Mood',
        type: 'select',
        options: ['Euthymic', 'Depressed', 'Anxious', 'Irritable', 'Elevated'],
        required: true,
      },
      {
        key: 'affect',
        label: 'Affect',
        type: 'select',
        options: ['Appropriate', 'Flat', 'Restricted', 'Labile', 'Expansive'],
        required: true,
      },
      { key: 'speech', label: 'Speech', type: 'text', placeholder: 'Normal rate and tone' },
      {
        ...
        type: 'text',
        placeholder: 'Linear and goal-directed',
      },
      {
        key: 'diagnosticImpressions',
    ...
    fields: [
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'How the client describes their week, symptoms, progress...',
      },
      {
        key: 'mood',
        label: 'Observed Mood',
        type: 'select',
        options: ['Improved', 'Stable', 'Declining', 'Variable'],
        required: true,
      },
      {
        key: 'engagement',
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Your professional assessment of the session and client progress',
      },
      {
        key: 'plan',
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Homework, techniques to practice, focus areas...',
      },
    ],
  },
  {
...
THERAPIST SIGNATURE: {{therapistName}} DATE: {{sessionDate}}`,
    fields: [
      ...
      {
        key: 'goal1Interventions',
        label: 'Goal 1 Interventions',
        type: 'textarea',
        required: true,
      },
      ...
      },
      {
        ...
        type: 'select',
        options: ['6 weeks', '3 months', '6 months', '1 year', 'Ongoing'],
        required: true,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: "Client's reported symptoms, experiences, concerns",
      },
      {
        key: 'appearance',
        label: 'Appearance',
        type: 'text',
        placeholder: 'Grooming, dress, hygiene',
      },
      {
        key: 'behavior',
        label: 'Behavior',
        type: 'text',
        placeholder: 'Eye contact, body language, cooperation',
      },
      {
        key: 'mood',
        label: 'Mood',
        type: 'text',
        required: true,
        placeholder: "Client's reported emotional state",
      },
      {
        key: 'affect',
        label: 'Affect',
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Clinical impressions, symptom severity, functioning',
      },
      { key: 'progressAssessment', label: 'Progress on Goals', type: 'textarea', required: true },
      {
        ...
        options: [
          ...
          'Low risk',
          'Moderate risk',
          'High risk - safety plan in place',
        ],
        required: true,
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Interventions used, focus for next session',
      },
      {
        key: 'homework',
        label: 'Homework Assigned',
        type: 'textarea',
        placeholder: 'Specific tasks or exercises',
      },
    ],
  },
  {
...
Date: {{sessionDate}}`,
    fields: [
      ...
      {
        key: 'treatmentProvided',
        label: 'Treatment Provided',
        type: 'textarea',
        required: true,
        placeholder: 'Modalities, techniques, frequency',
      },
      {
        key: 'progressAchieved',
        label: 'Overall Progress Achieved',
        type: 'textarea',
        required: true,
      },
      ...
      { key: 'goalsPartiallyMet', label: 'Goals Partially Met', type: 'textarea' },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Symptom status, functioning, coping skills',
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Continued care, self-care strategies, resources',
      },
      {
        key: 'followUpPlan',
        label: 'Follow-up Plan',
        type: 'textarea',
        placeholder: 'Check-in schedule, booster sessions, etc.',
      },
      {
        key: 'prognosis',
        label: 'Prognosis',
        type: 'select',
        options: ['Excellent', 'Good', 'Fair', 'Guarded'],
        required: true,
      },
      {
        key: 'finalRiskAssessment',
        label: 'Final Risk Assessment',
        type: 'select',
        options: ['No risk', 'Low risk', 'Moderate risk'],
        required: true,
      },
    ],
  },
