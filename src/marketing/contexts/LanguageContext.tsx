...
const guaranteedTranslations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'recommendations.kinesiology.emotional_description': 'Regulació emocional per recuperar claredat i calma.',
    'recommendations.systemic.description': 'Treball sistèmic per alliberar bloquejos profunds.',
    'services.disclaimerBody': 'Aquest contingut és informatiu. Els nostres mètodes són complementaris i no substitueixen atenció mèdica o psicològica.',
    ...
    'services.coreDesc': 'Des de massatges relaxants fins a teràpies especialitzades de kinesiologia.',
    'services.descriptionPrefix': 'Des de massatges relaxants fins a teràpies especialitzades de kinesiologia.',
    ...
    'services.subtitle': "Enfocament somàtic i integratiu per mobilitat, regulació de l'estrès i equilibri corporal.",
    'services.cta': 'Explorar sessions',
    'problems.subtitle': 'Situacions freqüents que acompanyem amb enfocament complementari i personalitzat.',
  ...
  es: {
    ...
    'recommendations.kinesiology.emotional_description': 'Regulación emocional para recuperar claridad y calma.',
    ...
    'services.descriptionPrefix': 'Desde masajes relajantes hasta terapias especializadas de kinesiología.',
    'services.disclaimerBody': 'Este contenido es informativo. Nuestros métodos son complementarios y no sustituyen la atención médica o psicológica.',
    ...
    'services.subtitle': 'Enfoque somático e integrativo para movilidad, regulación del estrés y equilibrio corporal.',
    'services.cta': 'Explorar sesiones',
    'problems.subtitle': 'Situaciones frecuentes que acompañamos con enfoque complementario y personalizado.',
  ...
  ru: {
    ...
    'personalized.business.plans.subtitle': 'Инвестируйте в физическое и психическое благополучие вашей команды для достижения максимальной продуктивности и гармонии.',
    'personalized.business.plans.enterprise.title': 'Предприятия / Корпорации',
    'personalized.business.plans.enterprise.desc': 'Комплексная интеграция программ благополучия для целых организаций, стремящихся создать культуру здоровья.',
    ...
    'services.descriptionPrefix': 'От расслабляющего массажа до специализированной кинезиологической терапии.',
    'recommendations.kinesiology.emotional_description': 'Эмоциональная регуляция для ясности и внутреннего спокойствия.',
    'recommendations.systemic.description': 'Системная работа для снятия глубоких блоков.',
    'services.disclaimerBody': 'Этот контент носит информационный характер. Наши методы являются дополнительными и не заменяют медицинскую или психологическую помощь.',
    ...
    'problems.subtitle': 'Частые ситуации, в которых мы помогаем с помощью дополнительного подхода.',
...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    'hero.subtitle': 'T\'ajudem a sentir-te a gust amb el teu cos una altra vegada. Amb tractaments personalitzats i kinesiologia pràctica, trobem la causa real del malestar per retornar-te energia.',
    ...
    'seo.contact.description': 'Contacta amb EKA Balance per reserves i consultes. Centres a Barcelona i Rubí. Telefon +34 658 867 133, email contact@ekabalance.com',
    ...
    'seo.artists.description': "Serveis per a artistes de totes les disciplines. Desbloqueja la teva creativitat, redueix l'estrès i millora la teva expressió artística.",
    'seo.artists.keywords': 'Teràpies artistes, creativitat, benestar emocional, expressió artística, artteràpia Barcelona',

    'seo.adults.title': 'Benestar integral per a adults - salut i equilibri | EKA Balance',
    'seo.adults.description': "Tractaments personalitzats per a adults: gestió de l'estrès, dolor crònic i millora de la qualitat de vida.Massatge, kinesiologia i més.",
    'seo.adults.keywords': 'Benestar adults, gestió estrès, dolor crònic, massatge terapèutic, kinesiologia Barcelona',

    'seo.children.title': 'Teràpies per a nens - desenvolupament i creixement | EKA Balance',
    'seo.children.description': "Suport al desenvolupament infantil a través de kinesiologia i mètodes suaus. Ajudem en problemes d'aprenentatge, emocionals i de coordinació.",
    'seo.children.keywords': 'Teràpies nens, desenvolupament infantil, kinesiologia nens, problemes aprenentatge, coordinació psicomotriu Barcelona',

    'seo.families.title': 'Benestar per a famílies - harmonia i connexió | EKA Balance',
    'seo.families.description': "Espai de salut per a tota la família. Millora la convivència, redueix tensions i troba l'equilibri familiar amb les nostres teràpies sistèmiques.",
    'seo.families.keywords': 'Benestar familiar, teràpia familiar, harmonia llar, kinesiologia familiar, relacions pares fills Barcelona',
    ...
    'personalizedServices.business.desc': 'Programes de benestar corporatiu, classes en grup i consultoria.',
    ...
    'personalized.business.hero.description': 'Cuidem de la salut del teu equip amb programes personalitzats: massatges a la feina, classes grupals i consultoria ergonòmica perquè treballin millor i sense dolor.',
    'personalized.business.bento.title': 'Benestar corporatiu dissenyat amb cura',
    'personalized.business.bento.subtitle': 'Empodera el teu equip amb un espai i una pràctica dedicats a restaurar el focus i cultivar la resiliència.',
    'personalized.business.bento.box1.title': 'Cohesió d\'Equip',
    'personalized.business.bento.box1.desc': 'Construeix connexions més fortes mitjançant experiències físiques compartides i moviment conscient.',
    'personalized.business.bento.box2.title': 'Més Productivitat',
    'personalized.business.bento.box2.desc': 'Les ments clares porten a millors decisions. Corregir la postura redueix la fatiga i millora el rendiment.',
    ...
    'personalized.business.understanding.description1': 'Les llargues jornades laborals, la tensió i les males postures es tradueixen en baixes i estrès. Nosaltres ajudem a prevenir-ho.',
    'personalized.business.understanding.description2': 'Oferim solucions flexibles adaptades al ritme i les necessitats reals de la teva empresa.',
    'personalized.business.understanding.callToAction': 'Parlem per dissenyar un pla pel teu equip.',
    'personalized.business.services.title': 'Serveis Corporatius',
    'personalized.business.services.subtitle': 'Solucions a mida per millorar el dia a dia de la teva empresa',
    'personalized.business.services.groupClasses.title': 'Classes de grup & Postura',
    'personalized.business.services.groupClasses.description': 'Sessions de consciència corporal o estiraments per alleujar l\'esquena, ideals per fer a l\'oficina.',
    'personalized.business.services.consulting.title': 'Consultoria & Diagnòstic',
    'personalized.business.services.consulting.description': 'Avaluem l\'ergonomia i l\'estrès dels teus empleats per establir pautes de benestar que funcionin.',
    'personalized.business.faq.q1': 'Teniu plans mensuals?',
    'personalized.business.faq.a1': 'Sí, creem plans recurrents on el nostre terapeuta pot visitar l\'oficina un o diversos dies al mes.',
    'personalized.business.faq.q2': 'Són classes online o presencials?',
    'personalized.business.faq.a2': 'Ens adaptem: podem realitzar tallers presencials a la vostra oficina o donar accés a sessions online.',
    'personalized.business.faq.q3': 'Com podem començar?',
    'personalized.business.faq.a3': 'Només cal que ens contactis. Farem una valoració gratuïta de què necessita exactament el teu equip.',
    'personalized.business.benefit1': "Redueix els nivells d'estrès de l'equip i prevé l'esgotament de manera proactiva.",
    'personalized.business.benefit2': "Millora la postura a l'escriptori i alleuja eficaçment el mal d'esquena crònic.",
    'personalized.business.benefit3': "Fomenta una cultura d'empresa més forta, connectada i saludable.",
    'personalized.business.benefit4': "Augmenta significativament la concentració diària, l'energia i la productivitat general.",
    ...
    'personalizedServices.parents.desc': 'Suport per recuperar energia, paciència i benestar físic mentre cuides dels altres.',
    ...
    'personalized.officeWorkers.method.step1.desc': 'Ens enfoquem en les línies fascials escurçades per estar assegut, obrint el pit i alliberant la tensió del coll.',
    'personalized.officeWorkers.method.step2.title': 'Reinici del Sistema Nerviós',
    'personalized.officeWorkers.method.step2.desc': "Canviem el teu cos del mode d'estrès al mode de descans i reparació per a una recuperació profunda.",
    'personalized.officeWorkers.method.step3.title': 'Realineament Ergonòmic',
    'personalized.officeWorkers.method.step3.desc': 'Integrem senyals somàtics simples per ajudar-te a mantenir una alineació neutral sense esforç durant el dia.',

    'personalized.officeWorkers.benefits.title': 'Beneficis clau',
    'personalized.officeWorkers.benefit1': 'Alleujament immediat del dolor crònic de coll, espatlles i esquena baixa.',
    'personalized.officeWorkers.benefit2': 'Reducció de mals de cap tensionals i fatiga ocular mitjançant alliberament cranial.',
    'personalized.officeWorkers.benefit3': "Millora de la claredat mental i l'enfocament regulant el sistema nerviós.",
    'personalized.officeWorkers.benefit4': "Millor qualitat del son reduint les hormones de l'estrès acumulades.",

    'personalized.officeWorkers.faq.title': 'Preguntes freqüents',
    'personalized.officeWorkers.faq.q1': 'Tinc "coll de text". La teràpia somàtica pot arreglar la meva postura?',
    'personalized.officeWorkers.faq.a1': "És molt efectiva perquè no només força les espatlles enrere; allibera la tensió al pit i coll que t'estira cap endavant, fent que la bona postura sigui natural.",
    'personalized.officeWorkers.faq.q2': 'És adequat per a la cura preventiva?',
    'personalized.officeWorkers.faq.a2': "Absolutament. Les sessions regulars prevenen l'acumulació de micro-traumes per postures estàtiques.",
    'personalized.officeWorkers.faq.q3': 'Hauré de fer exercicis al meu escriptori?',
    'personalized.officeWorkers.faq.a3': 'Proporcionem micro-moviments subtils que restableixen el teu sistema nerviós i postura sense interrompre el flux de treball.',
    ...
    'personalized.musicians.method.step1.desc': 'Avaluem les demandes biomecàniques uniques del teu instrument, identificant patrons asimètrics.',
    'personalized.musicians.method.step2.title': 'Alliberament de Motor Fi',
    'personalized.musicians.method.step2.desc': 'Ens enfoquem en la musculatura delicada de mans i braços, i en la tensió central que restringeix la respiració.',
    'personalized.musicians.method.step3.title': "Calibratge d'Estat de Flux",
    'personalized.musicians.method.step3.desc': " unim respiració i moviment, reduint l'ansietat i permetent una execució tècnica fluida.",

    'personalized.musicians.benefits.title': 'Beneficis clau',
    'personalized.musicians.benefit1': 'Prevenció i tractament de lesions per esforç repetitiu (RSI) i tendinitis.',
    'personalized.musicians.benefit2': 'Millor control de la respiració i ressonància per a músics de vent i vocalistes.',
    'personalized.musicians.benefit3': 'Major fluïdesa i reducció de tensió en la postura de tocar.',
    'personalized.musicians.benefit4': "Reducció de l'ansietat escènica mitjançant la regulació del sistema nerviós.",
    ...
    'personalized.musicians.faq.a1': "Sí. Tractem això no només localment, sinó seguint la cadena de tensió fins al coll, abordant la compressió nerviosa a l'origen.",
    'personalized.musicians.faq.q2': 'El tractament afectarà la meva tècnica?',
    'personalized.musicians.faq.a2': 'La refinarà. En eliminar la tensió innecessària, podràs tocar amb més facilitat, velocitat i resistència.',
    'personalized.musicians.faq.q3': 'Toco un instrument asimètric. Com ajudeu?',
    'personalized.musicians.faq.a3': 'Ens enfoquem a desfer els patrons de rotació, restaurant la simetria en la teva postura de descans.',
    ...
    'personalized.artists.hero.description': 'Cura de les mans, braços i postura per a artistes visuals i creadors',
    'personalized.artists.understanding.title': 'Reptes creatius',
    'personalized.artists.understanding.description1': 'Dolor per moviments repetitius durant llargues sessions de creació.',
    'personalized.artists.understanding.description2': 'Tensions al coll i esquena per postures prolongades mentre es crea.',
    'personalized.artists.understanding.callToAction': "T'ajudem a alliberar tensions físiques que bloquegen el procés creatiu.",
    ...
    'personalized.artists.method.step3.desc': 'Exercicis i pautes per mantenir la salut mentre crees.',
    'personalized.artists.benefits.benefit1': 'Més comoditat, fluïdesa i creativitat en el teu procés artístic.',
    ...
    'personalized.athletes.method.step1.desc': 'Analitzem els teus patrons de moviment per identificar ineficiències neuromusculars i restriccions fascials.',
    'personalized.athletes.method.step2.title': 'Alliberament estratègic i activació',
    'personalized.athletes.method.step2.desc': "Alliberem la tensió crònica mentre activem els estabilitzadors infraactius per restaurar l'equilibri estructural.",
    'personalized.athletes.method.step3.title': 'Integració del rendiment',
    'personalized.athletes.method.step3.desc': 'Reentrenem el teu sistema nerviós per a estratègies de moviment eficients, millorant la potència i reduint el temps de recuperació.',

    'personalized.athletes.benefits.title': 'Beneficis clau',
    'personalized.athletes.benefit1': 'Temps de recuperació accelerats mitjançant drenatge limfàtic millorat i alliberament fascial.',
    'personalized.athletes.benefit2': 'Prevenció de lesions per sobrecàrrega corregint patrons de moviment compensatoris.',
    'personalized.athletes.benefit3': 'Biomecànica optimitzada que porta a una major potència explosiva i resistència.',
    'personalized.athletes.benefit4': 'Major consciència propioceptiva per a una millor coordinació i agilitat.',

    'personalized.athletes.faq.title': 'Preguntes freqüents',
    'personalized.athletes.faq.q1': "En què es diferencia la teràpia somàtica d'un massatge esportiu normal?",
    'personalized.athletes.faq.a1': 'Mentre que el massatge esportiu se centra en la relaxació muscular, la teràpia somàtica aborda el control del sistema nerviós sobre aquests músculs. Treballem en la causa arrel.',
    'personalized.athletes.faq.q2': "Pot ajudar amb lesions cròniques que no s'han curat amb fisio tradicional?",
    'personalized.athletes.faq.a2': 'Sí. Les lesions cròniques sovint persisteixen perquè el cos està atrapat en un patró protector. El nostre enfocament ajuda el teu sistema nerviós a sentir-se prou segur per alliberar aquests mecanismes.',
    'personalized.athletes.faq.q3': 'Quan hauria de programar una sessió respecte a la meva competició?',
    'personalized.athletes.faq.a3': "Per a un treball d'alliberament profund, recomanem 3-5 dies abans d'un esdeveniment important. Per a la regulació i activació del sistema nerviós, 24-48 hores abans és ideal.",
    ...
    'children.kinesiology.desc': "Suport en dificultats d'aprenentatge, gestió emocional i coordinació motora.",
    'children.health.title': 'Equilibri Corporal',
    'children.health.desc': 'Tractament holístic per a al·lèrgies, intoleràncies i desenvolupament físic saludable.',
    ...
    'personalized.artists.description': 'Potencia la teva creativitat, desbloqueja tensions i connecta amb la teva expressió artística.',
    'personalized.artists.keywords': 'benestar artistes barcelona, creativitat, desbloqueig emocional',
    'personalized.athletes.title': 'Benestar per a atletes i esportistes | EKA Balance',
    'personalized.athletes.description': 'Millora el teu rendiment, recupera lesions i optimitza el teu cos amb els nostres plans.',
    'personalized.athletes.keywords': 'rendiment esportiu, recuperació lesions, optimització física',
    'personalized.musicians.title': 'Benestar per a músics | EKA Balance',
    'personalized.musicians.description': "Prevé lesions, millora la postura i connecta amb el teu instrument des d'un cos lliure.",
    ...
    'personalized.office.description': "Alleuja el mal d'esquena, corregeix la postura i redueix l'estrès laboral amb els nostres programes.",
    'personalized.office.keywords': "mal d'esquena oficina, ergonomia, postura ordinador, estrès laboral",
    'personalized.parents.title': 'Benestar per a pares i mares | EKA Balance',
    'personalized.parents.description': "Troba el teu equilibri, redueix l'estrès i millora la teva energia vital per a la criança.",
    'personalized.parents.keywords': 'benestar pares, criança conscient, estrès familiar, equilibri vida-treball',
    'personalized.students.title': 'Benestar per a estudiants | EKA Balance',
    'personalized.students.description': "Millora la concentració, redueix l'ansietat i optimitza el teu rendiment acadèmic.",
  ...
  en: {
    ...
    'children.kinesiology.desc': 'Support for learning difficulties, emotional management, and motor coordination.',
    'children.health.title': 'Body Balance',
    'children.health.desc': 'Holistic treatment for allergies, intolerances, and healthy physical development.',
    ...
    'services.revision360.description': 'An exhaustive evaluation of your biomechanics, posture, and metabolic status. We generate a detailed wellness report and a personalized therapeutic roadmap.',
    ...
    'casos.problems.backPain.description': 'Therapeutic management of cervicalgia, lumbar pathology, and myofascial pain syndromes. We address the structural and Functional root causes of persistent discomfort.',
    ...
    'personalizedServices.parents.desc': 'Support to recover energy, patience, and physical well-being while caring for others.',
    ...
    'musicians.problems.subtitle': 'Therapeutic Approach to musculoskeletal dysfunctions associated with instrumental practice',
    ...
    'students.problems.subtitle': 'Therapeutic Approach to physical and mental barriers affecting study',
    ...
    'office.problems.subtitle': 'Comprehensive Approach to dysfunctions derived from sedentary work and digital stress',
    ...
    'form.recommendation.officeWorker.desc': 'Therapeutic intervention for sedentary pathology. We treat cervicalgia, upper crossed syndrome, and cognitive fatigue.',
    ...
    'form.recommendation.holistic.desc': 'Synergistic application of manual therapy and holistic kinesiology for systemic diagnosis and treatment.',
    ...
    'personalized.students.hero.description': 'Professional support for high-demand academic environments. We optimize focus, manage exam stress, and correct study-related postural dysfunction.',
    ...
    'personalized.students.understanding.callToAction': 'Restore your cognitive capacity and structural integrity through therapeutic intervention.',
    ...
    'personalized.officeWorkers.services.subtitle': 'Somatic solutions for the digital professional',
    ...
    'personalized.officeWorkers.method.step1.desc': 'We target fascial lines shortened by sitting, focusing on opening the chest and releasing neck tension.',
    'personalized.officeWorkers.method.step2.title': 'Nervous System Reset',
    'personalized.officeWorkers.method.step2.desc': 'We shift your body from high-stress mode to a rest and repair state for deep recovery.',
    'personalized.officeWorkers.method.step3.title': 'Ergonomic Re-alignment',
    'personalized.officeWorkers.method.step3.desc': 'We integrate simple somatic cues to help you maintain neutral alignment effortlessly throughout the day.',

    'personalized.officeWorkers.benefits.title': 'Key Benefits',
    'personalized.officeWorkers.benefit1': 'Immediate relief from chronic neck, shoulder, and lower back pain.',
    'personalized.officeWorkers.benefit2': 'Reduction in tension headaches and eye strain through cranial release.',
    'personalized.officeWorkers.benefit3': 'Improved mental clarity and focus by regulating the nervous system.',
    'personalized.officeWorkers.benefit4': 'Better sleep quality by down-regulating stress hormones accumulated during the day.',
    ...
    'personalized.musicians.method.step1.desc': 'We evaluate the unique biomechanical requirements of your instrument, identifying asymmetrical patterns.',
    'personalized.musicians.method.step2.title': 'Fine Motor Release',
    'personalized.musicians.method.step2.desc': 'We focus on delicate hand and arm musculature, and core tension restricting breath.',
    'personalized.musicians.method.step3.title': 'Flow State Calibration',
    'personalized.musicians.method.step3.desc': 'We unite breath and movement, reducing anxiety and allowing for fluid technical execution.',

    'personalized.musicians.benefits.title': 'Key Benefits',
    'personalized.musicians.benefit1': 'Prevention and treatment of Repetitive Strain Injuries (RSI) and tendonitis.',
    'personalized.musicians.benefit2': 'Enhanced breath control and resonance for wind players and vocalists.',
    'personalized.musicians.benefit3': 'Greater fluidity and reduced tension in playing posture.',
    'personalized.musicians.benefit4': 'Reduction of performance anxiety through nervous system regulation.',
    ...
    'personalized.musicians.faq.a1': 'Yes. We treat not just locally, but trace the tension chain to the neck, addressing nerve compression at the source.',
    'personalized.musicians.faq.q2': 'Will treatment affect my playing technique?',
    'personalized.musicians.faq.a2': 'It will refine it. By removing unnecessary tension, you will play with more ease, speed, and endurance.',
    'personalized.musicians.faq.q3': 'I play an asymmetrical instrument. How do you help?',
    'personalized.musicians.faq.a3': 'We focus on unwinding rotational patterns, restoring symmetry to your resting posture.',
    'personalized.officeWorkers.faq.q1': 'I have "tech neck". Can somatic therapy fix my posture?',
    'personalized.officeWorkers.faq.a1': "It is highly effective because it doesn't just force shoulders back; it releases the tension pulling you forward, so good posture feels natural.",
    'personalized.officeWorkers.faq.q2': 'Is this suitable for preventative care?',
    'personalized.officeWorkers.faq.a2': 'Absolutely. Regular sessions prevent the accumulation of micro-traumas from static postures.',
    'personalized.officeWorkers.faq.q3': 'Will I need to do exercises at my desk?',
    'personalized.officeWorkers.faq.a3': 'We provide subtle micro-movements that reset your nervous system and posture without interrupting your workflow.',
    ...
    'personalized.musicians.services.kinesiologyPerformance.description': 'Targeted protocol to resolve stage anxiety and beta-adrenergic blockage.',
    ...
    'personalized.artists.hero.description': 'Functional preservation of fine motor skills and creative ergonomics',
    'personalized.artists.understanding.title': 'Creative challenges',
    'personalized.artists.understanding.description1': 'Microtrauma in upper extremities due to continuous technical gestures.',
    'personalized.artists.understanding.description2': 'Musculoskeletal compromise derived from prolonged static postures.',
    'personalized.artists.understanding.callToAction': 'We help you release physical blocks impacting creative flow.',
    ...
    'personalized.artists.method.step3.desc': 'Exercises and guidelines to maintain health while creating.',
    'personalized.artists.benefits.benefit1': 'Sustainability of artistic practice and freedom of movement.',
    ...
    'personalized.athletes.understanding.description2': 'We provide the specialized support necessary to maintain peak output without compromising structural integrity.',
    ...
    'personalized.athletes.method.step1.desc': 'We analyze your movement patterns to identify neuromuscular inefficiencies and fascial restrictions.',
    'personalized.athletes.method.step2.title': 'Strategic Release & Activation',
    'personalized.athletes.method.step2.desc': 'We release chronic tension while activating underactive stabilizers to restore structural balance.',
    'personalized.athletes.method.step3.title': 'Performance Integration',
    'personalized.athletes.method.step3.desc': 'We retrain your nervous system for efficient movement strategies, enhancing power and reducing recovery time.',

    'personalized.athletes.benefits.title': 'Key Benefits',
    'personalized.athletes.benefit1': 'Accelerated recovery times through enhanced lymphatic drainage and fascial release.',
    'personalized.athletes.benefit2': 'Prevention of overuse injuries by correcting compensatory movement patterns.',
    'personalized.athletes.benefit3': 'Optimized biomechanics leading to greater explosive power and endurance.',
    'personalized.athletes.benefit4': 'Increased proprioceptive awareness for better coordination and agility.',

    'personalized.athletes.faq.title': 'Common Questions',
    'personalized.athletes.faq.q1': 'How does somatic therapy differ from a regular sports massage?',
    'personalized.athletes.faq.a1': 'While sports massage focuses on muscle relaxation, somatic therapy addresses the nervous system control over those muscles. We work on the root cause.',
    'personalized.athletes.faq.q2': "Can this help with chronic injuries that haven't healed with traditional physio?",
    'personalized.athletes.faq.a2': 'Yes. Chronic injuries often persist because the body is stuck in a protective pattern. Our approach helps your nervous system feel safe enough to release these protective mechanisms.',
    'personalized.athletes.faq.q3': 'When should I schedule a session relative to my competition?',
    'personalized.athletes.faq.a3': 'For deep release work, we recommend 3-5 days before a major event. For nervous system regulation and activation, 24-48 hours prior is ideal.',

    'personalized.parents.hero.title': 'Parental vitality & recovery',
    'personalized.parents.hero.description': 'Professional support for the physical and emotional demands of parenthood. We restore energy, correct postural strain, and regulate the nervous system.',
    ...
    'personalized.parents.understanding.description2': 'We provide a restorative space for systemic recovery and neuro-affective regulation.',
    ...
    'personalized.parents.services.relaxingMassage.description': 'Restorative massage focused on adrenal recovery and releasing chronic holding patterns.',
    ...
    'seo.officeWorkers.description': 'Comprehensive management of sedentary pathology. Treatment for tech neck, carpal tunnel, and digital burnout. Corporate wellness solutions.',
    ...
    'seo.artists.description': 'Services for artists of all disciplines. Unlock your creativity, reduce stress, and improve your artistic expression.',
    'seo.artists.keywords': 'Artist therapies, creativity, emotional wellness, artistic expression, art therapy Barcelona',

    'seo.adults.title': 'Holistic Wellness for Adults - Health & Balance | EKA Balance',
    'seo.adults.description': 'Personalized treatments for adults: stress management, chronic pain relief, and quality of life improvement. Massage, kinesiology, and more.',
    'seo.adults.keywords': 'Adult wellness, stress management, chronic pain, therapeutic massage, kinesiology Barcelona',

    'seo.children.title': 'Therapies for Children - Development & Growth | EKA Balance',
    'seo.children.description': 'Support for child development through kinesiology and gentle methods. We help with learning, emotional, and coordination issues.',
    'seo.children.keywords': 'Children therapies, child development, child kinesiology, learning difficulties, psychomotor coordination Barcelona',

    'seo.families.title': 'Wellness for Families - Harmony & Connection | EKA Balance',
    'seo.families.description': 'Health space for the whole family. Improve coexistence, reduce tension, and find family balance with our systemic therapies.',
    'seo.families.keywords': 'Family wellness, family therapy, home harmony, family kinesiology, parent-child relations Barcelona',
    ...
    'seo.parents.description': 'Professional support for parenthood. Adrenal recovery, postural correction, and stress management for parents. Restore your vitality.',
    ...
    'elena.seo.desc': 'Specialist in neuro-integrative kinesiology and advanced manual therapy. Over 10 years of professional experience in musculoskeletal recovery and autonomic regulation.',
    'elena.seo.keywords': 'Elena Kucherova, integrative somatic therapist, neuro-integrative kinesiology, manual therapy Barcelona, musculoskeletal specialist',

    // Casos SEO
    'casos.seo.title': 'Case studies & therapeutic outcomes | EKA Balance',
    'casos.seo.desc': 'Evidence-based results in the treatment of chronic pain, autonomic dysregulation, and Functional rehabilitation. Real therapeutic protocols and patient outcomes.',
    'casos.seo.keywords': 'Case studies, chronic pain treatment, autonomic regulation, Functional rehabilitation, therapeutic outcomes Barcelona',

    // SEO
    'seo.home.title': 'EKA Balance - integrative somatics & manual therapy Barcelona',
    'seo.home.description': 'Advanced center for musculoskeletal recovery and autonomic regulation. Specialized in manual therapy, holistic kinesiology, and biomechanics.',
    'seo.home.keywords': 'Integrative somatics, manual therapy Barcelona, holistic kinesiology, biomechanics, musculoskeletal recovery, autonomic regulation',
    'seo.contact.title': 'Contact - appointments | EKA Balance',
    'seo.contact.description': 'Schedule your comprehensive evaluation. Centers in Barcelona and Rubí. Professional consultation for complex musculoskeletal cases.',
    'seo.contact.keywords': 'Therapeutic appointment, physiotherapy booking, health center Barcelona, wellness consultation',
    'seo.services.title': 'Therapeutic services | EKA Balance',
    'seo.services.description': 'Evidence-based interventions: advanced manual therapy, neuro-integrative kinesiology, and functional biomechanics. Systemic health solutions.',
    'seo.services.keywords': 'Manual therapy, holistic kinesiology, biomechanics, systemic health, integrative medicine Barcelona',
    ...
    'seo.vip.description': 'Exclusive health management for high-performance individuals. Priority access, comprehensive monitoring, and personalized therapeutic strategy.',
    ...
    'seo.massage.description': 'Advanced manual therapy for chronic pain, structural alignment, and tissue recovery. Deep tissue mobilization and fascial release.',
    ...
    'seo.kinesiology.keywords': 'Holistic kinesiology, neuro-integration, systemic regulation, emotional Balance, muscle testing',
    'seo.nutrition.title': 'Metabolic & nutritional counseling | EKA Balance',
    'seo.nutrition.description': 'Functional nutrition for metabolic optimization and inflammatory control. Personalized dietary strategies for systemic health.',
    'seo.nutrition.keywords': 'Functional nutrition, metabolic optimization, anti-inflammatory diet, gut health, nutritional counseling',
    ...
    'personalizedServices.business.desc': 'Corporate wellness, group classes, and consulting to reduce workplace stress.',
    ...
    'personalized.business.hero.description': 'We take care of your companies health with customized programs: from in-office massages to posture workshops. Because work shouldnt hurt.',
    'personalized.business.bento.title': 'Corporate wellness beautifully designed',
    'personalized.business.bento.subtitle': 'Empower your team with a space and practice dedicated to restoring focus and cultivating resilience.',
    'personalized.business.bento.box1.title': 'Team Cohesion',
    'personalized.business.bento.box1.desc': 'Build stronger connections through shared physical experiences and mindful movement.',
    'personalized.business.bento.box2.title': 'Increased Productivity',
    'personalized.business.bento.box2.desc': 'Clear minds lead to better decisions. Posture correction reduces fatigue and boosts daily output.',
    ...
    'personalized.business.understanding.description1': 'Sitting for hours causes neck strain and mental fatigue. We help employees recover their energy and stay sharp.',
    'personalized.business.understanding.description2': 'Whether you need weekly group classes, ergonomic consulting, or in-office therapies, we adjust our schedule to fit yours.',
    'personalized.business.understanding.callToAction': 'Lets talk and build a plan tailored to your workplace.',
    'personalized.business.services.title': 'Corporate Services',
    'personalized.business.services.subtitle': 'Options built to improve health in a busy environment',
    'personalized.business.services.groupClasses.title': 'Group Posture & Stretching',
    'personalized.business.services.groupClasses.description': 'Friendly and effective sessions focusing on relieving desk-related back pain, done online or on-site.',
    'personalized.business.services.consulting.title': 'Consulting & In-Office Care',
    'personalized.business.services.consulting.description': 'We evaluate your teams workspace and teach them how to stay pain-free. We can also provide manual therapy days right at your office.',
    'personalized.business.faq.q1': 'Can you work around our schedule?',
    'personalized.business.faq.a1': 'Yes, we know you have meetings and deadlines. We seamlessly integrate into your workday.',
    'personalized.business.faq.q2': 'Do you come to our office?',
    'personalized.business.faq.a2': 'Yes, we bring everything we need to run sessions directly at your company headquarters.',
    'personalized.business.faq.q3': 'How much does it cost?',
    'personalized.business.faq.a3': 'It varies based on team size and frequency. Lets hop on a call to give you a customized quote.',
    'personalized.business.benefit1': "Reduces team stress levels and proactively prevents burnout.",
    'personalized.business.benefit2': "Improves desk posture and effectively relieves chronic back pain.",
    'personalized.business.benefit3': "Fosters a stronger, more connected, and healthier company culture.",
    'personalized.business.benefit4': "Significantly boosts daily focus, energy, and overall productivity.",
    ...
    'about.description1': 'With over 15 years of professional practice, i have refined a method that goes beyond conventional treatment. My mission is to decode your body language to unlock its innate regeneration capacity.',
    ...
    'problems.subtitle': 'Integrative Approach to common dysfunctions via somatic integration protocols.',
    ...
    'personalized.artists.description': 'Boost your creativity, unlock tension, and connect with your artistic expression.',
    'personalized.artists.keywords': 'wellness for artists, creativity, emotional release, body expression, Barcelona',
    'personalized.athletes.title': 'Wellness for Athletes and Sportspeople | EKA Balance',
    'personalized.athletes.description': 'Improve your performance, recover from injuries, and optimize your body with our plans for athletes.',
    'personalized.athletes.keywords': 'sports performance, injury recovery, physical optimization, sports massage, Barcelona',
    'personalized.musicians.title': 'Wellness for Musicians | EKA Balance',
    'personalized.musicians.description': 'Prevent injuries, improve posture, and connect with your instrument from a tension-free body.',
    'personalized.musicians.keywords': 'wellness for musicians, injury prevention, musician posture, relaxation, Barcelona',
    'personalized.office.title': 'Wellness for Office Workers | EKA Balance',
    'personalized.office.description': 'Relieve back pain, correct posture, and reduce work stress with our programs.',
    ...
    'personalized.parents.description': 'Find your balance, reduce stress, and improve your vital energy for parenting.',
    'personalized.parents.keywords': 'wellness for parents, mindful parenting, family stress, work-life balance',
    'personalized.students.title': 'Wellness for Students | EKA Balance',
    'personalized.students.description': 'Improve concentration, reduce anxiety, and optimize your academic performance.',
    ...
    'discovery.recommendation.online.note': 'Note: Since you selected Online, this service is adapted for remote sessions.',
  },
  es: {
    // Navigation
    'nav.home': 'Inicio',
    ...
    'personalizedServices.officeWorkers.desc': 'Contrarresta el sedentarismo laboral y el estrés de alto nivel. Recupera la postura y la claridad mental.',
    'personalizedServices.officeWorkers.benefit1': 'Alivio de la tensión crónica en espalda y cuello',
    ...
    'personalizedServices.athletes.desc': 'Maximiza tu rendimiento y acelera la recuperación. Mantenimiento esencial para el cuerpo en movimiento.',
    ...
    'personalizedServices.musicians.desc': 'Afinación ergonómica de la conexión cuerpo-instrumento. Prevención de lesiones por repetición.',
    ...
    'personalizedServices.students.desc': 'Apoyo físico y mental para alta exigencia intelectual. Potencia el enfoque y alivia el estrés.',
    ...
    'personalizedServices.parents.desc': 'Apoyo para recuperar energía, paciencia y bienestar físico mientras cuidas de otros.',
    ...
    'seo.artists.description': 'Servicios para artistas de todas las disciplinas. Desbloquea tu creatividad, reduce el estrés y mejora tu expresión artística.',
    'seo.artists.keywords': 'Terapias artistas, creatividad, bienestar emocional, expresión artística, arteterapia Barcelona',

    'seo.adults.title': 'Bienestar integral para adultos - Salud y equilibrio | EKA Balance',
    'seo.adults.description': 'Tratamientos personalizados para adultos: gestión del estrés, dolor crónico y mejora de la calidad de vida. Masaje, kinesiología y más.',
    'seo.adults.keywords': 'Bienestar adultos, gestión estrés, dolor crónico, masaje terapéutico, kinesiología Barcelona',

    'seo.children.title': 'Terapias para niños - Desarrollo y crecimiento | EKA Balance',
    'seo.children.description': 'Apoyo al desarrollo infantil a través de kinesiología y métodos suaves. Ayudamos en problemas de aprendizaje, emocionales y de coordinación.',
    'seo.children.keywords': 'Terapias niños, desarrollo infantil, kinesiología niños, problemas aprendizaje, coordinación psicomotriz Barcelona',

    'seo.families.title': 'Bienestar para familias - Armonía y conexión | EKA Balance',
    'seo.families.description': 'Espacio de salud para toda la familia. Mejora la convivencia, reduce tensiones y encuentra el equilibrio familiar con nuestras terapias sistémicas.',
    'seo.families.keywords': 'Bienestar familiar, terapia familiar, armonía hogar, kinesiología familiar, relaciones padres hijos Barcelona',
    ...
    'personalized.artists.hero.description': 'Preservación funcional de la motricidad fina y ergonomía creativa',
    'personalized.artists.understanding.title': 'Desafíos clínicos',
    'personalized.artists.understanding.description1': 'Microtraumatismos en extremidades superiores por gestos técnicos continuados.',
    'personalized.artists.understanding.description2': 'Compromiso musculoesquelético derivado de posturas estáticas prolongadas.',
    'personalized.artists.understanding.callToAction': 'Te ayudamos a liberar restricciones físicas que impactan en el flujo creativo.',
    ...
    'personalized.artists.method.step3.desc': 'Ejercicios y pautas para mantener la salud mientras creas.',
    'personalized.artists.benefits.benefit1': 'Sostenibilidad de la práctica artística y libertad de movimiento.',
    ...
    'personalizedServices.business.desc': 'Programas de bienestar corporativo, clases grupales y consultoría.',
    ...
    'personalized.business.hero.description': 'Cuidamos de la salud de tu equipo con programas a medida: desde masajes en la oficina hasta clases de postura. Porque trabajar no debería doler.',
    'personalized.business.bento.title': 'Bienestar corporativo bellamente diseñado',
    'personalized.business.bento.subtitle': 'Empodera a tu equipo con un espacio y práctica dedicados a restaurar el enfoque y cultivar la resiliencia.',
    'personalized.business.bento.box1.title': 'Cohesión de Equipo',
    'personalized.business.bento.box1.desc': 'Construye conexiones más fuertes mediante experiencias físicas compartidas y movimiento consciente.',
    'personalized.business.bento.box2.title': 'Mayor Productividad',
    'personalized.business.bento.box2.desc': 'Mentes claras llevan a mejores decisiones. Corregir la postura reduce la fatiga y mejora el rendimiento.',
    ...
    'personalized.business.understanding.description1': 'Las largas horas de oficina pueden causar tensión y agotamiento. Nosotros ayudamos a recuperar la energía y reducir el estrés.',
    'personalized.business.understanding.description2': 'Ya sea mediante consultoría o sesiones semanales, nos adaptamos completamente a los tiempos de tu empresa.',
    'personalized.business.understanding.callToAction': 'Hablemos y diseñemos un plan real para tu equipo.',
    'personalized.business.services.title': 'Servicios Corporativos',
    'personalized.business.services.subtitle': 'Opciones para mejorar la salud de los tuyos en el trabajo',
    'personalized.business.services.groupClasses.title': 'Clases Grupales y Estiramientos',
    'personalized.business.services.groupClasses.description': 'Sesiones amenas de postura o estiramientos para destensar el cuello y la espalda, en la oficina o por videollamada.',
    'personalized.business.services.consulting.title': 'Consultoría y Cuidado en la Oficina',
    'personalized.business.services.consulting.description': 'Evaluamos cómo trabaja tu equipo y les enseñamos a cuidar su descanso. Además, podemos llevar las terapias manuales a tu oficina.',
    'personalized.business.faq.q1': '¿Adaptáis los horarios a la jornada?',
    'personalized.business.faq.a1': 'Sí, sabemos que el tiempo es oro. Diseñamos nuestras intervenciones para no interrumpir el flujo de trabajo.',
    'personalized.business.faq.q2': '¿Se desplazan a la oficina?',
    'personalized.business.faq.a2': 'Exacto, en la mayoría de zonas urbanas, nuestro equipo va directo a vuestras instalaciones.',
    'personalized.business.faq.q3': '¿Cuáles son los precios?',
    'personalized.business.faq.a3': 'Depende de las personas y la frecuencia. Contáctanos y te armaremos un presupuesto sin compromiso.',
    'personalized.business.benefit1': "Reduce los niveles de estrés del equipo y previene el agotamiento de manera proactiva.",
    'personalized.business.benefit2': "Mejora la postura en el escritorio y alivia eficazmente el dolor de espalda crónico.",
    'personalized.business.benefit3': "Fomenta una cultura de empresa más fuerte, conectada y saludable.",
    'personalized.business.benefit4': "Aumenta significativamente la concentración diaria, la energía y la productividad general.",
    ...
    'office.seo.desc': 'Terapias especializadas para oficinistas: alivia la tensión, mejora la postura y gestiona el estrés laboral. Sesiones de 1.5h por 60€.',
    ...
    'athletes.seo.desc': 'Terapias especializadas para atletas: recuperación muscular, mejora de flexibilidad y gestión del estrés pre-competición. Sesiones de 1.5h por 60€.',
    ...
    'artists.seo.desc': 'Terapias para artistas visuales y creadores: cuidado de manos, mejora postural y desbloqueo creativo. Sesiones de 1.5h por 60€.',
    ...
    'musicians.seo.desc': 'Terapias especializadas para músicos: prevención de lesiones, mejora técnica y gestión de ansiedad escénica. Sesiones de 1.5h por 60€.',
    ...
    'students.seo.desc': 'Terapias para estudiantes: gestión de estrés de exámenes, mejora de concentración y corrección postural. Sesiones de 1.5h por 60€.',
    ...
    'children.kinesiology.desc': 'Apoyo en dificultades de aprendizaje, gestión emocional y coordinación motora.',
    'children.health.title': 'Equilibrio Corporal',
    'children.health.desc': 'Tratamiento holístico para alergias, intolerancias y desarrollo físico saludable.',
  ...
  ru: {
    ...
    'children.kinesiology.desc': 'Поддержка при трудностях в обучении, управлении эмоциями и моторной координации.',
    'children.health.title': 'Телесный баланс',
    'children.health.desc': 'Холистическое лечение аллергий, непереносимостей и здоровое физическое развитие.',
    ...
    'personalizedServices.parents.desc': 'Поддержка для восстановления энергии, терпения и физического самочувствия.',
    ...
    'seo.artists.title': 'Терапия для художников и артистов - Творчество и благополучие | EKA Balance',
    'seo.artists.description': 'Услуги для людей искусства. Раскройте свой творческий потенциал, уменьшите стресс и улучшите художественное самовыражение.',
    'seo.artists.keywords': 'Терапия для артистов, творчество, эмоциональное благополучие, художественное самовыражение, арт-терапия Барселона',

    'seo.adults.title': 'Комплексное благополучие для взрослых - Здоровье и баланс | EKA Balance',
    'seo.adults.description': 'Персонализированные методы лечения для взрослых: управление стрессом, снятие хронической боли и улучшение качества жизни. Массаж, кинезиология и многое другое.',
    'seo.adults.keywords': 'Благополучие взрослых, управление стрессом, хроническая боль, терапевтический массаж, кинезиология Барселона',

    'seo.children.title': 'Терапия для детей - Развитие и рост | EKA Balance',
    'seo.children.description': 'Поддержка детского развития с помощью кинезиологии и мягких методов. Помогаем при проблемах с обучением, эмоциональных сложностях и координации.',
    'seo.children.keywords': 'Терапия для детей, детское развитие, детская кинезиология, трудности обучения, психомоторная координация Барселона',

    'seo.families.title': 'Благополучие для семей - Гармония и связь | EKA Balance',
    'seo.families.description': 'Пространство здоровья для всей семьи. Улучшите совместную жизнь, уменьшите напряжение и найдите семейный баланс с помощью наших системных методов.',
    'seo.families.keywords': 'Семейное благополучие, семейная терапия, гармония в доме, семейная кинезиология, отношения родителей и детей Барселона',
    ...
    'personalized.artists.hero.description': 'Уход за руками, руками и осанкой для визуальных художников и творцов',
    'personalized.artists.understanding.title': 'Общие проблемы',
    'personalized.artists.understanding.description1': 'Боль от повторяющихся движений во время долгих творческих сессий.',
    'personalized.artists.understanding.description2': 'Напряжение шеи и спины от длительных поз во время творчества.',
    'personalized.artists.understanding.callToAction': 'Мы помогаем устранить физические напряжения, блокирующие творческий процесс.',
    ...
    'personalized.artists.method.step3.desc': 'Упражнения и рекомендации для поддержания здоровья во время творчества.',
    'personalized.artists.benefits.benefit1': 'Больше комфорта, плавности и творчества в вашем процессе.',
    ...
    'personalizedServices.business.desc': 'Корпоративное здоровье, групповые занятия и консалтинг для снижения стресса.',
    ...
    'personalized.business.hero.description': 'Мы заботимся о здоровье вашей компании с помощью индивидуальных программ: от массажа в офисе до семинаров по осанке. Работа не должна приносить боль.',
    'personalized.business.bento.title': 'Корпоративный велнес в красивом исполнении',
    'personalized.business.bento.subtitle': 'Помогите вашей команде восстановить концентрацию и развить стрессоустойчивость через осознанное движение.',
    'personalized.business.bento.box1.title': 'Сплоченность Команды',
    'personalized.business.bento.box1.desc': 'Создавайте более прочные связи благодаря совместному физическому опыту и осознанным тренировкам.',
    'personalized.business.bento.box2.title': 'Повышение Продуктивности',
    'personalized.business.bento.box2.desc': 'Ясный ум приводит к лучшим решениям. Исправление осанки снижает утомляемость и повышает результативность.',
    ...
    'personalized.business.understanding.description1': 'Длительное сидение вызывает напряжение в шее и усталость. Мы помогаем сотрудникам восстановить энергию и снизить стресс.',
    'personalized.business.understanding.description2': 'Будь то еженедельные групповые занятия, эргономический консалтинг или массаж в офисе, мы подстроимся под ваш график.',
    'personalized.business.understanding.callToAction': 'Давайте обсудим план, который подойдет вашему офису.',
    ...
    'personalized.business.services.groupClasses.description': 'Эффективные сессии, направленные на снятие боли в спине, проводятся онлайн или в офисе.',
    'personalized.business.services.consulting.title': 'Консалтинг и уход в офисе',
    'personalized.business.services.consulting.description': 'Мы оцениваем рабочие места и учим команду работать без боли. Также мы можем проводить дни терапии прямо у вас в офисе.',
    'personalized.business.faq.q1': 'Подстроитесь ли вы под наш график?',
    'personalized.business.faq.a1': 'Да, мы знаем о ваших дедлайнах и без проблем интегрируемся в рабочие часы.',
    'personalized.business.faq.q2': 'Вы приезжаете в офис?',
    'personalized.business.faq.a2': 'Да, мы можем приезжать прямо в штаб-квартиру вашей компании для проведения сессий.',
    'personalized.business.faq.q3': 'Сколько это стоит?',
    'personalized.business.faq.a3': 'Зависит от размера команды и частоты. Свяжитесь с нами, и мы подготовим предложение.',
    'personalized.business.benefit1': "Снижает уровень стресса в команде и активно предотвращает выгорание.",
    'personalized.business.benefit2': "Улучшает осанку при работе за столом и эффективно снимает хроническую боль в спине.",
    'personalized.business.benefit3': "Способствует созданию более сильной, сплоченной и здоровой корпоративной культуры.",
    'personalized.business.benefit4': "Значительно повышает ежедневную концентрацию, энергию и общую продуктивность.",
