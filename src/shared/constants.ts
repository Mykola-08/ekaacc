...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    image: 'https://images.pexels.com/photos/6628817/pexels-photo-6628817.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/6628700/pexels-photo-6628700.jpeg?auto=compress&cs=tinysrgb&w=1200',
...
export const PERSONALIZED_SERVICES_DATA: PersonalizedServiceItem[] = [
  {
    ...
    image: 'https://images.pexels.com/photos/4050308/pexels-photo-4050308.jpeg?auto=compress&cs=tinysrgb&w=1200',
    href: '/services/office-workers',
    benefitsKeys: [
      'services.officeWorkers.benefits.0',
      'services.officeWorkers.benefits.1'
    ],
    duration: '60 min'
  },
  {
    ...
    benefitsKeys: [
      'services.athletes.benefits.0',
      'services.athletes.benefits.1'
    ],
    duration: '60 min'
  },
  {
    ...
    benefitsKeys: [
      'services.artists.benefits.0',
      'services.artists.benefits.1'
    ],
    duration: '60 min'
  }
];
